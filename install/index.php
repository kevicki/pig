...
//参数设置
define('SOFT_VERSION', '7.8加盟版');
define('SOFT_RELEASE', $version);
define('ROOT_PATH', dirname(__FILE__).'/../');//网站根目录
define('SOFT_NAME', '小猪PigCms微信营销平台安装'.SOFT_VERSION);
...
'license'=>'<div class="license"><h1>系统安装协议</h1>
                <p>版权所有 (c)2012-2014 保留所有权利。 </p>
				<p>感谢您选择pigcms微信营销平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
				<p>为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：</p>
			<strong>一、本授权协议适用且仅适用于 '. SOFT_NAME . SOFT_RELEASE .'更新，官方对本授权协议的最终解释权。</strong>
			    <p></p>
			<strong>二、协议许可的权利 </strong>
				<p>1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。 </p>
				<p>2、您可以在协议规定的约束和限制范围内修改小猪PigCms微信营销平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用小猪PigCms微信营销平台，还是部份栏目使用 微信营销平台，在你使用了小猪PigCms微信营销平台的网站主页上必须加上小猪PigCms微信营销平台  官方网址(<a href="http://www.5214.com.cn" target="_blank">www.5214.com.cn"</a>)的链接。</p>
				<p>4、未经官方许可，禁止在小猪PigCms微信营销平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p>3、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装   微信营销平台，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
				<p>4、如果本软件带有其它软件的整合API示范例子包，这些文件版权不属于本软件官方，并且这些文件是没经过授权发布的，请参考相关软件的使用许可合法的使用。</p>
				<p><b>版本最新更新：</b> '.SOFT_RELEASE.'</p>
                <p align=right>BY 小猪PigCms微信营销平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 小猪PigCms微信营销平台V'.SOFT_VERSION.' 安装程序',
...
'dbname' => '数据库名',
'tablepre' => '数据表前缀',
'tablepre_comment' => '数据表前缀不要修改，必须为tp_',
'dbport' =>'数据库端口',
'tips_admininfo' => '网站信息',
'username' => '管理员账号',
'username_comment' => '管理员账号必须为admin',
'password' => '管理员密码',
'password_comment' => '管理员密码为admin，安装成功后，进后台修改',
'password2' => '重复密码',
...
'php_version_too_low'=>'PHP版本过低，最低版本要求5.4或以上版本',
...
$env_items = array(
'php' => array('c' => 'PHP_VERSION', 'r' => '5.4', 'b' => '5.4'),
...
(1, '".$username."', '".$password."', 5, 1, '', 1383453875, '127.0.0.1', '')");
			//新增一个标识文件，用来屏蔽重新安装
			$fp = @fopen(ROOT_PATH.'PigData/install.lock','wb+');
			@fclose($fp);
		}else{
...
<meta content="小猪PigCms微信营销平台" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by 小猪PigCms微信营销平台© V7.8至尊加盟版 2012-2015</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
...
function config_edit() {
	...
	$configfile['agent_version']=1; //代理专用
	
	$config_info='../Conf/info.php';
	$configfile2 = include($config_info);	
	$configfile2['site_url']='http://'.$_SERVER['HTTP_HOST'].trim(str_replace(strstr($_SERVER['SCRIPT_NAME'], '/install'),"",$_SERVER['SCRIPT_NAME']));
	if (phpversion() > 5.0){
		@file_put_contents($config, "<?php\nreturn ".var_export($configfile,true).";\n?>");
		@file_put_contents($config_info, "<?php\nreturn ".var_export($configfile2,true).";\n?>");
	}
	$status=1;$msg='';
