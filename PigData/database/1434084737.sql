...
-- -------------------------------------------------------
 ...
 DROP TABLE IF EXISTS `tp_behavior`;/* MySQLReback Separation */ CREATE TABLE `tp_behavior` (
  ...
  PRIMARY KEY (`id`),
  KEY `openid` (`openid`)
) ENGINE=MyISAM AUTO_INCREMENT=86 DEFAULT CHARSET=utf8;/* MySQLReback Separation */
 /* 插入数据 `tp_behavior` */
 ...
 INSERT INTO `tp_forum_config` VALUES ('2','','','0','','0','9','博览书店官方粉丝社区','http://weixin.blbook.cn/uploads/t/twllsi1431226863/6/d/1/c/thumb_5559e7d82a1c8.jpg','twllsi1431226863','1','0');/* MySQLReback Separation */
...
<p>
	欢迎您的到来～
</p>','http://mp.weixin.qq.com/s?__biz=MzA5MzcyMjI2OA==&mid=206826137&idx=1&sn=025d0283dce26237f7728ade1c4744a3#rd','1431965654','1431966591','25','twllsi1431226863','博览书店微信平台内测中','1','','','0','微信运营','1','1','1','1');/* MySQLReback Separation */
 /* 创建表结构 `tp_img_multi` */
 ...
 /* 插入数据 `tp_keyword` */
 INSERT INTO `tp_keyword` VALUES ('4','参与感','8','twllsi1431226863','Product','0','0'),('3','万水千山','1','twllsi1431226863','vCard','0','0'),('5','创业，创业维艰','9','twllsi1431226863','Product','0','0'),('6','教辅，数学，压轴，浙大','10','twllsi1431226863','Product','0','0'),('7','英文,字帖,英文字,字','11','twllsi1431226863','Product','0','0'),('8','英语,高中','12','twllsi1431226863','Product','0','0'),('9','创业','13','twllsi1431226863','Product','0','0'),('14','博览书店','22','twllsi1431226863','Img','0','0'),('18','博览微信平台运营活动','1','twllsi1431226863','Invite','0','0'),('19','从0到1,商业','14','twllsi1431226863','Product','0','0'),('20','从0到1,商业','14','twllsi1431226863','Product','0','0'),('21','秒杀','1','twllsi1431226863','Seckill','0','0'),('22','摁死小情侣','1','twllsi1431226863','Lottery','0','0'),('23','签到','1','twllsi1431226863','Sign','0','0'),('25','微助力','16','twllsi1431226863','Helping','0','0'),('29','waphelp','1','twllsi1431226863','waphelp','0','1'),('27','waphelp','1','','waphelp','0','1');/* MySQLReback Separation */
 /* 创建表结构 `tp_leave` */
 ...
 INSERT INTO `tp_member_card_sign` VALUES ('0','twllsi1431226863','onHRmuCEpECSyzxz_isbLqeUI0lw','1432785257','1','1','0','0'),('0','twllsi1431226863','onHRmuCEpECSyzxz_isbLqeUI0lw','0','0','1','0','0');/* MySQLReback Separation */
 ...
 INSERT INTO `tp_member_card_use_record` VALUES ('8','0','twllsi1431226863','onHRmuCEpECSyzxz_isbLqeUI0lw','0','3','0','0','0','1432103741','','0','3','0',''),('9','0','twllsi1431226863','onHRmuCEpECSyzxz_isbLqeUI0lw','0','98','0','6','1','1432346677','','0','0','0','');/* MySQLReback Separation */
 ...
 /* 插入数据 `tp_node` */
 INSERT INTO `tp_node` VALUES ('97','Database','数据库维护','1','0','2','2','','0','2'),('99','News','新闻管理','1','0','4','2','','0','2'),('100','add','添加内容','1','0','99','3','','0','2'),('101','platform','平台支付配置','1','','6','3','','0','2'),('102','Platform','平台支付','1','','4','2','','0','2'),('103','index','平台对账','1','','102','3','','0','2'),('108','addclass','增加分类','1','0','85','3','','0','2'),('107','indexs','分类管理','1','0','85','3','','0','2'),('106','SystemIndex','后台首页','1','0','2','2','','0','2'),('124','index','进程列表','1','0','123','3','','0','2'),('121','addclass','增加分类','1','0','66','3','','0','2'),('122','indexs','分类管理','1','0','66','3','','0','2'),('123','Renew','更新进程','1','0','4','2','','0','2'),('125','add','添加进程','1','0','123','3','','0','2');/* MySQLReback Separation */
 /* 创建表结构 `tp_norms` */
...
</p>','twllsi1431226863','参与感','0','http://weixin.blbook.cn/uploads/t/twllsi1431226863/1/b/b/d/thumb_555a04cce3fe9.jpg','0','0','0','0','1431962942','10','fixed','0.00','0','0'),('9','1','1','26','0','0','创业维艰:如何完成比难更难的事','28','25','28','0','10','<h3 class=\"productDescriptionSource\" style=\"color:#333333;font-size:1.23em;font-weight:normal;font-family:verdana, arial, helvetica, sans-serif;\">
	编辑推荐
</h3>
...
</div>','twllsi1431226863','创业，创业维艰','0','http://weixin.blbook.cn/uploads/t/twllsi1431226863/6/9/4/9/thumb_555a063e1fab1.jpg','0','0','0','5','1431963270','100','fixed','0.00','0','0');/* MySQLReback Separation */
 /* 插入数据 `tp_product` */
...
<br />','twllsi1431226863','教辅，数学，压轴，浙大','0','http://weixin.blbook.cn/uploads/t/twllsi1431226863/e/6/7/c/thumb_555a0761ecaf9.jpg','0','0','0','0','1431963604','5','fixed','0.00','0','0');/* MySQLReback Separation */
 /* 插入数据 `tp_product` */
...
</div>','twllsi1431226863','英文,字帖,英文字,字','0','http://weixin.blbook.cn/uploads/t/twllsi1431226863/d/3/3/1/thumb_555a086db4dfb.jpg','0','0','0','1','1431963818','17','fixed','0.00','0','0');/* MySQLReback Separation */
 /* 插入数据 `tp_product` */
...
</div>','twllsi1431226863','英语,高中','0','http://weixin.blbook.cn/uploads/t/twllsi1431226863/b/6/2/9/thumb_555a0875bf6a4.jpg','0','0','0','0','1431964579','10','fixed','0.00','0','0');/* MySQLReback Separation */
 /* 插入数据 `tp_product` */
...
</div>','twllsi1431226863','创业','0','http://weixin.blbook.cn/uploads/t/twllsi1431226863/6/9/4/9/thumb_555a063e1fab1.jpg','0','0','0','5','1431965116','100','fixed','0.00','0','0');/* MySQLReback Separation */
 /* 插入数据 `tp_product` */
...
——《大西洋月刊》资深编辑德里克•汤姆森
</div>','twllsi1431226863','从0到1,商业','1','http://weixin.blbook.cn/uploads/t/twllsi1431226863/2/5/f/a/thumb_555bc65e4ba95.jpg','0','1','1433606399','100','1432077945','0','','0.00','0','0');/* MySQLReback Separation */
 ...
 INSERT INTO `tp_product_cart` VALUES ('8','1','','','0','','twllsi1431226863','onHRmuCEpECSyzxz_isbLqeUI0lw','0','a:1:{i:11;s:16:\"1|10|10|10|10|10\";}','1','10','好','18588872622','哈哈','0','0','1431989435','','0','0','0','0','0','0','0','20150518234428162081','0','','','0','0','0','0','0','1','','0','oll2','10'),('9','1','','','0','','twllsi1431226863','onHRmuCEpECSyzxz_isbLqeUI0lw','0','a:1:{i:11;s:22:\"1|10|10|10|10|10|10|10\";}','1','10','soGary','18588872622','莫','0','0','1432133040','','0','0','0','0','0','0','0','20150519065447812950','0','','','0','0','0','0','0','1','','0','pth10','10'),('10','1','','dianfu','14','onHRmu1432134200','twllsi1431226863','onHRmuCEpECSyzxz_isbLqeUI0lw','0','a:1:{i:14;a:2:{s:5:\"count\";i:1;s:5:\"price\";i:15;}}','1','15','soGary','18588872622','','0','0','1432134200','','1','0','0','0','0','0','0','thnj1432134200','0','','','0','0','0','0','0','0','','0','','0');/* MySQLReback Separation */
 ...
 /* 插入数据 `tp_sms_record` */
 INSERT INTO `tp_sms_record` VALUES ('1','2','twllsi1431226863','1431270639','','您的顾客好刚刚下了一个订单，订单号：20150510231039994547，手机号：18588872622请您注意查看并处理','101','1'),('2','2','twllsi1431226863','1431271324','','您的顾客好刚刚下了一个订单，订单号：20150510232204145912，手机号：18588872622请您注意查看并处理','101','1'),('3','2','twllsi1431226863','1431272372','','有新的会员领了会员卡','101','1'),('4','2','twllsi1431226863','1431963868','','您的顾客好刚刚下了一个订单，订单号：20150518234428162081，手机号：18588872622请您注意查看并处理','101','1'),('5','2','twllsi1431226863','1431989687','','您的顾客好刚刚下了一个订单，订单号：20150519065447812950，手机号：18588872622请您注意查看并处理','101','1'),('6','2','twllsi1431226863','1432103373','','有新的会员领了会员卡','101','1'),('7','2','twllsi1431226863','1432162030','','留言板有新的留言','101','1');/* MySQLReback Separation */
 /* 创建表结构 `tp_snccode` */
 ...
 /* 插入数据 `tp_user` */
 INSERT INTO `tp_user` VALUES ('1','admin','21232f297a57a5a743894a0e4a801fc3','1','1','','1434071980','58.67.148.148','','0','0');/* MySQLReback Separation */
 ...
 /* 插入数据 `tp_userinfo` */
 INSERT INTO `tp_userinfo` VALUES ('11','http://wx.qlogo.cn/mmopen/Ly9jEUBSYBPIjYa4H6dDlxm8uljF7ySib909Q4x4eHibhwDBIYCicicFibdSssZbMvJBFT8AEbY391fDNah6WqqmSbej5T6fr54X1/0','0','0','0','0','twllsi1431226863','onHRmuD5eAyABVzl3tWBJKXtPjjs','soGary','soGary','','','','','','0','','','','','0','0','0','0','0','0','0','0.00','0.00','','','','','','','0','','',''),('10','http://wx.qlogo.cn/mmopen/lKflbtDRhzwB7Wicr0FvicLDyXkD0qXbYStK13VVviaYFvobOwKWpsc8RKICCaiaxhSyg07iaGwcibbEPj5XwCyJcMFxnxUMEqew8b/0','0','6','0','0','twllsi1431226863','onHRmuCEpECSyzxz_isbLqeUI0lw','soGary','soGary','18588872622','1987','10','13','229034523','1','','','','','0','0','1','0','0','0','1432103373','0.00','0.00','d597feb69660a9a7d9e88833e92f0531','pth10','','','广州','广东','0','','',''),('7','http://wx.qlogo.cn/mmopen/lKflbtDRhzwB7Wicr0FvicLEjWrPfGK1aRlpgiaeSylLDib5uqELqFDzzgbNYIucO6ibCm793LZc6qLv7grsqN57GjTXbshS20DpZ/0','0','0','0','0','twllsi1431226863','onHRmuAvwwx6K08Guyj02PIKTyBc','吕端','吕端','','','','','','1','','','','','0','0','0','0','0','0','0','0.00','0.00','','kWl7','','','石景山','北京','0','','',''),('6','http://wx.qlogo.cn/mmopen/Q3auHgzwzM63IbV32YRDkKJXicLb2VOicmlpDGHyFmcznbatReJRIsgiaJI9ayApQJjTVYZRoR64ibbGWODbaVtsRg/0','0','0','0','0','twllsi1431226863','onHRmuKJHTp6moCPMXDlAy68RLLI','一米阳光','','','','','','','2','','','','','0','0','0','0','0','0','0','0.00','0.00','','QhY6','','','渭南','陕西','0','','',''),('8','http://wx.qlogo.cn/mmopen/Q3auHgzwzM61KejuxemMUS5IL9l88ibibU3DcF8Y4nREL3eicJlZdqQ0vsx3ILxZE9gselbnxhP6Msl5gc1oa5ibzJjLkKGkBn2NDr38cG91NXs/0','0','0','0','0','twllsi1431226863','onHRm
 /* 创建表结构 `tp_vcard` */
 ...
 DROP TABLE IF EXISTS `tp_voteimg`;/* MySQLReback Separation */ CREATE TABLE `tp_voteimg` (
  ...
  `action_desc` varchar(300) NOT NULL,
  `award_desc` varchar(300) NOT NULL,
  `flow_desc` varchar(300) NOT NULL,
  `join_desc` varchar(300) NOT NULL,
 ...
 DROP TABLE IF EXISTS `tp_voteimg_banner`;/* MySQLReback Separation */ CREATE TABLE `tp_voteimg_banner` (
  ...
  `external_links` varchar(100) NOT NULL DEFAULT '' COMMENT '外部链接',
 ...
 DROP TABLE IF EXISTS `tp_voteimg_users`;/* MySQLReback Separation */ CREATE TABLE `tp_voteimg_users` (
  `user_id` int(11) NOT NULL AUTO_INCREMENT,
  `vote_id` int(11) NOT NULL COMMENT '活动id',
  `item_id` text NOT NULL COMMENT '投片选项',
  `wecha_id` varchar(100) NOT NULL,
 ...
 INSERT INTO `tp_wechat_group` VALUES ('1','0','未分组','','twllsi1431226863','12'),('2','1','黑名单','','twllsi1431226863','0'),('3','2','星标组','','twllsi1431226863','0');/* MySQLReback Separation */
 ...
 INSERT INTO `tp_wechat_group_list` VALUES ('1','','LigneousCat','1','广东','广州','http://wx.qlogo.cn/mmopen/PiajxSqBRaELU760teOQtCGdw29EFlFPJzahciboasibNVRI5ky06lRouHh3AyDibLCvVI7o6YCzVg4ZoicaGtbOpDg/0','1430925016','twllsi1431226863','onHRmuBJhvmUblM7QEf9ecnd9Y7U','0'),('2','','奈露','2','','','http://wx.qlogo.cn/mmopen/Q3auHgzwzM5jgjsibUtgGee5iaKc9iaBhkxiaQAY8diaDq5OjRE66q1xouicpK8v0nxLLe1WLT0ibTic7t8sGrpNKPhic7ow0GoUdE6w0DNSwhgEria5E/0','1431129623','twllsi1431226863','onHRmuDxjcFPlNwGRLcpvAg5okqw','0'),('3','','soGary','1','广东','广州','http://wx.qlogo.cn/mmopen/lKflbtDRhzwB7Wicr0FvicLDyXkD0qXbYStK13VVviaYFvobOwKWpsc8RKICCaiaxhSyg07iaGwcibbEPj5XwCyJcMFxnxUMEqew8b/0','1431271764','twllsi1431226863','onHRmuCEpECSyzxz_isbLqeUI0lw','0'),('4','','幽清溪','1','广东','广州','http://wx.qlogo.cn/mmopen/iaqOF0rNfD12nvHImGJ8MfHq8GCia8iaYIXgBD16TUz6amQzhRw0NeiaOB68COMvicHyq5Gf0NerxD3chXjWZJGta0ibKDrFXptKN3/0','1430876062','twllsi1431226863','onHRmuHQF1owigQV4NEXRbmmHHyU','0'),('5','','Aon','2','广东','广州','http://wx.qlogo.cn/mmopen/lKflbtDRhzwB7Wicr0FvicLO2GD1829GfSPlX2lXwgwiaEbAh82gPnEfAObAGBQdJYSz44cicgX1ZkgwF9QI7LSic3dYsoQLkIicoM/0','1430823075','twllsi1431226863','onHRmuCWBIpi5-O4wM_IL18eEqUY','0'),('6','','吕端','1','北京','石景山','http://wx.qlogo.cn/mmopen/lKflbtDRhzwB7Wicr0FvicLEjWrPfGK1aRlpgiaeSylLDib5uqELqFDzzgbNYIucO6ibCm793LZc6qLv7grsqN57GjTXbshS20DpZ/0','1430270016','twllsi1431226863','onHRm