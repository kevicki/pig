    ...
    <div>
      <form name="myform" id="Js-myform" method="post">
        ...
        <tr>
          ...
          <td>
            <input type="text" value="<?php echo ($create['number']); ?>" name="number" readonly="true"/>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <input type="text" value="" name="new_number"/>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <div class="pt_10 pb_10 pl_10 pr_10">
          <input type="hidden" name="createid" value="<?php echo ($create['id']); ?>">
