...
<div id="deal" class="deal" xmlns="http://www.w3.org/1999/html">
    <div class="deal-intro">
        ...
        <div class="deal-title">
            <h1><?php echo ($product["name"]); ?> <?php if($product["sn"] == 1): ?><span style="color:#f60;font-size:14px;" title="虚拟商品">（虚拟商品）</span><?php endif; ?></h1>
...
<script type="text/javascript"> 
 ...
 function SetRemainTime() { 
  if (SysSecond > 0) { 
   ...
   $("#remainTime").html('&nbsp;&nbsp;距结束'+day + "天" + hour + "小时" + minite + "分" + second + "秒"); 
...
<!--daojishi end-->
    <div class="box-style deal-comment">
             <span style="font-size:16px;font-weight:800;color:#FF9900;">&nbsp;&nbsp;库存还剩 <?php echo ($product["groupon_num"]); ?> 件</span>
    </div>
    <div class="box-style deal-comment">
