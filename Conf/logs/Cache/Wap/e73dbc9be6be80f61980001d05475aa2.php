...
window.shareData = {  
            ...
            "timeLineLink": "<?php echo ($f_siteUrl); echo U('Forum/comment',array('token'=>$_GET['token'],'tid'=>intval($_GET['tid'])));?>",
            "sendFriendLink": "<?php echo ($f_siteUrl); echo U('Forum/comment',array('token'=>$_GET['token'],'tid'=>intval($_GET['tid'])));?>",
            "weiboLink": "<?php echo ($f_siteUrl); echo U('Forum/comment',array('token'=>$_GET['token'],'tid'=>intval($_GET['tid'])));?>",
