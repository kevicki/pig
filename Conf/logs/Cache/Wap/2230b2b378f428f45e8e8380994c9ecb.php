...
<head>
    ...
    <!--[if lte IE 9]><script src="<?php echo STATICS;?>/forum/js/watermark.js"></script><![endif]-->
	<!--[if IE 7]><link href="<?php echo STATICS;?>/forum/css/font_awesome_ie7.css" rel="stylesheet" /><![endif]-->
</head>
<body>
	<!DOCTYPE html>
<html lang="zh-CN">
	<head>
		...
		<script src="<?php echo STATICS;?>/forum/js/swipe.js" ></script>
		...
		<script src="<?php echo STATICS;?>/forum/js/input.js" ></script>
		<script>
    					...
    					$("#list_emotion").on("click", function(evt){						
    						if("SPAN" == evt.target.tagName){
    							...
    							myInput.listen(this, {
    								...
    								value:val[2],
    								imgUrl: '<?php echo STATICS;?>/forum/images/'+ val[0]+".gif"
    							});
    							this.focus();
    						}
    					});
	...
	<body onselectstart="return true;" ondragstart="return false;" class="discuss_comment">
		<div id="container" class="container">
			<header></header>
			<div class="body">
				<form id="form_1" action="<?php echo U('Forum/checkCommentAdd');?>" method="post">
					<section class="form_comment">
						...
						<input name="tid" type="hidden" value="<?php echo (intval($_GET['tid'])); ?>" />
