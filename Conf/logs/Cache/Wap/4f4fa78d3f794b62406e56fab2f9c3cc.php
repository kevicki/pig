...
<div id="win">
<ul class="dropdown"> 
<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php if($vo["url"] != ''): echo ($vo["url"]); else: echo U('Index/lists',array('token'=>$vo['token'],'classid'=>$vo['id'])); endif; ?>"><span><?php echo ($vo["name"]); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
...
<?php
 if($iswx == 1){ ?>
<a id="biz-link" class="btn" href="<?php echo U('Index/index',array('token'=>$res['token'],'wecha_id'=>$wecha_id));?>"  data-transition="slide" >
<div class="arrow">
