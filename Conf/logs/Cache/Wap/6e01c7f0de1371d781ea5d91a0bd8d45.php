...
<link rel="stylesheet" href="<?php echo RES;?>/css/136/idangerous.swiper.css">
<link href="<?php echo RES;?>/css/136/iscroll.css" rel="stylesheet" type="text/css" />
<link href="<?php echo RES;?>/css/allcss/cate36_<?php echo ($tpl["color_id"]); ?>.css" rel="stylesheet" type="text/css" />
<style>
  
</style>

<script src="<?php echo RES;?>/css/136/iscroll.js" type="text/javascript"></script>
...
<?php if(is_array($flashbg)): $i = 0; $__LIST__ = $flashbg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><li>
            ...
            <img src="<?php echo ($so["img"]); ?>" style="height:100%">
...
<script src="<?php echo RES;?>/css/136/jquery-1.10.1.min.js" type="text/javascript"></script>
  <script src="<?php echo RES;?>/css/136/idangerous.swiper-2.1.min.js" type="text/javascript"></script>
  <script>
