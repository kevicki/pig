...
<img src="<?php echo ($hostlist["logourl"]); ?>" data-src="<?php echo ($hostlist["logourl"]); ?>" width="122" height="74" alt="">
	<ul>
		<li class="dl-brand break-word"><?php echo ($hostlist["name"]); ?> 
		</li>
		<li class="dl-title dl-indent break-word">&nbsp;&nbsp;截止<?php echo (date("Y-m-d",$hostlist["endtime"])); ?></li>
		<li class="dl-price">&nbsp;
			<strong><?php echo ($hostlist["price"]); ?></strong>元 
		<del><?php echo ($hostlist["oprice"]); ?>元</del> <span><?php if($hostlist["sn"] == 1): ?><span style="color:#f60;font-weight:normal;font-size:12px;" title="虚拟商品">(虚拟)</span><?php endif; ?>已售<?php echo ($hostlist['salecount']+$hostlist['fakemembercount']); ?></span></li>
	</ul></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
...
<footer>
<div class="ft-copyright"><span class="ft-copyright-text"> 
<?php if($iscopyright == 1): echo ($homeInfo["copyright"]); ?>
<?php else: ?>
<?php echo ($siteCopyright); endif; ?> </span></div>
</footer>
