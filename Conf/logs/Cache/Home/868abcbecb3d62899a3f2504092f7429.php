...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="/tpl/Home/demo/common/js/jquery.js" type="text/javascript"></script>
        <script src="/tpl/Home/demo/common/js/daohang.js" type="text/javascript"></script>
        <link href="/tpl/Home/demo/common/css/manage.css" rel="stylesheet" type="text/css" />
    </head>
        ...
        <div class="xia clr">
            ...
            <div class="banner clr" >
            	<p class="zhutu clr" style="background:#cbfef7;">
                    <?php if($images['login'] == null): ?><img src="/tpl/Home/demo/common/images/images/5.png" />
                    <?php else: ?>
