	...
	<div class="biaotilan clr">
        ...
        <div class="xia clr">
            ...
            <div class="banner clr" >
                <p  style="background:url(/tpl/Home/demo/common/images/images/onebg_02.png) repeat-x;" class="zhutu clr">
                    <?php if($images['fc'] == null): ?><img src="/tpl/Home/demo/common/images/images/1.png" style="height:300px;"/>
                    <?php else: ?>
	    ...
	    <div class="contRt clr" style="text-align:left" id="">
	    	<?php if($pre == ''): ?><div class="contNei clr">
                    ...
                    <img src="/tpl/Home/demo/common/images/mrtp.jpg" style="margin-bottom:10px;" />
