...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php if($zdydh3['name'] == ''): ?>资费说明<?php else: echo ($zdydh3['name']); endif; ?>－<?php echo ($f_siteTitle); ?></title>
    </head>
        ...
        <div class="xia clr">
            ...
            <div class="banner clr" >
            	<p class="zhutu clr" style="background:#bfd4eb;">
                	<?php if($images['price'] == null): ?><img src="/tpl/Home/demo/common/images/images/3.png" />
                    <?php else: ?>
         ...
         <div class="content clr">
        	<div class="congtS clr">
                ...
                <div class="shangRt clr">
                    ...
                    <p>»</p>
                    <p class="twoth clr"><a href="#"><?php if($zdydh3['name'] == ''): ?>资费说明<?php else: echo ($zdydh3['name']); endif; ?></a></p>
                </div>
            </div>
                ...
                <div class="biaoge clr">
                	<table>
                        ...
                        <tr class="twoth clr">
                        	<td class="teshu clr">
                            	vip价格
                                <a  class="tooltips" ><img src="/tpl/Home/demo/common/images/images/biaoge_18.png" align="absmiddle" />
