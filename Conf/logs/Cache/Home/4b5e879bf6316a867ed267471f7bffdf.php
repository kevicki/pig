...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php if($zdydh2['name'] == ''): ?>关于我们<?php else: echo ($zdydh2['name']); endif; ?>－<?php echo ($f_siteName); ?></title>
    </head>
        ...
        <div class="xia clr">
            ...
            <div class="banner clr" >
            	<p  style="background:#d1e4de;" class="zhutu clr">
                	<?php if($images['about'] == ''): ?><img src="/tpl/Home/demo/common/images/images/2.png" />
                    <?php else: ?>
        ...
        <div class="content clr">
        	<div class="congtS clr">
                ...
                <div class="shangRt clr">
                    ...
                    <p>»</p>
                    <p class="twoth clr"><?php if($img == ''): ?><a href="#"><?php if($zdydh2['name'] == ''): ?>关于我们<?php else: echo ($zdydh2['name']); endif; ?></a><?php else: echo ($img['classname']); endif; ?></p>
                </div>
            </div>
