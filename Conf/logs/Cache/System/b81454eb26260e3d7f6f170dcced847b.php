...
<?php if(($info["id"]) > "0"): ?><form action="<?php echo U('Users/edit');?>" method="post" name="form" id="myform">
		...
		<?php else: ?>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
				...
				<tr>
					<td height="48" align="right"><strong>活动已创建数：</strong></td>
					<td colspan="3" class="lt">
				...
				<tr>
					...
					<td colspan="3" class="lt">
						<input type="text" name="viptime" onClick="WdatePicker()" class="ipt" size="45" value="<?php if($info['viptime'] != ''): echo (date("Y-m-d",$info["viptime"])); else: echo ($time); endif; ?>">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td height="48" align="right"><strong>每周手机端访问次数：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="access_count" class="ipt" size="45" value="<?php echo ($info["access_count"]); ?>"/>
						<span style="color:red;">　0表示使用套餐组的访问次数限制，-1表示不限制 ( 这里的限制优先套餐组里的限制 )</span>
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>手机端访问次数超出提醒：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="access_count_notice" class="ipt" size="45" value="<?php echo ($info["access_count_notice"]); ?>"/>
						<span style="color:red;">　每周手机端访问次数 不等于 0 时才会生效</span>
					</td>
				</tr>
				<tr>
