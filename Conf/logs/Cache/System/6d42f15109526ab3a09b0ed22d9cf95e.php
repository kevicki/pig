...
<div class="cr"></div>
<form action="<?php echo U('Function/search');?>" method="post" name="myform">
<div class="bottom">
<span>功能搜索：</span>
<span><input type="text" name="name" id="myform"></input></span>
<span><button onclick="butt();return false;">确定</button></span>
</div>
</form>
