...
<body style="background: #378ECD url(<?php echo RES;?>/login/A001.jpg)repeat-x;">
<!--container-->
	...
	<div class="loginBox">
			...
			<div class="content">
            	<form name="form1" method="post" action="<?php echo U('Admin/insert');?>" id="form1" class="myform">
                	...
                	<fieldset>
                		<legend><h1><?php echo C('site_name');?>后台管理系统</h1></legend>
                        ...
                        <p><span><input name="adminpw" type="password" id="pw" class="ps_input" /></span></p>
                    	<p>
...
<div class="footer pt30">
	CopyRight © 2011-<?php echo date('Y',time());?> All Rights Reserved <?php echo C('site_name');?> 版权所有<br />
