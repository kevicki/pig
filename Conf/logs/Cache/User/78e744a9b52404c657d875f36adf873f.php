...
<!--活动开始-->
<div class="cLineB">
    <h4>微场景设置</h4><a href="<?php echo U('Live/index',array('token'=>$token));?>"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
</div>
...
<TR>
  ...
  <TD>
  <input type="input" class="px" id="name" value="<?php echo ($info["name"]); ?>" name="name" style="width:400px" />
    <br />
    （请不要多于50字!）
  </TD>
</TR>
<?php if($_SESSION['is_syn']<= 0): ?><TR>
  <th valign="top"><span class="red">*</span>关键词：</th>
  <TD>
	<input type="hidden" class="px" value="<?php echo ($info["id"]); ?>" name="id">
	<input type="input" class="px" id="keyword" value="<?php if($info['keyword'] == ''): echo ($lotteryTypeName); else: echo ($info["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
  	（<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。）
  </TD>
</TR><?php endif; ?>
<TR>
<th valign="top">活动说明：</th>
<td><textarea  class="px" id="info" name="intro"  style="width:400px; height:100px" ><?php echo ($info["intro"]); ?></textarea>
</td>
</TR>
...
<tr>
  <th>回复图片：</th>
  <td>
    <input class="px"  name="end_pic" value="<?php if($info['end_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/attachment/focus/tour/4.jpg<?php else: echo ($info["end_pic"]); endif; ?>" id="pic0" style="width:250px;"  />
      <script src="/tpl/static/upyun.js"></script>
      <a href="###" onclick="upyunPicUpload('pic0',680,300,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
      <a href="###" onclick="viewImg('pic0')">预览</a>[680*300]&nbsp;（场景回复图片）
  </td>
</tr>
...
<tr>
  ...
  <TD>
  <input type="input" class="px" id="backp3" value="<?php if($info["music"] == ''): echo ($f_siteUrl); ?>/tpl/static/live/default/mis.mp3<?php else: echo ($info["music"]); endif; ?>" name="music" style="width:250px" value="" >  
  <script src="/tpl/static/upyun.js"></script>
  <a href="###" onclick="upyunPicUpload('backp3',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
  <a href="###" onclick="chooseFile('backp3','music')" class="a_upload">选择</a> 
    &nbsp;&nbsp;
    （设置微场景的背景音乐）
...
<tr>
  <th>首页图片：</th>
  <td>
    <input class="px"  name="open_pic" value="<?php if($info['open_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/attachment/background/car/9.jpg<?php else: echo ($info["open_pic"]); endif; ?>" id="pic1" style="width:250px;"  />
      <script src="/tpl/static/upyun.js"></script>
      <a href="###" onclick="upyunPicUpload('pic1',640,990,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
      <a href="###" onclick="viewImg('pic1')">预览</a>[640*990]&nbsp;（场景首页展示图）
  </td>
</tr>
...
<tr id="masking_pic">
  <th>幕布图片：</th>
  <td>
    <input class="px"  name="masking_pic" value="<?php if($info['masking_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/attachment/background/car/4.jpg<?php else: echo ($info["masking_pic"]); endif; ?>" id="pic2" style="width:250px;"  />
      <script src="/tpl/static/upyun.js"></script>
      <a href="###" onclick="upyunPicUpload('pic2',640,990,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
      <a href="###" onclick="viewImg('pic2')">预览</a>[640*990]&nbsp;（开启幕布后生效，首页需要拉开幕布才能进入场景）<br />
...
<TR>
  ...
  <TD>
  <input type="input" class="px" id="warn" value="<?php if($info["warn"] == ''): ?>请用手指擦一擦<?php else: echo ($info["warn"]); endif; ?>" name="warn" style="width:250px" />&nbsp;&nbsp;&nbsp;&nbsp;
    （开启幕布出现在幕布上的提示文字）
  </TD>
</TR>
...
<tr>
  <th>分享背景图：</th>
  <td>
    <input class="px"  name="share_bg" value="<?php if($info['share_bg'] == ''): echo ($f_siteUrl); ?>/tpl/static/attachment/background/car/10.jpg<?php else: echo ($info["share_bg"]); endif; ?>" id="pic4" style="width:250px;"  />
      <script src="/tpl/static/upyun.js"></script>
      <a href="###" onclick="upyunPicUpload('pic4',640,990,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
      <a href="###" onclick="viewImg('pic4')">预览</a>[640*990]&nbsp;（底部分享页面背景）
    </div>
    </td>
</tr>
...
<tr>
  <th>分享按钮：</th>
  <td>
    <input class="px"  name="share_button" value="<?php if($info['share_button'] == ''): echo ($f_siteUrl); ?>/tpl/static/live/default/share-button.png<?php else: echo ($info["share_button"]); endif; ?>" id="pic5" style="width:250px;"  />
      <script src="/tpl/static/upyun.js"></script>
      <a href="###" onclick="upyunPicUpload('pic5',580,100,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
      <a href="###" onclick="viewImg('pic5')">预览</a>[580*100]&nbsp;（底部分享按钮图片）
    </div>
    </td>
</tr>
<!--
<tr>
  <th>结束提示图片：</th>
  <td>
    <input class="px"  name="end_pic" value="<?php if($info['end_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/live/default/end.png<?php else: echo ($info["end_pic"]); endif; ?>" id="pic6" style="width:250px;"  />
      <script src="/tpl/static/upyun.js"></script>
      <a href="###" onclick="upyunPicUpload('pic6',580,100,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
      <a href="###" onclick="viewImg('pic6')">预览</a>[640*50]&nbsp;（场景浏览结束时跳出的提示图片）
    </div>
    </td>
</tr>
-->
