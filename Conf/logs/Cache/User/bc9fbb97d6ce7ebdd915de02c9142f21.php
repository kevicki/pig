...
<script type="text/javascript">
	...
	<script src="./tpl/User/default/common/js/jquery.min.js"></script>
	 ...
	 <script src="<?php echo STATICS;?>/layer/layer.js" type="text/javascript"></script>
        <div class="content">
          <div class="cLineB">
              <h4 class="left">微贺卡</h4>
                 
              <div class="clr"></div>
          </div>
          <div class="cLine">
            <div class="pageNavigator left">
				<a href='<?php echo U('Card/cardLibrary',array('token'=>$token));?>' class='btnGrayS vm bigbtn'>从贺卡库中添加贺卡</a>
 ...
 <div id="showdiv<?php echo ($list["id"]); ?>">
   ...
   <div id="testdiv{pigcms:{pigcms:$list.id}"><img src="<?php echo (session('source_domain')); ?>/wap.php?c=Wxapp&a=qrcode&id=<?php echo ($list["id"]); ?>&modle=Card" width="300" height="300" class="cateimg_small"></div>
 </div>
   <a id="lay<?php echo ($list["id"]); ?>" style="width:70px;">查看二维码</a><?php endif; endif; ?>
          <a href="index.php?g=User&m=Card&a=cardSet&id=<?php echo ($list["id"]); ?>&token=<?php echo ($token); ?>">修改</a>
						<a href="index.php?g=User&m=Card&a=delCard&id=<?php echo ($list["id"]); ?>">删除</a>
						<a onclick="qrcode('{changjingUrl}/index.php?m=Card&c=index&a=index&unique=<?php echo ($unique); ?>&crid=<?php echo ($list["cardid"]); ?>&usercardid=<?php echo ($list["id"]); ?>&token=<?php echo ($token); ?>')" href="javascript:void(0)">扫二维码预览</a>
				   </TD>
