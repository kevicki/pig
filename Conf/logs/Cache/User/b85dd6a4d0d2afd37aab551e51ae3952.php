...
<script language="javascript" type="text/javascript" src="<?php echo ($staticPath); ?>/tpl/static/cutprice/js/DatePicker/WdatePicker.js"></script>
...
KindEditor.ready(function(K) {
	editor = K.create('#info', {	
		...
		uploadJson : "<?php echo U('Upyun/kindedtiropic');?>",
		items : [
...
<form class="form" method="post"   action="<?php echo U('Cutprice/doadd',array('token'=>$token));?>" enctype="multipart/form-data" >
	<div class="content">
		<div class="cLineB">
		...
		<div class="cLineB">
			<h4 class="left">添加一个拍卖商品</h4>
			<a href="<?php echo U('Cutprice/index',array('token'=>$token));?>"  class="right btnGreen" >返回</a>
		</div>
					...
					<?php else: ?>
						...
						<td rowspan="999" valign="top">
							<div style="margin-left:20px">
								<img id="wxpic_src" src="<?php echo ($staticPath); ?>/tpl/static/cutprice/images/wximg.jpg" <?php if($usertplid == 2): ?>style="min-width:300px;width:53%;"<?php else: ?>width="373px"<?php endif; ?> >
								<br/>
								<input class="px"  name="wxpic" value="<?php echo ($staticPath); ?>/tpl/static/cutprice/images/wximg.jpg" id="wxpic" <?php if($usertplid == 2): ?>style="min-width:275px;width: 50%;"<?php else: ?>style="width:363px;"<?php endif; ?>  />
								<a href="###" onclick="upyunPicUpload('wxpic',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('wxpic')">预览</a>&nbsp;<span class="red"><strong>*</strong></span>微信图文信息图片，推荐尺寸：900*500
							</div>
						</td>
					</tr>
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="input" class="px" id="starttime" value="<?php echo date("Y-m-d H:i:s",(time()+3600))?>" name="starttime" style="width:130px" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="number" class="px" id="original" value="" name="original" style="width:100px" />&nbsp;原价不能低于起拍价，单位（元）
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="number" class="px" id="startprice" value="" name="startprice" style="width:100px" />&nbsp;起拍价不能低于最低价，单位（元）
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="number" class="px" id="stopprice" value="" name="stopprice" style="width:100px" />&nbsp;最低价不能高于起拍价，单位（元）
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							每&nbsp;<input type="number" class="px" id="cuttime" value="" name="cuttime" style="width:100px" />&nbsp;分钟下降&nbsp;<input type="number" class="px" id="cutprice" value="" name="cutprice" style="width:100px" />&nbsp;元&nbsp;&nbsp;（注：时间和下降钱数相乘不能高于起拍价和最低价的差）
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="number" class="px" id="onebuynum" value="0" name="onebuynum" style="width:100px" />&nbsp;0为不限制，请填写正整数。
						</td>
					</tr>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('logoimg1',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('logoimg1')">预览</a><span class="red"><strong>*</strong></span>推荐尺寸：900*500
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('logoimg2',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('logoimg2')">预览</a><span class="red"><strong>*</strong></span>推荐尺寸：900*500
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('logoimg3',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('logoimg3')">预览</a><span class="red"><strong>*</strong></span>推荐尺寸：900*500
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input class="radio" type="radio" name="state_subscribe" value="0" checked> 是 <input class="radio" type="radio" name="state_subscribe" value="1"> 否<?php echo ($__access_remind__); ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input class="radio" type="radio" name="state_userinfo" value="1"> 是  <input class="radio" type="radio" name="state_userinfo" value="0" checked> 否 <br/>（没有粉丝详细信息参加活动的处理方式）
						</td>
					</tr>
					...
					<tr>
						<th>&nbsp;</th>
						<td><button type="submit" class="btnGreen" >保存</button>　<a href="<?php echo U('Cutprice/index',array('token'=>$token));?>"  class="btnGray vm">取消</a></td>
					</tr>
