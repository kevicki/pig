   ...
   认证公众号才能使用，微信接口不支持删除分组操作，所以添加的时请谨慎操作，如需删除请到公众平台删除，本系统会与公众平台同步
          ...
          <div class="cLine">
            <div class="pageNavigator left">
				<a href="<?php echo U('User/Wechat_group/groupSet');?>" class="btnGrayS vm bigbtn">
					<img src="tpl/User/default/common/images/text.png" class="vm">添加
				</a>
				&nbsp;
				&nbsp;
				<a href="<?php echo U('User/Wechat_group/sysGroups');?>" class="btnGrayS vm bigbtn">
					<img src="tpl/User/default/common/images/text.png" class="vm">同步
				</a>
            </div>
            <div class="clr"></div>
          </div>
          ...
          <input name="delall" type="hidden" value="del">
           <input name="wxid" type="hidden" value="gh_423dwjkewad">
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
			  <?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                  <td><?php echo ($list["id"]); ?></td>
                  <td><?php echo ($list["wechatgroupid"]); ?></td>
                  <td><a href="<?php echo U('Wechat_group/index',array('wechatgroupid'=>$list['wechatgroupid']));?>"><?php echo ($list["name"]); ?></a></td>
				  <td><?php echo ($list["fanscount"]); ?></td>
                  <td><?php echo ($list["intro"]); ?></td>
                  <td class="norightborder">
						<a href="<?php echo U('Wechat_group/groupSet',array('id'=>$list['id']));?>">修改</a>　
				   </td>
