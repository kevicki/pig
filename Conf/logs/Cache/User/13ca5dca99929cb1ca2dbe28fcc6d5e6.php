...
<div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>>
    ...
    <div class="msgWrap form">
        <ul id="tags">
            ...
            <li><a onclick="selectTag('tagContent3',this)" id="colorTab" href="javascript:void(0)">4.颜色风格&预览</a> </li>
            <div class="clr"></div>
        </ul>
<!--首页模板选择-->
...
<script src="<?php echo STATICS;?>/tmpls/js/jquery.lazyload.min.js" type="text/javascript"></script>
		...
		<!--	首页模板选择结束	-->
            ...
            <div class="tagContent" id="tagContent2">
                ...
                <div id="page" class="footactions" style="<?php if($type == 1 || $type == 2): ?>display:block;<?php else: ?>display:none;<?php endif; ?>padding-left:10px;margin-top:170px;">
        ...
        <script type="text/javascript">
            function selectTag(showContent,selfObj){
				...
				if(showContent == 'tagContent1'){
                    ...
                    window.location.href="<?php echo U('Tmpls/index',array('token'=>session('token'),'cid'=>'0','type'=>'3'));?>";
                }else if(showContent == 'tagContent0'){
                    window.location.href="<?php echo U('Tmpls/index',array('token'=>session('token'),'cid'=>'0','type'=>'0'));?>";
                }
	...
	<?php elseif(isset($_GET['cid']) && $_GET['type'] == 2): ?>
                ...
                document.getElementById('tagContent2').style.display = "block";
    <?php elseif(isset($_GET['cid']) && $_GET['type'] == 3): ?>
                                // 操作标签
                var tag = document.getElementById("tags").getElementsByTagName("li");
                var taglength = tag.length;
                for(i=0; i<taglength; i++){
                ...
                document.getElementById('colorTab').parentNode.className = "selectTag";
                // 操作内容
                for(i=0; j=document.getElementById("tagContent"+i); i++){
                    j.style.display = "none";
                }

                document.getElementById('tagContent3').style.display = "block";<?php endif; ?>
        </script>
	...
	$(function(){
		$("img").lazyload();
            ...
            $(".radio").click(function(){
                $(this).parents("li").addClass("active ck").siblings().removeClass('active ck');
