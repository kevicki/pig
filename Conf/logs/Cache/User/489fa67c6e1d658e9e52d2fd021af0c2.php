...
<?php if($reslist['id'] != ''): ?><input type="hidden" name="id" id="id" value="<?php echo ($reslist['id']); ?>"/><?php endif; ?>
    <div class="control-group">
        ...
        <div class="controls">
           <input type="text" placeholder="请输入图文消息标题" name="title" id="title" class="span4"  value="<?php echo ($reslist['title']); ?>" data-validation-engine="validate[required,minSize[2]]"
    ...
    <div class="control-group">
        ...
        <input type="text" name="keyword" id="keyword" class="span4" data-validation-engine="validate[required,minSize[2]]"
                    data-errormessage-value-missing="必填项!"  value="<?php echo ($reslist['keyword']); ?>"><span class="maroon">*</span><span class="help-inline">比如: 儿童英语课程 </span>
        </div>
    </div>
    <div class="control-group">
        ...
        <input type="text" name="typename" id="typename" class="span4" data-validation-engine="validate[required,minSize[2]]"
                    data-errormessage-value-missing="必填项!"  value="<?php echo ($reslist['typename']); ?>"><span class="maroon">*</span><span class="help-inline"> </span>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <input type="text" name="typename2" id="typename2" class="span4" data-validation-engine="validate[required,custom[integer],min[1]]"
                    data-errormessage-value-missing="必填项!"  value="<?php echo ($reslist['typename2']); ?>"><span class="maroon">*</span><span class="help-inline"> </span>
        </div>
    </div>
    <div class="control-group">
        <label for="typename3" class="control-label">开课时间：</label>
        <div class="controls">
        <input type="text" name="typename3" id="typename3" value="<?php if($reslist['typename3'] != ''): echo ($reslist['typename3']); endif; ?>" onClick="WdatePicker({dateFmt:'yyyy-M-d H:mm:ss',minDate:'%y-%M-%d 6:00:00'})" class="span4" data-validation-engine="validate[required]"
        ...
        <div class="controls">
        <input type="text" name="date" id="date" value="<?php if($reslist['date'] != ''): echo ($reslist['date']); endif; ?>" onClick="WdatePicker({dateFmt:'yyyy-M-d H:mm:ss',minDate:'%y-%M-%d 00:00:00'})" class="span4" data-validation-engine="validate[required]"
                    data-errormessage-value-missing="必填项!"  ><span class="maroon">*</span><span class="help-inline"> </span>
        </div>
    </div>
    <div class="control-group">
...
<?php if($reslist['picurl'] != ''): ?><img class="thumb_img" id="picurl_src" src="<?php echo ($reslist['picurl']); ?>" style="max-height:100px;"><?php endif; ?>
      <input id="picurl" type="text" class="span4" name="picurl" class="input-xlarge"  data-validation-engine="validate[required,custom[url]]"
                    data-errormessage-value-missing="必须上传图片!"  data-errormessage-custom-error="如果是手动填写,正确的网址,如: http://www.baidu.com/images/demo.png"  value="<?php echo ($reslist['picurl']); ?>" />
          <span class="help-inline">
               <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('picurl',470,240,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl')">预览</a>
    ...
    <label for="address" class="control-label">预约地址：</label>
     <div class="controls">
        <input type="text" name="address" id="address" class="span4"  value="<?php echo ($reslist['address']); ?>" data-validation-engine="validate[required,minSize[2]]"
    ...
    <label for="suggestId" class="control-label">地图标识：</label>
         <div class="controls">
          ...
          经度 <input type="text" id="longitude"  name="lng" size="14" class="px" value="<?php echo ($reslist['lng']); ?>" />
          纬度 <input type="text" id="latitude" name="lat" size="14"  class="px" value="<?php echo ($reslist['lat']); ?>" />
...
<div class="control-group">
         ...
         <div class="controls">
             <input type="text" name="tel" id="tel" class="span4" value="<?php echo ($reslist['tel']); ?>"  data-validation-engine="validate[required,custom[phone]]" placeholder="请输入有效的电话" placeholder="请输入电话"  placeholder="请输入接收预约的电话号码"/><span class="maroon">*</span><span class="help-inline">如0551-62696666</span>
         </div>
     </div>
     <div class="control-group">
         <label for="project_brief" class="control-label">订单页头部图片：</label>
 <div class="controls">
<?php if($reslist['headpic'] != ''): ?><img class="thumb_img" id="headpic_src" src="<?php echo ($reslist['headpic']); ?>" style="max-height: 100px;"><?php endif; ?>
              <input id="headpic"type="text"class="input-large" name="headpic" class="span4 px"  data-validation-engine="validate[required,custom[url]]"
                    data-errormessage-value-missing="必须上传图片!"  data-errormessage-custom-error="如果是手动填写,正确的网址,如: http://www.baidu.com/images/demo.png"  value="<?php echo ($reslist['headpic']); ?>" />
     ...
     <div class="control-group">
        ...
        <div class="controls">
          <textarea class="input-xlarge" id="infodec" name="info" style="width:560px;height:250px;border:1px #000 solid" data-validation-engine="validate[required,minSize[2]]"
                    data-errormessage-value-missing="必填项!"   placeholder="显示在图文封面下方，文字请尽量的简洁"><?php echo ($reslist['info']); ?></textarea>
        </div>
    </div>
