		...
		<li class="tabli <?php if($type == 6): ?>current<?php endif; ?>"><a href="<?php echo U('Member_card/gifts', array('token' => $token,'id'=>$thisCard['id'],'type' => 6));?>">开卡赠送</a></li>
          ...
          <div class="cLine">
			<div class="pageNavigator left">
				<a class="btnGrayS vm bigbtn" href="<?php echo U('Member_card/scorelottery_edit',array('token'=>$token,'id'=>$thisCard['id']));?>" title="发布礼品券">
					<img src="<?php echo RES;?>/images/cart_info/power3.png" width="24px" class="vm">发布抽奖活动
				</a>　
			</div>
              ...
              <tbody>
                <?php if(is_array($data_vip)): $i = 0; $__LIST__ = $data_vip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data_vip): $mod = ($i % 2 );++$i;?><tr>
					  ...
					  <td class="norightborder">
						<a href="<?php echo U('Member_card/uselotRecords',array('id'=>$thisCard['id'],'type'=>'scorelottery','itemid'=>$data_vip['id']));?>">使用统计</a> 
						<a href="<?php echo U('Member_card/scorelottery_edit',array('id'=>$thisCard['id'],'itemid'=>$data_vip['id']));?>">编辑</a> <a href="<?php echo U('Member_card/scorelottery_del',array('itemid'=>$data_vip['id'],'id'=>$thisCard['id']));?>">删除</a>
					  </td>
