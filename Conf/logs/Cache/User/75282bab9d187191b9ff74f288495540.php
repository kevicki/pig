...
<?php else: ?>
 <div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-bottom:5px;font-size:12px;"><?php endif; ?>温馨提示：1.如不填写活动简介手机端的活动介绍菜单将只显示投票次数说明；如不填写如何参与、流程介绍、奖品设置三项,手机端活动介绍菜单将不显示这三项。<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.如果开启了地区限制则‘是否需要粉丝信息’项必须选择“是”。选择省市时如果只选省份不选城市则该省份下所有城市都可参与。 <br />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.开启地区限制,需购买短信。
</div>
<div class="msgWrap bgfc">
<form class="form" method="post" action="<?php echo U('Voteimg/add_voteimg',array('id'=>$action_id,'token'=>$token));?>" enctype="multipart/form-data" onsubmit="return save_voteimg();">
...
<?php if($_SESSION['is_syn']<= 0): ?><th width="120"><span class="red">*</span>关键词：</th>
