...
<div class="content"  >
  <div class="cLineB">
    <h4 class="left">简历信息管理 (<?php echo ($page); ?> ) </h4>
  </div>
  <div class="tab">
    <ul>
      <li class=" tabli" id="tab2"><a href="<?php echo U('Zhaopin/index');?>">招聘信息管理</a></li>
      <li class=" current tabli" id="tab2"><a href="<?php echo U('Zhaopin/jianli');?>">简历信息管理</a></li>
      <li class=" tabli" id="tab20"><a href="<?php echo U('Zhaopin/reply');?>">回复信息配置</a></li>
    </ul>
  </div>
  <div class="cLine">
    <div class="pageNavigator left" style=" margin-right:30px"> <a href="<?php echo U('Zhaopin/exportFormss',array('token'=>$token));?>" title="导出简历信息" class="btnGrayS vm bigbtn">导出简历信息</a></div>
    <div class="pageNavigator left"> <a href="<?php echo U('Zhaopin/jladd',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png">添加</a></div>
    <div class="clr"></div>
  </div>
  <div class="msgWrap">
    <form method="post" action="" id="info">
      ...
      <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
        <thead>
          <tr>
            <th width="140">求职意向</th>
            <th width="80">性别</th>
            <th width="80">年龄</th>
            <th width="140">学历</th>
            <th width="140">期望薪资</th>
        ...
        <tbody>
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td style="color:#F00"><?php echo (substr($item["date"],0,10)); ?></td>
              <td class="norightborder">
              	<!--&nbsp;&nbsp;<a href="<?php echo U('Zhaopin/infos',array('pid'=>$item['id'],'token'=>$token));?>">应聘者管理</a>-->
                <?php if($item['allow'] == 0): ?>&nbsp;&nbsp;<a href="<?php echo U('Zhaopin/allowJL',array('id'=>$item['id'],'token'=>$token,'allow'=>'1'));?>">未审核</a>
                <?php else: ?>
                    &nbsp;&nbsp;<a href="<?php echo U('Zhaopin/allowJL',array('id'=>$item['id'],'token'=>$token,'allow'=>'0'));?>">已审核</a><?php endif; ?>
                &nbsp;&nbsp;<a href="<?php echo U('Zhaopin/jlset',array('id'=>$item['id'],'token'=>$token));?>">修改</a>
                &nbsp;&nbsp;<a href="<?php echo U('Zhaopin/jldel',array('aid'=>$item['pid'],'id'=>$item['id'],'token'=>$token));?>">删除</a>
              </td>
