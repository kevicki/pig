...
<div class="cLineB">
  <h4> 
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
		  ...
		  <a href="<?php echo U('Micrstore/edit_withdraw',array('id'=>$vo['id'],'token'=>$token));?>" class="btnGreen">编辑</a>
		  <a href="<?php echo U('Micrstore/del_withdraw',array('id'=>$vo['id']));?>" onclick="return(confirm('确定要删除吗？'))" class="btnGreen">删除</a> </td>
		</tr>
