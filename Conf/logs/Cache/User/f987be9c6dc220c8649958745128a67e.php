...
<div class="content">
          ...
          <div class="cLineB">
             <h4>全民经纪人活动 (<?php echo ($count); ?>) 条</h4>
          ...
          <div class="cLine">
			...
			<a href="<?php echo U('MicroBroker/mbkadd',array('token'=>$token));?>" class="btnGrayS vm bigbtn">发布一个全民经纪人活动</a>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                <tr></tr>
				  ...
				  <td><?php echo ($list["invitecode"]); ?></td>
                   <td class="norightborder">
                    <a href="<?php echo U('MicroBroker/mbkClients',array('id'=>$list['id'],'token'=>$token));?>" title="客户管理列表">客户列表</a> |
					<a href="<?php echo U('MicroBroker/mbkBrokers',array('id'=>$list['id'],'token'=>$token));?>" title="经纪人管理列表">经纪人列表</a> |
					<a href="<?php echo U('MicroBroker/mbkConfirm',array('id'=>$list['id'],'token'=>$token));?>" title="佣金管理列表">已回款客户列表</a> |
                    <a href="<?php echo U('MicroBroker/mbkedit',array('id'=>$list['id'],'token'=>$token));?>" title="编辑">编辑</a> |
                    <a href="###" onclick="toDelmbk(<?php echo ($list['id']); ?>)">删 除</a> 
   ...
   <script type="text/javascript">
      function toDelmbk(id){
	  	  if(confirm('您确定要删除吗？删除会把相关数据一起删除的！')){
	     $.post('<?php echo U('MicroBroker/mbkdel');?>',{id:id,token:'<?php echo ($token); ?>'},function(ret){
