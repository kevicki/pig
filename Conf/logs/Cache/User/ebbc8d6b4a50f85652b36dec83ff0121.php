...
<div class="cLineB">
  <h4>留言板配置 </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
				  ...
				  <td>
					<span class="red">留言 —— 当用户输入该关键词时，将会触发此回复。</span></td>
				</tr>
				<tr>
					<th width="120"><span class="red">*</span>图文回复标题：</th>
				...
				<tr>
					<th>头部横幅图片：</th>
					<td><input type="text" name="banner" value="<?php echo (($set['banner'])?($set['banner']):' '); ?>" id="banner" class="px" style="width:550px;"><a href="###" onclick="upyunPicUpload('banner',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('banner')">预览</a> </td>
				</tr>

				<tr>
					<th>需要审核：</th>
					<td><label><input type="checkbox" name="needcheck" value="1" <?php if($set["needcheck"] == 1): ?>checked<?php endif; ?> /> 需要审核</label></td>
				</tr>
				<tr>
					<th>启用查看密码：</th>
					<td><label><input type="checkbox" name="needpass" value="1" <?php if($set["needpass"] == 1): ?>checked<?php endif; ?> /> 启用</label></td>
				</tr>
				<tr>
					<th>请设置查看密码：</th>
					<td><input type="password"class="px" name="readpass" value="" /> *修改时留空则不修改密码</td>
				</tr>
				<th>&nbsp;</th>
					<td>
					<input type="hidden" name="infotype" value="message" />
