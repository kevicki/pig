...
<div class="content" >  
 ...
 <div class="ftip" style="margin:25px auto 5px auto;">请先设置如下信息</div>
<div class="msgWrap">
<form class="form" method="post" enctype="multipart/form-data" >
<TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
  <THEAD>
				<tr>
					<th width="120">微信号名称：</th>
					<td><input type="text" name="wxname" value="<?php echo ($info["wxname"]); ?>" class="px" style="width:550px;"></td>
				</tr>
				<tr>
					<th width="120">微信号：</th>
					<td><input type="text" name="wxid" value="<?php echo ($info["wxid"]); ?>" class="px" style="width:550px;"></td>
				</tr>
				<tr>
					<th>微信号logo：</th>
					<td><input type="text" name="wxlogo" id="wxlogo" value="<?php echo ($info["wxlogo"]); ?>" class="px" style="width:550px;">   <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('wxlogo',120,120,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('wxlogo')">预览</a> 长360 宽200</td>
				</tr>
				<tr>
					<th width="120">链接：</th>
					<td><input type="text" name="link" value="<?php echo ($info["link"]); ?>" id="link" class="px" style="width:550px;"> <a href="###" onclick="addLink('link',0)" class="a_choose">从功能库添加</a></td>
				</tr>
				<tr>
					<th width="120">引导关注语：</th>
					<td><input type="text" name="attentionText" value="<?php echo ($info["attentionText"]); ?>" id="attentionText" class="px" style="width:550px;"><br/>一键关注（或者其他带有关注的词）被微信定为诱导关注，此项可以填写你想要的引导关注语句来指引用户关注</td>
				</tr>
<TR>
  <TH></TH>
