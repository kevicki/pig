...
<div class="cLineB">
  <h4>邀请函回复配置 </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tbody>
				<tr>
				  ...
				  <td>
					<span class="red"><input type="text" name="keyword" value="<?php echo ($Invite["keyword"]); ?>" class="px" style="width:550px;height:25px;height:25px;">当用户输入该关键词时，将会触发此回复。<br>多个关键词间用空格。</span></td>
				</tr>
				<tr>
					<th width="120"><span class="red">*</span>回复标题　　:</th>
					<td><input type="text" name="title" value="<?php echo ($Invite["title"]); ?>" class="px" style="width:550px;height:25px;height:25px;"></td>
				</tr>
				<tr>
					<th><span class="red">*</span>回复图片　　:</th>
					<td><input type="text" name="replypic" value="<?php echo (($Invite["replypic"])?($Invite["replypic"]):$staticPath.'/tpl/static/attachment/focus/wedding/10.jpg'); ?>" class="px" style="width:550px;height:25px;height:25px;" id="pic" onblur="document.getElementById('pic_src').src=document.getElementById('pic').value;document.getElementById('zpic2').src=document.getElementById('pic').value;" onchange="document.getElementById('pic_src').src=document.getElementById('pic').value;document.getElementById('zpic2').src=document.getElementById('pic').value;">
                    <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a></td>
				</tr>
				<tr>
					<th width="120"><span class="red">*</span>内容介绍　　:</th>
					<td><textarea style="width:550px;height:25px;height:75px" name="content" id="info" class="px"><?php echo ($Invite["content"]); ?></textarea>最多填写120个字</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="cover" id="cover" value="<?php echo (($Invite["cover"])?($Invite["cover"]):$staticPath.'/tpl/static/attachment/background/wedding/1.jpg'); ?>" class="px" style="width:550px;height:25px;"><script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script> <a href="###" onclick="upyunPicUpload('cover',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('cover')">预览</a></td>
				</tr>
				<tr>
					<th><span class="red">*</span>背景图片　　:</th>
					<td><input type="text" name="inback" id="inback" value="<?php echo (($Invite["inback"])?($Invite["inback"]):$staticPath.'/tpl/static/attachment/background/wedding/8.jpg'); ?>" class="px" style="width:550px;height:25px;">   <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('inback',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('inback')">预览</a></td>
				</tr>
				<tr>
					<th width="120">&nbsp&nbsp注意事项　　:</th>
					<td><input type="text" name="warn" value="<?php echo ($Invite["warn"]); ?>" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th width="120"><span class="red">*</span>主办方电话　:</th>
					<td><input type="text" name="photo" value="<?php echo ($Invite["photo"]); ?>" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th width="120">&nbsp&nbsp主办方邮箱　:</th>
					<td><input type="text" name="email" value="<?php echo ($Invite["email"]); ?>" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="linkman" value="<?php echo ($Invite["linkman"]); ?>" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th><span class="red">*</span>活动介绍图片:</th>
					<td><input type="text" name="meetpic" id="meetpic" value="<?php echo (($Invite["meetpic"])?($Invite["meetpic"]):$staticPath.'/tpl/static/attachment/background/wedding/14.jpg'); ?>" class="px" style="width:550px;height:25px;">   <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('meetpic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('meetpic')">预览</a></td>
				</tr>
				<tr>
					<th>&nbsp&nbsp主办方二维码:</th>
					<td><input type="text" name="twopic" id="twopic" value="<?php echo ($Invite["twopic"]); ?>" class="px" style="width:550px;height:25px;">   <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('twopic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('twopic')">预览</a></td>
				</tr>
				<tr>
					<th width="120">&nbsp;&nbsp;活动网站链接:</th>
					<td><input type="text" name="themeurl" value="<?php echo ($Invite["themeurl"]); ?>" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th width="120">&nbsp;&nbsp;活动网站名称:</th>
					<td><input type="text" name="theme" value="<?php echo ($Invite["theme"]); ?>" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<th>&nbsp;</th>
					<td>
