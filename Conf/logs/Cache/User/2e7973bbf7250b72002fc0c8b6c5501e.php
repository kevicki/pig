...
<div class="cLineB">
  <h4>邀请函主要人物 </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div> 
	  ...
	  <form class="form" method="post" action="" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
					<th width="120">人名　　：</th>
					<td><input type="text" name="username"class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th>头像　　：</th>
					<td><input type="text" name="headpic" id="headpic" class="px" style="width:550px;height:25px;">   <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('headpic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('headpic')">预览</a></td>
				</tr>
				<tr>
					<th width="120">身份　　：</th>
					<td><input type="text" name="position" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th width="120">介绍　　：</th>
					<td><textarea style="width:550px;height:25px;height:75px" name="synopsis" id="synopsis" class="px"></textarea><br/></td>
				</tr>
				<th>&nbsp;</th>
					<td>
...
<div style="width:990px;height:auto;" class="tab_th">
<table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%" style="text-align:center;">
<thead>
<tr><th>头像</th><th>人名</th><th>身份</th><th>介绍</th><th>操作</th></tr>
</thead>
<tbody>
<tr></tr>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Invite): $mod = ($i % 2 );++$i;?><tr><td><img src="<?php echo ($Invite["headpic"]); ?>" style="width:50px;height:50px;"></td><td><?php echo ($Invite["username"]); ?></td><td><?php echo ($Invite["position"]); ?></td><td><?php echo ($Invite["synopsis"]); ?></td><td><a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Invite/userdel',array('token'=>$_GET['token'],'id'=>$Invite['id']));?>');"><font color="red" size="2"><b>删除</b></font></a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
</tbody>
</table>
</div>
