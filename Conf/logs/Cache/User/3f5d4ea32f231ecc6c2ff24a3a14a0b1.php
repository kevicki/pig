...
<td><?php echo ($hostlist["truename"]); ?></td>
<td><?php echo ($hostlist["tel"]); ?></td>
<td><?php echo ($hostlist["score"]); ?></td>
<td><?php echo ($hostlist["content"]); ?></td>
<td><?php echo ($hostlist["productinfo"]); ?></td>
<td><?php echo (date("Y-m-d H:i:s",$hostlist["dateline"])); ?></td> 
<td class="norightborder" align="center">
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/commentdel',array('id'=>$hostlist['id'],'token'=>$token,'catid'=>$catid,'pid'=>$hostlist['pid']));?>');">删除</a>
</td>
