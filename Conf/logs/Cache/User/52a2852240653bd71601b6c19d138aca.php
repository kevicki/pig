...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        <div class="content">
<div class="cLineB">
<h4 class="left">微场景</h4>
<div class="clr"></div>
</div>

<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Live/add',array('token'=>$token));?>" title="添加场景" class="btnGrayS vm bigbtn"><?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" class="vm"><?php endif; ?> 添加场景</a></div>
...
<thead>
<tr>
<th width="160">场景名称</th>
<th width="160">关键词</th>
<th width="130">添加时间</th>
 <th width="80">是否开启</th>
<th width="260" class="norightborder">操作</th>
</tr>
</thead>
<tbody>
<tr></tr>
...
<script type="text/javascript">
 ...
 <style type="text/css">
   #brg<?php echo ($item["id"]); ?>{ z-index:9999;width:100%; height:100%; background:#333; position:absolute; top:0; left:0; filter:alpha(opacity=60); -moz-opacity:0.6; opacity: 0.6; position:absolute; top:0; left:0; display:none;}
   #showdiv<?php echo ($item["id"]); ?>{z-index:9999; display:none;position:fixed; *position:absolute;top:30%; left:50%; margin:-50px 0 0 -50px;}
 ...
 <div id="showdiv<?php echo ($item["id"]); ?>">
   ...
   <div id="testdiv<?php echo ($item["id"]); ?>"><img src="<?php echo (session('source_domain')); ?>/wap.php?c=Wxapp&a=qrcode&id=<?php echo ($item["id"]); ?>&modle=Live" width="300" height="300" class="cateimg_small"></div>
 </div>
<?php if($_SESSION['is_syn']== 2): if($usertplid != 2): ?><a id="lay<?php echo ($item["id"]); ?>" style="width:191px;">查看二维码</a><br><?php endif; endif; ?>
	<a href="<?php echo U('Live/content',array('id'=>$item['id'],'token'=>$token));?>">场景内容</a>
<?php if($item["show_company"] == '1'): ?><!--<a href="<?php echo U('Company/branches',array('id'=>$item['id'],'token'=>$token,'isBranch'=>1));?>">公司分支信息</a>-->
	<a href="<?php echo U('Live/company',array('id'=>$item['id'],'token'=>$token));?>">商家展示</a><?php endif; ?>
	<a href="<?php echo U('Live/add',array('id'=>$item['id'],'token'=>$token));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Live/del',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
