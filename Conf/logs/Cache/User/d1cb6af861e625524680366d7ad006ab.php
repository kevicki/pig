...
<div class="msgWrap form">
  ...
  <th style=" width:100px;">交易状态</th>
              ...
              <th style=" width:120px;">查看订单</th>
            </tr>
          </thead>
<?php if(is_array($book)): $i = 0; $__LIST__ = $book;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
              <td><?php echo ($vo["orderid"]); ?></td>
              <td><?php echo ($vo["true_name"]); ?></td>
              <td><?php echo ($vo["price"]); ?></td>
              <td><?php echo (date("Y-m-d H:i:s", $vo["book_time"])); ?></td>
			        <td><?php echo ($vo["ptype"]); ?></td>
              <td><?php if($vo['paid'] == 0): if($vo['paytype'] == 'daofu' || $vo['paytype'] == 'dianfu'): ?>等待卖家发货<?php else: ?>未付款<?php endif; elseif($vo['paid'] == 1): ?>买家已付款，等待卖家发货<?php elseif($vo['paid'] == 2): ?>卖家已发货<?php elseif($vo['paid'] == 3): ?>买家已收货<?php endif; ?></td>
              <td class="norightborder">
              <a href="<?php echo U('Seckill/order_detail',array('bid'=>$vo['book_id'],'sid'=>$vo['shop_id'], 'type'=>'seckill'));?>" class="btnGreen">查看</a>
            </tr>
