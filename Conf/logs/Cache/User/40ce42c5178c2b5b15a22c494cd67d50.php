		...
		<div class="media_preview_area" id="js_preview_area">
			<div class="msg_card">
				<div class="msg_card_inner">
					<p class="msg_title">
						<?php if($vip["type"] == '1'): ?>优惠券
						<?php elseif($vip["type"] == '2'): ?>
							礼品券
						<?php else: ?>
							代金券<?php endif; ?>
					</p>
					<div class="js_preview msg_card_section shop disabled">
						<div class="shop_panel" id="img_preview">
							<img src="<?php if($vip["pic"] == '' or $vip["type"] == '1'): echo ($staticPath); ?>/tpl/static/card/images/youhui.png<?php elseif($vip["pic"] == '' and $vip["type"] == '0'): echo ($staticPath); ?>/tpl/static/card/images/daijin.png<?php echo ($vip["pic"]); elseif($vip["pic"] == '' and $vip["type"] == '2'): echo ($staticPath); ?>/tpl/static/card/images/lipin.png<?php else: echo ($vip["pic"]); endif; ?>" id="pic_src" style="max-width:100%;max-height:100%;">
						</div>
						<div class="shop_panel" id="color_preview" style="display:none;">	
							<div class="logo_area group">
								<span class="logo left">
									<img src="<?php echo ($vip["logourl"]); ?>" id="logourl_src">
								</span>
					...
					<div class="inner">
						<div class="editor_section">
							...
							<div class="appmsg_edit_item frm_normal">
								...
								<input type="input" id="title" value="<?php echo ($vip["title"]); ?>" name="title" target="#js_title_tip" data-maxlength="9" class="frm_input js_can_preview js_maxlength" placeholder="">
								</span>
								<p class="frm_tips">
...
<!-- 							<div class="appmsg_edit_item frm_normal">
	...
	<div class="frm_controls frm_vertical_lh">
		<div class="radio_control_group group" style="line-height: 32px;">
			<label class="frm_radio_label frm_radio_input selected" for="checkbox1">
				...
				<input type="radio" disabled="true"  <?php if($vip['type'] == '1' or $vip['type'] == ''): ?>checked="checked"<?php endif; ?> name="type" class="type" value="1">
				<span class="lbl_content">优惠券</span>&nbsp;&nbsp;
				<input type="radio" disabled="true"  <?php if($vip['type'] == '2' and $vip['type'] != ''): ?>checked="checked"<?php endif; ?>  name="type" class="type" value="2">
				<span class="lbl_content">礼品券</span>&nbsp;&nbsp;
				<input type="radio" disabled="true" <?php if($vip['type'] == '0' and $vip['type'] != ''): ?>checked="checked"<?php endif; ?>  name="type"  class="type" value="0">
	...
	<p class="frm_tips">微信卡券类型不支持修改</p>
							...
							<div class="appmsg_edit_item frm_normal gift" <?php if($vip['type'] == '2'): else: ?>style="display:none"<?php endif; ?>>
								<label for="" class="frm_label">
							...
							<div class="appmsg_edit_item frm_normal cktime" <?php if($vip['type'] == '0'): else: ?>style="display:none"<?php endif; ?>>
								<label for="" class="frm_label">
						...
						<div class="editor_section">
							...
							<div class="appmsg_edit_item">
								...
								<div class="input_submsg">
									<span class="frm_input_box no_border">
										<input type="input" id="total" value="<?php if($vip['total'] == ''): ?>100<?php else: echo ($vip["total"]); endif; ?>" name="total" class="frm_input js_can_preview js_maxlength valid"  disabled="true">
									</span>
					...
					<div class="inner">
						<div class="editor_section">
							...
							<div class="appmsg_edit_item">
								...
								<span class="frm_input_box no_border">
									<input type="input" value="<?php echo ($vip['brand_name']); ?>" name="brand_name" id="brand_name" class="frm_input js_can_preview js_maxlength valid" disabled="true">
								</span>
							...
							<div class="appmsg_edit_item frm_normal upload_item">
								...
								<p class="frm_tips">
									<span class="frm_input_box">
										<input type="text" name="logourl" id="logourl" value="<?php echo ($vip['logourl']); ?>"  class="frm_input js_can_preview js_maxlength valid" >
									</span>
	...
	<div class="tool_bar border tc">
		<input type="hidden" name="type" value="<?php echo ($vip["type"]); ?>">
		<input type="hidden" name="id" value="<?php echo ($vip["id"]); ?>">
		<input type="hidden" name="token" value="<?php echo ($vip["token"]); ?>">
		<input type="hidden" name="card_id" value="<?php echo ($vip["card_id"]); ?>">
