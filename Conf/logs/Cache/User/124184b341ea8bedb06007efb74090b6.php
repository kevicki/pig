...
<?php else: ?>
 ...
 <a href="<?php echo U('Flash/add',array('tip'=>$tip));?>" class="btnGrayS vm bigbtn" ><?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" class="vm"><?php endif; ?> <?php if($tip == 1): ?>添加幻灯片<?php else: ?>添加背景图<?php endif; ?></a> 
</div>
...
<th><?php if($tip == 1): ?>幻灯片图片<?php else: ?>背景图图片<?php endif; ?> <a  target="999" class="tooltips" ><?php if($usertplid == 2): ?><i class="fa fa-bullhorn" style="color:#1ab394;"></i><?php else: ?><img src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><?php endif; ?><span>
<p>如果不填写分类图片地址系统将随机分配默认图片。</p>
</span></a></th>
                        <th><?php if($tip == 1): ?>幻灯片外链地址<?php else: ?>背景图外链地址<?php endif; ?><span class="tooltips" > <?php if($usertplid == 2): ?><i class="fa fa-bullhorn" style="color:#1ab394;"></i><?php else: ?><img src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><?php endif; ?><span>
<p>比如你想跳转到百度，就填写<a class="red">http://www.baidu.com</a></p>
<p>不需要跳转就不用填写，还可以外链活动，</p>
<p>直接填写活动外链地址：<a class="red">大转盘387</a></p>
</span></span></th>

                        <th style=" width:190px;" class="norightborder">操作</th>
</tr>
</thead>
