...
<div class="content">
          ...
          <div class="msgWrap">
           <div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-top:5px;">注意:这里您可以添加预约的课程,供家长和学生选择. &nbsp;&nbsp;&nbsp; <a class="btn" href="javascript:location.reload()">刷新本页面</a></div>
        </div>
        ...
        <a href="<?php echo U('School/subscribe_add',array('token'=>$token,'addtype'=>'course'));?>" class="btnGrayS vm bigbtn">
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                <?php if(is_array($reslist)): $i = 0; $__LIST__ = $reslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td >
                             <a href="<?php echo U('School/res_manage',array('token'=>$vo['token'],'id'=>$vo['id'],'addtype'=>$vo['addtype']));?>" class="btn" title="订单管理">订单管理</a>
                            <a class="btn" href="<?php echo U('School/subscribe_add',array('token'=>$vo['token'],'id'=>$vo['id'],'addtype'=>$vo['addtype'],'type'=>'edit'));?>" title="编辑">编辑</a>
                             <a class="btn" href="<?php echo U('School/subscribe_del',array('token'=>$vo['token'],'id'=>$vo['id'],'addtype'=>$vo['addtype']));?>" onclick="return(confirm('确定要删除吗？'))"  title="删除">删除</a></td>
