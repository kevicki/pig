...
<div class="msgWrap">
  <form class="form" method="post"   action="<?php echo U('Voiceresponse/insert');?>"  target="_top" enctype="multipart/form-data" >
<TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
  <THEAD>
                          <TR>
  <TH valign="top"><span class="red">*</span><label for="keyword">关键词：</label></TH>
  <TD><input type="input" class="px" id="keyword" value="" name="keyword" style="width:600px" ><br />
                  多个关键词请用空格格开：例如: 美丽&nbsp;漂亮&nbsp;好看</TD>
</TR>
<TR>
  <TH valign="top"><span class="red">*</span><label for="Title">音乐标题：</label></TH>
  <TD><input type="input" class="px" id="Title" value="" name="title" style="width:600px" > <p>注明：添加QQ音乐因为腾讯防盗链，<span class="red">后台无法试听,但微信可以播放!</span></p>
                  </TD>
</TR>
                            <TR>
  <TH valign="top"><span class="red">*</span><label for="MusicUrl">音乐链接：</label></TH>
  <TD><input type="input" class="px" id="musicurl" value="" name="musicurl" style="width:600px" > <script src="/tpl/static/upyun.js?2013"></script><a href="###" onclick="upyunPicUpload('musicurl',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;<a href="###" onclick="chooseFile('musicurl','music')" class="a_upload">选择</a> <br />
                  </TD>
</TR>
                            <TR>
  <TH valign="top"><span class="red">*</span><label for="HQMusicUrl">高品质音乐链接：</label></TH>
  <TD><input type="input" class="px" id="HQMusicUrl" value="" name="hqmusicurl" style="width:600px" > <a href="###" onclick="upyunPicUpload('HQMusicUrl',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;<a href="###" onclick="chooseFile('HQMusicUrl','music')" class="a_upload">选择</a><br />没有高品质音乐链接，请直接再填一遍音乐链接。（高质量音乐链接，WIFI环境优先使用该链接播放音乐）
                  </TD>
</TR>
  </THEAD>
  <TBODY>
...
<TR>
  <TH></TH>
  <TD><button type="submit"  name="button"  class="btnGreen left" >保存</button>　<a href="index.php?ac=mp3list&amp;id=9379"  class="btnGray vm">取消</a>
  <div class="clr"></div>
</TD>
</TR>
  </TBODY>
