...
<form class="form" method="post"   action="<?php echo U('Unitary/doadd',array('token'=>$token));?>" enctype="multipart/form-data" >
...
<div class="content">
	<div class="cLineB" id="ooo">
		...
		<a href="<?php echo U('Unitary/index',array('token'=>$token));?>"  class="right btnGreen" >返回</a>
	</div>
			...
			<tbody>
				<tr>
					...
					<td rowspan="999" valign="top">
						<div style="margin-left:20px">
							<img id="wxpic_src" src="<?php echo ($staticPath); ?>/tpl/static/unitary/images/wxnewspic.jpg" width="373px" >
							<br/>
							<input class="px"  name="wxpic" value="<?php echo ($staticPath); ?>/tpl/static/unitary/images/wxnewspic.jpg" id="wxpic" style="width:363px;"  />
							<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('wxpic',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('wxpic')">预览</a>&nbsp;<span class="red"><strong>*</strong></span>微信图文信息图片，推荐尺寸：900*500
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2">
						...
						<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('logopic',400,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('logopic')">预览</a><br/><span class="red"><strong>*</strong></span>推荐尺寸：400*400
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('fistpic',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('fistpic')">预览</a><br/><span class="red"><strong>*</strong></span>推荐尺寸：900*500
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('secondpic',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('secondpic')">预览</a>
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('thirdpic',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('thirdpic')">预览</a>
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('fourpic',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('fourpic')">预览</a>
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('fivepic',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('fivepic')">预览</a>
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('sixpic',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('sixpic')">预览</a>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<th>&nbsp;</th>
					<td><button type="submit" class="btnGreen" >保存</button>　<a href="<?php echo U('Unitary/index',array('token'=>$token));?>"  class="btnGray vm">取消</a></td>
				</tr>
			</tbody>
		</table>
	</div>
