...
<script type="text/javascript"
	src="/tpl/static/audioplayer/inc/jquery.jplayer.min.js"></script>
<script type="text/javascript"
	src="/tpl/static/audioplayer/inc/jquery.mb.miniPlayer.js"></script>
<link rel="stylesheet" type="text/css"
	href="/tpl/static/audioplayer/css/miniplayer.css" title="style"
	media="screen" />
<div class="content">
	<div class="cLineB">
		<h4 class="left">当前位置：微学校 >> 首页版块</h4>
		<a class="right btnGreen vm" style="margin-top: -2px"
			href="<?php echo U('School/cat_add',array('token'=>$token,'type'=>'cat'));?>">添加版块</a>
		<div class="clr"></div>
	</div>
	<div class="cLineD"></div>
	<div class="msgWrap">
		<div class="msgWrap">
			<table class="ListProduct" style="margin: 0;" border="0"
				cellspacing="0" cellpadding="0" width="100%">
				<THEAD>
					<TR>
						<TH width="100">图标</TH>
						<TH width="120">版块名称</TH>
						<TH width="150">版块链接</TH>
						<TH width="50">排序</TH>
						<TH width="60">是否显示</TH>
						<TH width="100">操作</TH>
					</TR>
				...
				<TBODY>
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><TR>
						<td><img src="<?php echo ($list['icon']); ?>" style="width:50px;height:50px;"></td>
						<TD><?php echo ($list['name']); ?></TD>
						<TD><?php echo ($list['url']); ?></TD>
						<TD><?php echo ($list['sort']); ?></TD>
						<TD><?php if($list['is_show'] == '1'): ?>显示<?php endif; ?> <?php if($list['is_show'] == '0'): ?>隐藏<?php endif; ?></TD>	
						<TD><a href="<?php echo U('School/cat_add',array('token'=>$token,'id'=>$list['id'],'type'=>'cat'));?>"><font color="red">编辑</font></a>
						<?php if($list['system'] == '0'): ?><a href="<?php echo U('School/cat_del',array('token'=>$token,'id'=>$list['id'],'type'=>'cat'));?>" onclick="return(confirm('确定要删除吗？'))" title="删除">
							<font color="#CCC7C7">删除</font>
							</a><?php endif; ?>
						</TD>
