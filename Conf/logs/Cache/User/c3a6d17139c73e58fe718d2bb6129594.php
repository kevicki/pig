...
<div class="cLineB">
  <h4>邀请函活动安排 </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
    <div class="msgWrap bgfc">
	  <form class="form" method="post" action="" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
					<th width="120">具体时间：</th>
					<td><input type="input" class="px" style="width:550px;height:25px;" id="statdate" value="" onClick="WdatePicker()" name="time" /></td>
				</tr>
				<tr>
					<th width="120">具体时分：</th>
					<td><input type="text" name="ytime" value="" class="px" style="width:172px;height:25px;">到<input type="text" name="xtime" value="" class="px" style="width:172px;height:25px;">(时分，例:5:30到6:40,注:英文冒号)</td>
				</tr>
				<tr>
					<th width="120">人物　　：</th>
					<td><input type="text" name="guest" value="<?php echo ($Invite["guest"]); ?>" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th width="120">电话　　：</th>
					<td><input type="text" name="call" value="<?php echo ($Invite["call"]); ?>" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th width="120">地址　　：</th>
					<td><input type="text" name="site" value="<?php echo ($Invite["site"]); ?>" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th width="120">内容　　：</th>
					<td><textarea style="width:550px;height:25px;height:75px" name="content" id="content" class="px"></textarea></td>
				</tr>
				<th>&nbsp;</th>
					<td>
						<button type="submit" class="btnGreen">添加</button>
...
<thead>
<tr><th>时间(月日)</th><th>时间(时分)</th><th>人物</th><th>电话</th><th>地址</th><th>内容</th><th>操作</th></tr>
</thead>
<tbody>
<tr></tr>
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Invite): $mod = ($i % 2 );++$i;?><tr><td><?php echo (date("Y-m-d",$Invite["time"])); ?></td><td><?php echo (date("H:i",$Invite["ytime"])); ?>-<?php echo (date("H:i",$Invite["xtime"])); ?></td><td><?php echo ($Invite["guest"]); ?></td><td><?php echo ($Invite["call"]); ?></td><td><?php echo ($Invite["site"]); ?></td><td><?php echo ($Invite["content"]); ?></td><td><a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Invite/meetdel',array('token'=>$_GET['token'],'id'=>$Invite['id']));?>');"><font color="red" size="2"><b>删除</b></font></a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
</tbody>
</table>
   </div>
