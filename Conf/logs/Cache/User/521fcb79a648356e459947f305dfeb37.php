...
<div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>>
 ...
 <TH><label for="writer">作者：</label></TH>
                  <TD><input type="text" class="px" id="writer" value="<?php echo ($info["writer"]); ?>"    name="writer" style="width:580px;"> </TD>
                </TR>
                ...
                <TR style="display:none">
                  ...
                  <TD><input type="text" class="px"  name="pic" id="pic" value="" style="width:580px;"  />  <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a>
</TD>
                </TR>
               <TR>
                  ...
                  <TD>
                      &nbsp;&nbsp;&nbsp;
                      是<input class="radio" type="radio" name="showpic" value="1"  checked="true"/>
                      &nbsp;&nbsp;
                      &nbsp;&nbsp;
                      &nbsp;&nbsp;
                      否<input class="radio" type="radio" name="showpic" value="0"/>
                ...
                <TR>
                  ...
                  <TD>
                      隐藏<input class="radio" type="radio" name="is_focus" value="0" checked="true"/>
                      &nbsp;&nbsp;
                      &nbsp;&nbsp;
                      显示<input class="radio" type="radio" name="is_focus" value="1"/>
                       &nbsp;&nbsp;
 ...
 if( 2 < $wxuser['winxintype']): ?>
                 ...
                 <TR>
                  ...
                  <TD><input type="text" class="px" id="url" value="" name="url" style="width:280px;">  <?php if(session('isQcloud') != true): ?><a href="###" onclick="addLink('url',0)" class="a_choose">从功能库添加</a><?php endif; ?><br /><span class="red">如需跳转到其他网址，请在输入框右侧选择或这里填写网址(例如：http://baidu.com，记住如果填写必须有http://)</span>如果填写了图文详细内容，这里请留空，不要设置！</TD>
                </TR>
                <script>
	...
	art.dialog.open('<?php echo U('Map/setLatLng',array('token'=>$token,'id'=>$id));?>',{lock:false,title:'设置经纬度',width:600,height:400,yesText:'关闭',background: '#000',opacity: 0.87});
                ...
                <tr> 
					...
					<td>经度 <input type="text" id="longitude"  name="longitude" size="14" class="px" value="<?php echo ($set["longitude"]); ?>" /> 纬度 <input type="text"  name="latitude" size="14" id="latitude" class="px" value="<?php echo ($set["latitude"]); ?>" /> <a href="###" onclick="setlatlng($('#longitude').val(),$('#latitude').val())">在地图中查看/设置</a>&nbsp;&nbsp;可以根据粉丝发送的地理位置后推送最近的图文（可以不填）</td> 
				</tr>
