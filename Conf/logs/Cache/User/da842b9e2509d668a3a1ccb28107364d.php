...
<div class="cLineB">
  <h4>邀请函合作伙伴 </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
    <div class="msgWrap bgfc">
	  <form class="form" method="post" action="" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
					<th width="120">伙伴类型　：</th>
					<td><input type="text" name="partnertype"class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th>伙伴LOGO ：</th>
					<td><input type="text" name="typepic" id="typepic" class="px" style="width:550px;height:25px;">   <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('typepic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('typepic')">预览</a></td>
				</tr>
				<tr>
					<th width="120">伙伴名称　：</th>
					<td><input type="text" name="company" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th width="120">联系方式　：</th>
					<td><input type="text" name="photo" class="px" style="width:550px;height:25px;"></td>
				</tr>
				<tr>
					<th width="120">方案计划　：</th>
					<td><pre><textarea style="width:550px;height:25px;height:75px;white-space: pre-wrap;" name="scheme"class="px"></textarea></pre><font color="red"></font><br/></td>
				</tr>
				<th>&nbsp;</th>
					<td>
  ...
  <div class="tab_th">
		...
		<thead>
		<tr><th>伙伴logo</th><th>伙伴类型</th><th>伙伴名称</th><th>联系方式</th><th>方案计划</th><th>操作</th></tr>
		</thead>
		<tbody>
		<tr></tr>
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Invite): $mod = ($i % 2 );++$i;?><tr><td><img src="<?php echo ($Invite["typepic"]); ?>" style="width:50px;height:50px;"></td><td><?php echo ($Invite["partnertype"]); ?></td><td><?php echo ($Invite["company"]); ?></td><td><?php echo ($Invite["photo"]); ?></td><td width="55%"><?php echo ($Invite["scheme"]); ?></td><td><a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Invite/pardel',array('token'=>$Invite['token'],'id'=>$Invite['id']));?>');"><font color="red" size="2"><b>删除</b></font></a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
		</tbody>
		</table>
   </div>
