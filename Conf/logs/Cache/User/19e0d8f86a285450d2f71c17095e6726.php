...
<?php else: ?>
	...
	<li class="current tabli" id="tab2"><a href="<?php echo U('Store/flash',array('token'=>$token));?>">商城背景与轮播图</a></li>
...
<a href="<?php echo U('Store/flashadd', array('token' => $token, 'cid' => $cid, 'type' => 0));?>" title="添加背景图" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">添加背景图</a>
</div>
<div class="pageNavigator right"> 
<a href="<?php echo U('Store/flashadd', array('token' => $token, 'cid' => $cid, 'type' => 1));?>" title="添加幻灯片" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">添加幻灯片</a>
</div>
<div class="clr"></div>
</div>
...
<?php if(is_array($flash)): $i = 0; $__LIST__ = $flash;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($vo["info"]); ?></td>
<td><?php if($vo['type'] == 0): ?>背景图<?php else: ?>幻灯片<?php endif; ?></td>
...
<td class="norightborder">
	...
	<a href="<?php echo U('Store/flashadd',array('id'=>$vo['id'],'type'=>$vo['type']));?>">编辑</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/flashdel',array('id'=>$vo['id']));?>');">删除</a>
</td>
