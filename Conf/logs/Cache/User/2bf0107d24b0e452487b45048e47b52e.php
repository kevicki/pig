...
<li class="<?php if(ACTION_NAME == 'wap_nav'): ?>selectTag<?php endif; ?> " id="tab2"><a href="<?php echo U('Market/wap_nav',array('token'=>$token,'type'=>'market'));?>">商圈首页板块设置</a></li>
  ...
  <div class="cLineB">
    <h4>请设置商圈信息</h4>
    <a href="<?php echo U('Market/tenant',array('token'=>$token));?>" class="right  btnGreen" style="margin-top:-27px">返回商家</a> 
</div>
...
<tr>
            ...
            <td><input type="input" class="px" id="mtitle" value="<?php echo ($market['name']); ?>" name="name" style="width:400px" data-validation-engine="validate[required,minSize[2],maxSize[50]]" data-errormessage-value-missing="必填项">
              <br>
            </td>
            <td></td>
          </tr>
 <tr>
  ...
  <td><input type="input" class="px" id="keyword" value="<?php echo ($market['keyword']); ?>" name="keyword"  data-validation-engine="validate[required,minSize[1],maxSize[20]]" data-errormessage-value-missing="必填项">
         10个字以内         </td>
  <td></td>
</tr>         
<tr>
  <th valign="top"><span class="red">*</span><label for="keyword">图文消息标题</label></th>
  <td><input type="input" class="px" id="title" value="<?php echo ($market['title']); ?>" name="title" style="width:400px"  data-validation-engine="validate[required,minSize[2],maxSize[50]]" data-errormessage-value-missing="必填项">
                  </td>
  <td></td>
</tr> 
...
<tr>
  ...
  <td>
    <input type="input" class="px" id="logo_pic" value="<?php if($market['logo_pic'] == ''): echo ($default); else: echo ($market['logo_pic']); endif; ?>" name="logo_pic"  style="width:350px" data-validation-engine="validate[required,minSize[2],maxSize[100]]" data-errormessage-value-missing="必填项">
...
<tr>
  ...
  <td><input type="input" class="px" id="tel" value="<?php echo ($market['tel']); ?>" name="tel"  data-validation-engine="validate[required,minSize[1],maxSize[20]]" data-errormessage-value-missing="必填项">
         联系电话 </td>
  <td></td>
</tr> 
<tr>
  ...
  <?php if($market['market_index_tpl'] > 0): ?><a class="a_upload" onclick="viewTpl()">预览</a><?php endif; ?>
...
<tr>
  ...
  <td>
  <input type="text" id="tenant_list_tpl" class="px"  value="<?php if($market['tenant_list_tpl'] > 0): ?>已选择模板<?php echo ($market['tenant_list_tpl']); else: endif; ?>"  size="40" placeholder="点击右侧按钮选择" data-validation-engine="validate[required,minSize[2],maxSize[25]]" data-errormessage-value-missing="必填项"  />
  <a class="a_upload" onclick="chooseTpl('conttpid','tenant_list_tpl',1)">选择模板</a>
<?php if($market['tenant_list_tpl'] > 0): ?><a class="a_upload" onclick="viewTpl2()">预览</a><?php endif; ?>
    ...
    function viewTpl2(){
      ...
      chooseTpl(tid,'',2);
        ...
        <tr>
            ...
            <td><input type="input" class="px" id="address" value="<?php echo ($market['address']); ?>" name="address" style="width:400px" data-validation-engine="validate[required,minSize[5],maxSize[100]]" data-errormessage-value-missing="必填项">
              <br>
            </td>
            <td></td>
          </tr>
         ...
         纬度 <input type="text"  name="latitude" size="14" id="latitude" class="px" value="<?php echo ($market['latitude']); ?>" /> <a href="javascript:void(0);" onclick="setlatlng($('#longitude').val(),$('#latitude').val())">在地图中查看/设置</a>
         </div>
...
<tr>
  ...
  <td><input type="input" class="px" id="line" value="<?php echo ($market['line']); ?>" name="line" style="width:400px" >
                  </td>
  <td></td>
</tr>  
    ...
    <table class="quanjing" border="0" cellspacing="0" cellpadding="0" width="750">
        <tr>
          <td>     
            ...
            <input type="input" class="px" id="link_1" value="<?php echo ($slide['link_0']); ?>" name="link[]"  placeholder="幻灯片链接" style="width:85px">   
          </td>
          <td>
            <a href="###" onclick="addLink('link_2',0)" class="a_choose">添加</a>
            <input type="input" class="px" id="link_2" value="<?php echo ($slide['link_1']); ?>" name="link[]"  placeholder="链接地址" style="width:85px">            
          </td>
          <td>
            <a href="###" onclick="addLink('link_3',0)" class="a_choose">添加</a>
            <input type="input" class="px" id="link_3" value="<?php echo ($slide['link_2']); ?>" name="link[]"  placeholder="链接地址" style="width:85px">         
          </td>
          <td>
            <a href="###" onclick="addLink('link_4',0)" class="a_choose">添加</a>
            <input type="input" class="px" id="link_4" value="<?php echo ($slide['link_3']); ?>" name="link[]"  placeholder="幻灯片链接" style="width:85px">    
          </td>
          <td>
            <a href="###" onclick="addLink('link_5',0)" class="a_choose">添加</a>
            <input type="input" class="px" id="link_5" value="<?php echo ($slide['link_4']); ?>" name="link[]"  placeholder="幻灯片链接" style="width:85px">       
          </td>
        </tr>
      <!--
        <tr>
          <td><input type="input" class="px" id="link_1" value="<?php echo ($slide['title_0']); ?>" name="slid_title[]"  placeholder="幻灯片标题" style="width:133px"></td>
          <td><input type="input" class="px" id="link_1" value="<?php echo ($slide['title_1']); ?>" name="slid_title[]"  placeholder="幻灯片标题" style="width:133px"></td>
          <td><input type="input" class="px" id="link_1" value="<?php echo ($slide['title_2']); ?>" name="slid_title[]"  placeholder="幻灯片标题" style="width:133px"></td>
          <td><input type="input" class="px" id="link_1" value="<?php echo ($slide['title_3']); ?>" name="slid_title[]"  placeholder="幻灯片标题" style="width:133px"></td>
          <td><input type="input" class="px" id="link_1" value="<?php echo ($slide['title_4']); ?>" name="slid_title[]"  placeholder="幻灯片标题" style="width:133px"></td>
        </tr>-->
        <tr id="slide">
          <td>
...
<script>
  $(function(){
    var slide = $('#slide img');
        ...
        <tr>
          <td>
            <input type="input" class="px" id="slide_1" value="<?php echo ($slide['slide_0']); ?>" name="slide[]" placeholder="幻灯片" style="width:133px">
              
          </td>
          <td>
            <input type="input" class="px" id="slide_2" value="<?php echo ($slide['slide_1']); ?>" name="slide[]" placeholder="幻灯片" style="width:133px">
                   
          </td>
          <td>
            <input type="input" class="px" id="slide_3" value="<?php echo ($slide['slide_2']); ?>" name="slide[]" placeholder="幻灯片" style="width:133px">
               
          </td>
          <td>
            <input type="input" class="px" id="slide_4" value="<?php echo ($slide['slide_3']); ?>" name="slide[]" placeholder="幻灯片" style="width:133px">
            
            
          </td>
          <td>
            <input type="input" class="px" id="slide_5" value="<?php echo ($slide['slide_4']); ?>" name="slide[]" placeholder="幻灯片" style="width:133px">
                 
          </td>
        </tr>
        <tr>
          <td>
            <a href="javascript:void(0);" onclick="upyunPicUpload('slide_1',640,320,'<?php echo ($token); ?>')" class="a_upload">上传</a>
            <a href="javascript:void(0);" onclick="viewImg('slide_1')">预览</a>[640*320]

            
          </td>
          <td>
            <a href="javascript:void(0);" onclick="upyunPicUpload('slide_2',640,320,'<?php echo ($token); ?>')" class="a_upload">上传</a>
            <a href="javascript:void(0);" onclick="viewImg('slide_2')">预览</a>[640*320]
          </td>
          <td>
            <a href="javascript:void(0);" onclick="upyunPicUpload('slide_3',640,320,'<?php echo ($token); ?>')" class="a_upload">上传</a>
            <a href="javascript:void(0);" onclick="viewImg('slide_3')">预览</a>[640*320]
          </td>
          <td>
            <a href="javascript:void(0);" onclick="upyunPicUpload('slide_4',640,320,'<?php echo ($token); ?>')" class="a_upload">上传</a>
            <a href="javascript:void(0);" onclick="viewImg('slide_4')">预览</a>[640*320]
          </td>
          <td>
            <a href="javascript:void(0);" onclick="upyunPicUpload('slide_5',640,320,'<?php echo ($token); ?>')" class="a_upload">上传</a>
