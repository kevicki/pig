...
<div class="content">
          <div class="cLineB"><h4>编辑贺卡</h4><a href="<?php echo U('User/Greeting_card/index');?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a></div>
            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <tbody>
               <tr style="display:">
                  ...
                  <td><input type="input" class="px" id="keyword" value="<?php echo ($greeting_card['keyword']); ?>" required="" name="keyword" style="width:380px;"> </td>
                </tr>
                <tr>
                  <th>标题名字
                    <label for="title">：</label></th>
                  <td><input type="input" class="px" id="name" required="" value="<?php echo ($greeting_card['title']); ?>" name="title" style="width:380px;"> </td>
                </tr>
                <tr style="display:">
                ...
                <tr>
				  ...
				  <span class="help-inline">
					<a href="javascript:void(0)" onclick="upyunPicUpload('suicai2',640,1366,'<?php echo ($token); ?>')" class="btnGrayS vm">上传</a>
					<a href="###" onclick="viewImg('suicai2')" class="btnGrayS vm">预览</a>
				 </span>只改变选中模版的背景图!
</td>
                </tr>
                <tr>
    <th>背景音乐:</th>
	 ...
	 <a href="###" onclick="upyunPicUpload('suicai3',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;<a href="###" onclick="chooseFile('suicai3','music')" class="a_upload">选择</a><br />
