...
<div class="content">
	...
	<?php if($_SESSION['role_name']!= 'staff'): ?><div class="welcome1" style="display: block;">
	<div class="tab_menu">
        <ul>
          ...
          <!--<li class=""><a href="javascript:" class="icon icon icon-display"> <span>节日营销类</span></a></li>-->
...
//]]>
		...
		<div class="content1">
			<?php if(is_array($wel_content)): $i = 0; $__LIST__ = array_slice($wel_content,0,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img1">
					<a href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($staticPath); echo ($vo["pic"]); ?>"/><?php echo ($vo["title"]); ?></a>
...
<!--以下是隐藏部分-->
		<div class="content1" style="display: none;">
				<?php if(is_array($spr_content)): $i = 0; $__LIST__ = array_slice($spr_content,0,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img1">
						<a href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($staticPath); echo ($vo["pic"]); ?>"/><?php echo ($vo["title"]); ?></a>
					</div><?php endforeach; endif; else: echo "" ;endif; ?>
				<div style="clear:both"></div>
		</div>	
		...
		<div class="content1" style="display: none;">
				<?php if(is_array($mar_content)): $i = 0; $__LIST__ = array_slice($mar_content,0,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img1">
						<a href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($staticPath); echo ($vo["pic"]); ?>"/><?php echo ($vo["title"]); ?></a>
					</div><?php endforeach; endif; else: echo "" ;endif; ?>
				<div style="clear:both"></div>
		</div>			
		...
		<!--<div class="content1" style="display: none;">
				<?php if(is_array($holi_content_yincang)): $i = 0; $__LIST__ = array_slice($holi_content_yincang,0,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img1">
						<a href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($staticPath); echo ($vo["pic"]); ?>"/><?php echo ($vo["title"]); ?></a>
					</div><?php endforeach; endif; else: echo "" ;endif; ?>
				<div style="clear:both"></div>
		</div>-->
		...
		<div class="content1" style="display: none;">
				<?php if(is_array($busi_content)): $i = 0; $__LIST__ = array_slice($busi_content,0,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img1">
						<a href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($staticPath); echo ($vo["pic"]); ?>"/><?php echo ($vo["title"]); ?></a>
					</div><?php endforeach; endif; else: echo "" ;endif; ?>
				<div style="clear:both"></div>
		</div>	
		...
		<div class="content1" style="display: none;">
				<?php if(is_array($ind_content)): $i = 0; $__LIST__ = array_slice($ind_content,0,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img1">
						<a href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($staticPath); echo ($vo["pic"]); ?>"/><?php echo ($vo["title"]); ?></a>
					</div><?php endforeach; endif; else: echo "" ;endif; ?>
				<div style="clear:both"></div>
		</div>
		...
		<div class="content1" style="display: none;">
				<?php if(is_array($mem_content)): $i = 0; $__LIST__ = array_slice($mem_content,0,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img1">
						<a href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($staticPath); echo ($vo["pic"]); ?>"/><?php echo ($vo["title"]); ?></a>
					</div><?php endforeach; endif; else: echo "" ;endif; ?>
				<div style="clear:both"></div>
		</div>	
		...
		<div class="content1" style="display: none;">
				<?php if(is_array($oth_content)): $i = 0; $__LIST__ = array_slice($oth_content,0,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="img1">
						<a href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($staticPath); echo ($vo["pic"]); ?>"/><?php echo ($vo["title"]); ?></a>
					</div><?php endforeach; endif; else: echo "" ;endif; ?>
				<div style="clear:both"></div>
		</div>	
