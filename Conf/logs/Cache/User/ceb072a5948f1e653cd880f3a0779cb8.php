...
<div class="content">
  ...
  <div class="tab">
    <ul>
      <li class="tabli" id="tab2"><a href="<?php echo U('Zhaopin/index');?>">招聘信息管理</a></li>
      <li class="tabli" id="tab2"><a href="<?php echo U('Zhaopin/jianli');?>">简历信息管理</a></li>
      <li class="current  tabli" id="tab20"><a href="<?php echo U('Zhaopin/reply');?>">回复信息配置</a></li>
    </ul>
  </div>
  <!--tab end-->
      ...
      <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
          <tr>
            ...
            <td><span class="red">微招聘</span>————微信里输入关键字"微招聘"即可看到效果 </td>
          </tr>
          <tr>
            <th valign="top"><span class="red">*</span>回复标题：</th>
            <td><input type="text" name="title" value="<?php echo ($info["title"]); ?>" class="px" style="width:550px;"></td>
          </tr>
          <tr>
            <th>回复图片：</th>
            <td><input type="text" id="picurl1" value="<?php echo ($info["tp"]); ?>" name="tp" class="px" style="width:550px;">
              <script src="/tpl/static/upyun.js"></script>
              <a href="javascript:void(0)" onclick="upyunPicUpload('picurl1',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl1')" >预览</a></td>
          </tr>
          <tr>
            <th width="120"><span class="red">*</span>回复简介：</th>
            <td><textarea style="width:560px;height:75px" name="info" id="info" class="px" onkeydown='countChar("info","counter");' onkeyup="countChar('info','counter');"><?php echo ($info["info"]); ?></textarea>
              <br/>
              <font color="red">可以输入<span id="counter">400</span>字<br>
              </font></td>
          </tr>
          <tr>
            <th valign="top"><span class="red">*</span>审核招聘：</th>
            <td>
              <label for="radio3"><input id="radio3" class="radio" type="radio" name="allowqy" value="1" <?php if(($info["allowqy"]) == "1"): ?>checked="checked"<?php endif; ?> /> 开启</label>
              &nbsp;&nbsp;
              <label for="radio4"><input id="radio4" class="radio" type="radio" name="allowqy" value="0" <?php if(($info["allowqy"]) == "0"): ?>checked="checked"<?php endif; ?> /> 关闭</label>
            </td>
          </tr>
          <tr>
            <th valign="top"><span class="red">*</span>审核简历：</th>
            <td>
              <label for="radio5"><input id="radio5" class="radio" type="radio" name="allowjl" value="1"  <?php if(($info["allowjl"]) == "1"): ?>checked="checked"<?php endif; ?> /> 开启</label>
              &nbsp;&nbsp;
              <label for="radio6"><input class="radio" id="radio6" type="radio" name="allowjl" value="0"  <?php if(($info["allowjl"]) == "0"): ?>checked="checked"<?php endif; ?> /> 关闭</label></td>
          </tr>
          <tr>
            <th valign="top"><span class="red">*</span>版权设置：</th>
            <td><input type="text" name="copyright" value="<?php echo ($info["copyright"]); ?>" class="px" style="width:550px;"></td>
          </tr>
        <th>&nbsp;</th>
