...
<div class="content">
        <div class="cLineB">
			<h4><?php echo ($thisCard["cardname"]); ?>：发布积分兑换礼品 <span class="FAQ">发布积分兑换礼品信息</span></h4>
          ...
          <div class="msgWrap form">
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <tbody>
				...
				<tr>
					<th>兑换礼品所需积分：</th>
					<td><input type="input" class="px" id="integral" value="<?php echo ($vip["integral"]); ?>" name="integral" style="width:50px;"> 积分				　
				</td>
				</tr>
				<tr>
					<th>礼品数量：</th>
					<td><input type="input" class="px" id="people" value="<?php echo ($vip["people"]); ?>" name="people" style="width:50px;"> 个				　
				</td>
				</tr>
              	<tr>
					<th>有效期：</th>
					<td>
						<input type="input" class="px" id="statdate" value="<?php if($vip['statdate'] != false): echo (date("Y-m-d H:i:s",$vip["statdate"])); endif; ?>" name="statdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd  HH:mm:ss'})"> （含）到 
						<input type="input" class="px" id="enddate" value="<?php if($vip['enddate'] != false): echo (date("Y-m-d H:i:s",$vip["enddate"])); endif; ?>" name="enddate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd  HH:mm:ss'})">（含）
					</td>
				</tr>
<tr>
  <th>优惠劵图标：</th>
  <td>
  <img src="<?php if($vip["pic"] == ''): ?>/tpl/User/default/common/images/cart_info/lipin.jpg<?php else: echo ($vip["pic"]); endif; ?>" id="pic_src"style="max-width:200px;"><br/>
  <input type="text" name="pic" id="pic" value="<?php if($vip["pic"] == ''): ?>/tpl/User/default/common/images/cart_info/lipin.jpg<?php else: echo ($vip["pic"]); endif; ?>" class="px" style="width:200px;"> 
