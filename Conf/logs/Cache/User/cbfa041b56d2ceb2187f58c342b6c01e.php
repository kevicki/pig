...
<div class="content">
	<div class="cLineB">
		 <h4>招聘信息设置</h4>  <a href="<?php echo U('Zhaopin/index',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a> 
	</div>
	<div class="tab">
		<ul>
			<li class="current tabli" id="tab2"><a href="<?php echo U('Zhaopin/index');?>">招聘信息管理</a>
			</li>
			<li class="tabli" id="tab2"><a href="<?php echo U('Zhaopin/jianli');?>">简历信息管理</a>
			</li>
	...
	<form class="form" method="post" id="form" action="" enctype="multipart/form-data">
		...
		<div class="msgWrap bgfc">
			<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
				<tbody>
					<tr>
						<th><span class="red">*</span>机构名称：</th>
						<td>
							<input type="text" id="name" name="jigou" placeholder=" 请输入机构名称，例如：360教育培训学校" value="<?php echo ($set["jigou"]); ?>" class="px" style="width:400px;" />
						</td>
					</tr>
					<tr>
						<th><span class="red">*</span>招聘岗位：</th>
						<td>
							<input type="text" id="name" name="gangwei" placeholder=" 请输入所需要招聘的岗位，例如：PHP程序猿" value="<?php echo ($set["gangwei"]); ?>" class="px" style="width:400px;" />
						</td>
					</tr>
					<tr>
						<th><span class="red">*</span>招聘人数：</th>
						<td>
							<input type="text" id="name" name="ren" placeholder=" 请输入所需要招聘的人数，例如：2" value="<?php echo ($set["ren"]); ?>" class="px" style="width:400px;" />
						</td>
					</tr>
					<tr>
						<th><span class="red">*</span>岗位薪资：</th>
						<td>
							<input type="text" id="xinzi" name="xinzi" placeholder=" 请输入岗位的薪资范围（可以不写）例如：1000——2000" value="<?php echo ($set["xinzi"]); ?>" class="px" style="width:400px;" />
						</td>
					</tr>
					<tr>
						<th><span class="red">*</span>工作地点：</th>
						<td>
							<input type="text" id="address" name="address" placeholder=" 请输入工作地点，例如：北京天安门" value="<?php echo ($set["address"]); ?>" class="px" style="width:400px;" />
						</td>
					</tr>
					<script>
						function setlatlng(longitude,latitude){
					...
					<tr>
						<th>
							<label for="keyword">经纬地址</label>
						</th>
						<td>
							<div class="control-group">
								<label class="control-label" for="suggestId"></label>
								<div class="controls">经度
									<input type="text" id="longitude" name="longitude" size="14" class="px" value="<?php echo ($set["longitude"]); ?>" data-validation-engine="validate[required]" data-errormessage-value-missing="必选项" />纬度
									<input type="text" name="latitude" size="14" id="latitude" class="px" value="<?php echo ($set["latitude"]); ?>" /> <a href="###" onclick="setlatlng($('#longitude').val(),$('#latitude').val())">在地图中查看/设置</a>
								</div>
							</div>
		</div>
		</td>
		...
		<tr>
			...
			<td>
				<input type="text" id="address" name="people" placeholder=" 请输入联系人姓名，如：林先生" value="<?php echo ($set["people"]); ?>" class="px" style="width:400px;" />
			</td>
		</tr>
		<tr>
			<th><span class="red">*</span>联系人电话：</th>
			<td>
				<input type="text" id="address" name="tell" placeholder=" 请输入联系电话" value="<?php echo ($set["tell"]); ?>" class="px" style="width:400px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<select name="leibie" id="auth2nd" class="input-medium">
					<option value="服务/销售" <?php if(($set["leibie"]) == "服务/销售"): ?>selected="selected"<?php endif; ?>>服务/销售</option>
					<option value="电子/商务" <?php if(($set["leibie"]) == "电子/商务"): ?>selected="selected"<?php endif; ?>>电子/商务</option>
					<option value="普工/技工" <?php if(($set["leibie"]) == "普工/技工"): ?>selected="selected"<?php endif; ?>>普工/技工</option>
					<option value="市场/运营" <?php if(($set["leibie"]) == "市场/运营"): ?>selected="selected"<?php endif; ?>>市场/运营</option>
				</select>
			</td>
		</tr>
		<tr>
			<TR>
				<TH valign="top"><span class="red">*</span>岗位要求：</TH>
				<TD>
					<textarea name="yaoqiu" id="content" rows="5" style="width:590px;height:360px"><?php echo ($set["yaoqiu"]); ?></textarea>
				</TD>
			</TR>
			<tr>
				<th>&nbsp;</th>
