...
<div class="content">
	...
	<?php if($wxuser["wx_coupons"] == 1): ?><div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-top:5px;">
	...
	<div class="tab">
		<ul>
			...
			<?php if($wxuser["wx_coupons"] == 1): ?><li style="float:right;"><a href="<?php echo U('Member_card/import_company',array('token'=>$token));?>">微信门店导入</a></li><?php endif; ?>
		</ul>
	</div>
	<!--tab end-->
	<div class="msgWrap">
				...
				<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
					<tbody> 
						...
						<tr>
							...
							<td>
								<select id="type" autocomplete="off" name="cat_name" style="width:120px;">
									<option value="生活" <?php if($set["cat_name"] == '生活'): ?>selected="selected"<?php endif; ?> >生活</option>
									<option value="服务" <?php if($set["cat_name"] == '服务'): ?>selected="selected"<?php endif; ?> >服务</option>
									<option value="情感" <?php if($set["cat_name"] == '情感'): ?>selected="selected"<?php endif; ?> >情感</option>
									<option value="数码" <?php if($set["cat_name"] == '数码'): ?>selected="selected"<?php endif; ?> >数码</option>
									<option value="娱乐" <?php if($set["cat_name"] == '娱乐'): ?>selected="selected"<?php endif; ?> >娱乐</option>
									<option value="IT"  <?php if($set["cat_name"] == 'IT'): ?>selected="selected"<?php endif; ?> >IT</option>
									<option value="数码" <?php if($set["cat_name"] == '数码'): ?>selected="selected"<?php endif; ?> >数码</option>
									<option value="购物" <?php if($set["cat_name"] == '购物'): ?>selected="selected"<?php endif; ?> >购物</option>
									<option value="其他" <?php if($set["cat_name"] == '其他'): ?>selected="selected"<?php endif; ?> >其他</option>
								</select>
							</td>
						<tr>
						<tr> 
						...
						<tr> 
							...
							<td><input type="text" id="mp" name="mp" value="<?php echo ($set["mp"]); ?>" class="px" style="width:400px;" /></td> 
						</tr> 
						...
						<?php if($isBranch == 1): ?><tr> 
							...
							<td>
								<input class="radio" id="Store" type="checkbox" name="business_type[]" value="Store"  <?php if(in_array('Store', $set['business_type'])): ?>checked="checked"<?php endif; ?> > <label for="Store">商城</label>
								<input class="radio" id="Hotels" type="checkbox" name="business_type[]" value="Hotels"  <?php if(in_array('Hotels', $set['business_type'])): ?>checked="checked"<?php endif; ?> > <label for="Hotels">酒店</label>
								<input class="radio" id="Repast" type="checkbox" name="business_type[]" value="Repast"  <?php if(in_array('Repast', $set['business_type'])): ?>checked="checked"<?php endif; ?> > <label for="Repast">订餐</label>
								<input class="radio" id="DishOut" type="checkbox" name="business_type[]" value="DishOut"  <?php if(in_array('DishOut', $set['business_type'])): ?>checked="checked"<?php endif; ?> > <label for="DishOut">外卖</label>
							</td> 
						</tr><?php endif; ?>
						<tr>
