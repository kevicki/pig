...
<!--<a href="<?php echo U('Custom/index',array('token'=>$token));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> -->
<style>
...
<ul id="tags" style="width:100%">
        <li <?php if(ACTION_NAME == 'record'): ?>class="selectTag"<?php endif; ?>>
            ...
            <li style="float:right;">
            	<a href="<?php echo U('Custom/index',array('token'=>$token));?>" class="btnGreen">返回</a>
            </li>
...
<div class="cLine">
<div class="left"> 
	<a href="<?php echo U('Custom/forms_set',array('token'=>$token,'set_id'=>$set_id));?>" title="输入设置" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">输入设置</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td class="norightborder">
	<a href="<?php echo U('Custom/forms_set',array('field_id'=>$item['field_id'],'token'=>$token,'set_id'=>$set_id));?>">修改</a> |
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Custom/forms_del',array('field_id'=>$item['field_id'],'token'=>$token));?>');">删除</a>
</td>
