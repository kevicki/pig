...
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a class="btnGrayS vm bigbtn" title="添加" href="<?php echo U('Repast/dishadd',array('token' => $token,'cid'=>$cid));?>"><?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" class="vm"><?php endif; ?>添加菜品</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
