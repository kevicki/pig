...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
  <div class="content"> 
   <div class="cLineB"> 
    <h4>商品分类设置</h4> 
    <a href="<?php echo U('Store/index',array('token'=>$token, 'cid' => $cid));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div>
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        <th>Logo地址：</th> 
        <td><input type="text" name="logourl" value="<?php echo ($set["logourl"]); ?>" id="pic" class="px" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a></td> 
       </tr> 
       <tr> 
        <th>分类规格：</th> 
        <td><input type="text" name="norms" value="<?php echo ($set["norms"]); ?>" id="norms" class="px"/>(如：鞋的规格是：鞋码。即填写【鞋码】。尺寸，尺码，体积...。没有外观可不填写。可参考淘宝写)</td> 
       </tr>
       <tr> 
        <th>商品的外观：</th> 
        <td><input type="text" name="color" value="<?php echo ($set["color"]); ?>" id="color" class="px"/>(如：衣服一般有颜色,即填写【颜色】；酒水一般都是没有颜色的，没有外观可不填写)</td> 
       </tr>
       <tr> 
        <th>简介：</th> 
	   ...
	   <?php if($has_website): ?><TR>
			<TH valign="top">是否同时添加到<br/>电脑网站产品分类：</TH>
			<TD>
				<label for="pc_show_yes"><input type="radio" class="px" id="pc_show_yes" value="1" name="pc_show" />是</label>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如果选择是，以后删除电脑网站分类您需要到电脑网站设置处自行手动删除。<br/>
				<label for="pc_show_no"><input type="radio" class="px" id="pc_show_no" value="0" name="pc_show" checked />否</label>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;且子分类下的商品不会同步到电脑网站中。
			</TD>
			<TD>&nbsp;</TD>
		</TR><?php endif; ?>
		<?php if($set['pc_cat_id']): ?><TR>
				<TH valign="top">是否解绑电脑<br/>网站产品分类：</TH>
				<TD>
					<label for="pc_show_yes"><input type="radio" class="px" id="pc_show_yes" value="1" name="pc_show" />是</label>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;系统检测到此分类开启了添加到电脑网站。
					<br/>
					<label for="pc_show_no"><input type="radio" class="px" id="pc_show_no" value="0" name="pc_show" checked />否</label>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如果选择是，此分类将不再与电脑网站产品分类挂钩，以后添加产品时不会出现“是否添加到电脑网站分类”的提示。改变后不可改回。
				</TD>
				<TD>&nbsp;</TD>
			</TR><?php endif; ?>
       <tr>         
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Store/index',array('token' => $token, 'cid' => $cid));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
