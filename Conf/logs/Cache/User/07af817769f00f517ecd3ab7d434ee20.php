...
<div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-bottom:5px;">使用方法：点击对应内容后面的“选中”即可。<a href="?g=User&m=Link&a=insert">点击这里返回模块选择</a></div>
...
<?php if($_GET['c'] != ''): ?><a href="<?php echo ($m["url"]); ?>" target="_blank">预览</a>&nbsp;&nbsp;<a href="###" onclick="returnHomepage('<?php echo ($m["url"]); ?>')">选中</a>
<?php else: ?>
	<a href="?g=User&m=Link&a=outsideLinkDetail&c=<?php echo ($m["code"]); ?>">详细列表</a><?php endif; ?>
