...
<div class="pageNavigator left"> 
	<a href="<?php echo U('Problem/game_set',array('token'=>$token,'dining'=>$isDining));?>" title="添加" class="btnGrayS vm bigbtn">
		<?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm"><?php endif; ?> 
		添加活动
	</a>
</div>
...
<?php if($_SESSION['is_syn']== 2): if($usertplid != 2): ?><script type="text/javascript">
 ...
 <div id="showdiv<?php echo ($list["id"]); ?>">
   ...
   <div id="testdiv<?php echo ($list["id"]); ?>"><img src="<?php echo (session('source_domain')); ?>/wap.php?c=Wxapp&a=qrcode&id=<?php echo ($list["id"]); ?>&modle=Problem" width="300" height="300" class="cateimg_small"></div>
 </div>
   <a id="lay<?php echo ($list["id"]); ?>"  style="width:286px;">查看二维码</a><br><?php endif; endif; ?>
