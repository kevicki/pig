...
<div class="cLineB">
  <h4>平台支付对帐 </h4>
   <div class="ftip" style="margin:10px 0">在此显示使用平台支付的订单列表，方便与管理员进行对帐。</div> 
 </div>
	  ...
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		<table border="0" cellspacing="0" cellpadding="0" width="100%" class="platform_table">
			...
			<?php if(is_array($platform_list)): $i = 0; $__LIST__ = $platform_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><?php if($vo['paid']): ?><font color="blue">已对帐</font><?php else: ?><font color="red">未对帐</font><?php endif; ?></td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			<tr>
				<td colspan="5"></td>
			</tr>
			<tr>
				<td colspan="5"><div style="float:left;">此页总计：总金额 (<font color="blue"><?php echo floatval($platform_count['all']);?>元</font>) ，已对帐 (<font color="blue"><?php echo floatval($platform_count['ok']);?>元</font>) ，未处理 (<font color="red"><?php echo floatval($platform_count['none']);?>元</font>)</div></td>
			</tr>
			<tr>
				<td colspan="5"><div style="float:right;"><?php echo ($page); ?></div></td>
			</tr>
		</table>
	</form>
  </div> 
