...
<!--活动开始-->
<div class="cLineB">
    <h4>活动设置</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
</div>
...
<TR>
  ...
  <TD>
	<input type="input" class="px" id="keyword" value="<?php if($set["keyword"] == ''): ?>人气冲榜<?php else: echo ($set["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
  	<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
  </TD>
  <TD rowspan="5" valign="top">
	  <div style="margin-left:20px">
		<img id="pic1_src" src="<?php if($set['pic'] == ''): echo ($staticPath); ?>/tpl/static/Popularity/images/pic.jpg<?php else: echo ($set["pic"]); endif; ?>" width="373px" >
		<br />
		<input class="px"  name="pic" value="<?php if($set['pic'] == ''): echo ($staticPath); ?>/tpl/static/Popularity/images/pic.jpg<?php else: echo ($set["pic"]); endif; ?>" id="pic1" style="width:363px;"  />
		<br />
		  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic1',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;&nbsp;消息回复图片
	  </div>
  </TD>
</TR>
<TR>
  ...
  <TD>
	<input type="input" class="px" id="title" value="<?php if($set["title"] == ''): ?>挑战人气榜<?php else: echo ($set["title"]); endif; ?>" name="title" style="width:400px" />
  	<br />
  	请不要多于50字!
  </TD>
</TR>
...
<!-- <TR>
  <th valign="top"><span class="red">*</span>头部宣传图：</th>
  <TD>
		<input class="px"  name="top_pic" value="<?php if($set['top_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/Popularity/images/banner.jpg<?php else: echo ($set["top_pic"]); endif; ?>" id="pic0" style="width:310px;"  />
		<script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic0',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic0')">预览</a>
  </TD>
</TR> -->

  <TR>
  	<th valign="top"><span class="red">*</span>地址：</th>
  	<td>
		<input type="input" class="px" id="txt" value="<?php echo ($set["addr"]); ?>" name="addr" style="width:400px" />
	</td>
  </TR>
...
<TR>
	...
	<td><input type="input" class="px" id="statdate" value="<?php if($set['start'] != ''): echo (date("Y-m-d",$set["start"])); else: echo (date("Y-m-d",$start_date)); endif; ?>" onClick="WdatePicker()" name="start" />
		到
		<input type="input" class="px" id="enddate" value="<?php if($set['end'] != ''): echo (date("Y-m-d",$set["end"])); else: echo (date("Y-m-d",$end_date)); endif; ?>" name="end"  onClick="WdatePicker({startDate:'<?php echo time()+60*60*24*30;?>'})"  />
	</td>
</TR>
<TR>
<th valign="top">活动规则：</th>
<td colspan="2">
	<textarea  class="px" id="intro"  name="info"  style="width:400px; height:125px" ><?php echo ($set["info"]); ?></textarea>
</td>
</TR>
<TR>
 	<th valign="top"><span class="red"></span>奖品数量：</th>
 	<td>
	<input type="radio" name="show_num" value="1" <?php if($set['show_num'] == '' or $set['show_num'] == 1): ?>checked<?php endif; ?>>显示&nbsp;&nbsp;&nbsp;
	<input type="radio" name="show_num" value="2" <?php if($set['show_num'] == 2): ?>checked<?php endif; ?>>不显示    &nbsp;&nbsp;&nbsp;&nbsp;（控制前台是否显示奖品的数量）
</td>

<TR>
 	<th valign="top"><span class="red"></span>未关注是否可以参与：</th>
 	<td>
		<input type="radio" name="is_attention" value="1" <?php if($set['is_attention'] == '' or $set['is_attention'] == 1): ?>checked<?php endif; ?>>是
		&nbsp;&nbsp;&nbsp;
		&nbsp;
		<input type="radio" name="is_attention" value="2" <?php if($set['is_attention'] == 2): ?>checked<?php endif; ?>>否
		  &nbsp;&nbsp;&nbsp;
  		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  		  <?php echo ($__access_remind__); ?>
	</td>
</TR>
<TR>
 	<th valign="top"><span class="red"></span>是否需要粉丝详细信息：</th>
 	<td>
		<input type="radio" name="is_reg" value="1" <?php if($set['is_reg'] == '' or $set['is_reg'] == 1): ?>checked<?php endif; ?>>是
		&nbsp;&nbsp;&nbsp;
		&nbsp;
		<input type="radio" name="is_reg" value="2" <?php if($set['is_reg'] == 2): ?>checked<?php endif; ?>>否
		&nbsp;&nbsp;&nbsp;
  		（没有粉丝信息参加活动的处理方式）
	</td>
</TR>
<TR>
 	...
 	<td>
	<input type="radio" name="is_open" value="1" <?php if($set['is_open'] == '' or $set['is_open'] == 1): ?>checked<?php endif; ?>>开启&nbsp;&nbsp;&nbsp;
	<input type="radio" name="is_open" value="2" <?php if($set['is_open'] == 2): ?>checked<?php endif; ?>>关闭
</td>
 </TR>
 <tr>    
	<th valign="top"></th>     
...
<h4>奖项设置</h4></div>
<div class="msgWrap bgfc">
<div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-bottom:5px;font-size:12px;">温馨提示：推荐每个奖项的人气值最好从小到大进行设置。奖项最多设置4个。单个奖项参数请填写完整，否则前台将不予显示。奖品图片宽高比例请尽量一致
</div>
<TABLE class="userinfoArea" style=" margin: 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
<TBODY>
<TR>
<th valign="top"><span class="red">*</span>奖项一：</th>
<td><input type="input" class="px" id="fist"  name="prize[0][name]" value="<?php echo ($prize[0]['name']); ?>"  style="width:250px"/>
请不要多于50字! </td>
  <TD rowspan="9" valign="top">&nbsp;</TD>
</TR>
<tr>
<th><span class="red">*</span>奖品图片</th>
<td>
<input class="px"  name="prize[0][img]" value="<?php echo ($prize[0]['img']); ?>" id="pic2" style="width:200px;"  />
<script src="/tpl/static/upyun.js"></script>
<a href="###" onclick="upyunPicUpload('pic2',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a>
</td>
</tr>
<TR>
<th valign="top"><span class="red">*</span>奖品数量：</th>
<td>
	<input type="input" class="px" name="prize[0][num]" value="<?php echo ($prize[0]['num']); ?>" style="width:80px" />
</td>
</TR>
<TR>
<th valign="top"><span class="red">*</span>需要人气值：</th>
<td>
	<input type="input" class="px" name="prize[0][count]" value="<?php echo ($prize[0]['count']); ?>" style="width:80px" />
	<input  type="hidden" name="prize[0][id]" value="<?php echo ($prize[0]['id']); ?>" />
</td>
</TR>
...
<TR>
<th valign="top"><span class="red"></span>奖项二：</th>
<td><input type="input" class="px" id="fist"  name="prize[1][name]" value="<?php echo ($prize[1]['name']); ?>"  style="width:250px"/>
请不要多于50字! </td>
  <TD rowspan="9" valign="top">&nbsp;</TD>
</TR>
<tr>
<th><span class="red"></span>奖品图片</th>
<td>
<input class="px"  name="prize[1][img]" value="<?php echo ($prize[1]['img']); ?>" id="pic3" style="width:200px;"  />
<script src="/tpl/static/upyun.js"></script>
<a href="###" onclick="upyunPicUpload('pic3',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic3')">预览</a>
</td>
</tr>
<TR>
<th valign="top"><span class="red"></span>奖品数量：</th>
<td>
	<input type="input" class="px" name="prize[1][num]" value="<?php echo ($prize[1]['num']); ?>" style="width:80px" />
</td>
</TR>
<TR>
<th valign="top"><span class="red"></span>需要人气值：</th>
<td>
	<input type="input" class="px" name="prize[1][count]" value="<?php echo ($prize[1]['count']); ?>" style="width:80px" />
	<input  type="hidden" name="prize[1][id]" value="<?php echo ($prize[1]['id']); ?>" />
</td>
</TR>
...
<TR>
<th valign="top"><span class="red"></span>奖项三：</th>
<td><input type="input" class="px" id="fist"  name="prize[2][name]" value="<?php echo ($prize[2]['name']); ?>"  style="width:250px"/>
请不要多于50字! </td>
  <TD rowspan="9" valign="top">&nbsp;</TD>
</TR>
<tr>
<th><span class="red"></span>奖品图片</th>
<td>
<input class="px"  name="prize[2][img]" value="<?php echo ($prize[2]['img']); ?>" id="pic4" style="width:200px;"  />
<script src="/tpl/static/upyun.js"></script>
<a href="###" onclick="upyunPicUpload('pic4',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic4')">预览</a>
</td>
</tr>
<TR>
<th valign="top"><span class="red"></span>奖品数量：</th>
<td>
	<input type="input" class="px" name="prize[2][num]" value="<?php echo ($prize[2]['num']); ?>" style="width:80px" />
</td>
</TR>
<TR>
<th valign="top"><span class="red"></span>需要人气值：</th>
<td>
	<input type="input" class="px" name="prize[2][count]" value="<?php echo ($prize[2]['count']); ?>" style="width:80px" />
	<input  type="hidden" name="prize[2][id]" value="<?php echo ($prize[2]['id']); ?>" />
</td>
</TR>
...
<TR>
<th valign="top"><span class="red"></span>奖项四：</th>
<td><input type="input" class="px" id="fist"  name="prize[3][name]" value="<?php echo ($prize[3]['name']); ?>"  style="width:250px"/>
请不要多于50字! </td>
  <TD rowspan="9" valign="top">&nbsp;</TD>
</TR>
<tr>
<th><span class="red"></span>奖品图片</th>
<td>
<input class="px"  name="prize[3][img]" value="<?php echo ($prize[3]['img']); ?>" id="pic5" style="width:200px;"  />
<script src="/tpl/static/upyun.js"></script>
<a href="###" onclick="upyunPicUpload('pic5',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic5')">预览</a>
</td>
</tr>
<TR>
<th valign="top"><span class="red"></span>奖品数量：</th>
<td>
	<input type="input" class="px" name="prize[3][num]" value="<?php echo ($prize[3]['num']); ?>" style="width:80px" />
</td>
</TR>
<TR>
<th valign="top"><span class="red"></span>需要人气值：</th>
<td>
	<input type="input" class="px" name="prize[3][count]" value="<?php echo ($prize[3]['count']); ?>" style="width:80px" />
	<input  type="hidden" name="prize[3][id]" value="<?php echo ($prize[3]['id']); ?>" />
</td>
</TR>
