...
function regexChange(){
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>输入设置项</h4> 
    <a href="<?php echo U('Custom/forms',array('token'=>$token,'set_id'=>$set_id));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tr> 
       ...
       <tr> 
        ...
        <td>
            ...
            <span id="troptions"<?php if(($set['field_type'] == 'select') or ($set['field_type'] == 'checkbox') or($set['field_type'] == 'radio') ): else: ?>style="display:none"<?php endif; ?>>
              ...
              <textarea name="filed_option" id="options"  class="px" style="width:300px; height:70px" cols="60" rows="8"><?php echo ($set["filed_option"]); ?></textarea>
            </span>
        </td> 
       </tr>
       ...
       <tr> 
        ...
        <td>
          <select name="field_match" id="regexSelect" onchange="regexChange()"><?php echo ($field_match); ?></select>
        ...
        <td>
          <select name="is_show" id="require">
              ...
              <option value="0" <?php if($set["is_show"] == '0'): ?>selected<?php endif; ?>> 隐藏 </option>
          </select>
          设置是否显示该选项
        </td> 
       </tr> 
        ...
        <td><input type="text" name="sort" id="taxis" value="<?php if($set["sort"] == ''): ?>50<?php else: echo ($set["sort"]); endif; ?>" class="px" style="width:100px;" /></td> 
       </tr>
       <tr> 
       ...
       <td>
        ...
        <input type="hidden" name="set_id" value="<?php echo $set_id;?>">
          ...
          <a href="<?php echo U('Custom_form/index',array('token'=>$token,'set_id'=>$set_id));?>" class="btnGray vm">取消</a>
       </td> 
       </tr> 
      </tbody> 
     </table> 
