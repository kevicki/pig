...
<div class="cLineB">
  <h4>回答不上来的配置 </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
	  ...
	  <form class="form" method="post" action="" target="_top" >	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
					<th>回复图文关键词：</th>
					<td><input type="text" id="keyword" name="keyword" value="<?php echo ($other["keyword"]); ?>" class="px" style="width:200px;">
					<a href="###" onclick="addLink('keyword',1)" class="a_choose">从功能库添加</a>
					<br/> 注：只能填写一个关键词，此项如果填写，文字回复将会失效</td>
				</tr>
				<th>&nbsp;</th>
					<td>
