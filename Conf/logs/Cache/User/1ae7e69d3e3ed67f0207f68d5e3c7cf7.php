...
<div class="content">
<link type="text/css" rel="stylesheet" href="<?php echo RES;?>/css/cymain.css">
<style>
.cLine{overflow:visible;}
</style>
<div class="tab">
	<ul>
		<li class="tabli <?php if($type == 1): ?>current<?php endif; ?>"><a href="<?php echo U('Member_card/members', array('token' => $token,'id'=>$thisCard['id'],'type' => 1));?>">会员管理</a></li>
		<li class="tabli <?php if($type == 99): ?>current<?php endif; ?>"><a href="<?php echo U('Member_card/signcp', array('token' => $token,'id'=>$thisCard['id'],'type' => 99));?>">实物兑换</a></li>
		<li class="tabli <?php if($type == 100): ?>current<?php endif; ?>"><a href="<?php echo U('Member_card/scorelottery', array('token' => $token,'id'=>$thisCard['id'],'type' => 100));?>">积分抽奖</a></li>
		<li class="tabli <?php if($type == 2): ?>current<?php endif; ?>"><a href="<?php echo U('Member_card/coupon', array('token' => $token,'id'=>$thisCard['id'],'type' => 2));?>">优惠劵活动</a></li>
		<li class="tabli <?php if($type == 3): ?>current<?php endif; ?>"><a href="<?php echo U('Member_card/integral', array('token' => $token,'id'=>$thisCard['id'],'type' => 3));?>">礼品劵活动</a></li>
		<li class="tabli <?php if($type == 4): ?>current<?php endif; ?>"><a href="<?php echo U('Member_card/privilege', array('token' => $token,'id'=>$thisCard['id'],'type' => 4));?>">特权管理</a></li>
		<li class="tabli <?php if($type == 5): ?>current<?php endif; ?>"><a href="<?php echo U('Member_card/staff', array('token' => $token,'id'=>$thisCard['id'],'type' => 5));?>">店员管理</a></li>
		<li class="tabli <?php if($type == 6): ?>current<?php endif; ?>"><a href="<?php echo U('Member_card/gifts', array('token' => $token,'id'=>$thisCard['id'],'type' => 6));?>">开卡赠送</a></li>
	</ul>
</div> 
          <div class="cLine">
			<div class="pageNavigator left">
			<a href="<?php echo U('Member_card/coupon_edit',array('token'=>$token,'id'=>$thisCard['id']));?>" title="发布优惠券" class="btnGrayS vm bigbtn">
				<img src="<?php echo RES;?>/images/cart_info/power2.png" width="24px" class="vm">发布优惠券
			  </a>　

			</div>
			<a href="<?php echo U('Member_card/index',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:10px">返回</a>          
			<div class="clr"></div>
          </div>
          <div class="msgWrap">
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
					...
					<th class="time">属性</th>
					<th class="time">适用门店</th>
					<th class="time" style="width:80px;">发放数量</th>
              ...
              <tbody>
                <?php if(is_array($data_vip)): $i = 0; $__LIST__ = $data_vip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data_vip): $mod = ($i % 2 );++$i;?><tr>
					  ...
					  <td>
					  	<?php if($data_vip["attr"] == '1'): ?>赠送劵	
						<?php else: ?>
							普通劵<?php endif; ?>
					  </td>
					  <td><?php echo ($data_vip["company_name"]); ?></td>
					  <td>
					  	<?php if($data_vip["total"] == 0): ?>不限
					  	<?php else: ?>
							<?php echo ($data_vip["total"]); ?>张<?php endif; ?>
					  </td>
					  <td><?php echo ($data_vip["usetime"]); ?></td>
					  <td  align="center">
					  	<?php echo (date('Y-m-d',$data_vip["statdate"])); ?>
						<br/>
						至
						<br/>
					  	<?php echo (date('Y-m-d',$data_vip["enddate"])); ?>
					  </td>
					  <td class="norightborder" align="center">
						<a href="<?php echo U('Member_card/useRecords',array('id'=>$thisCard['id'],'type'=>'coupon','itemid'=>$data_vip['id']));?>">使用统计</a> <a href="<?php echo U('Member_card/coupon_edit',array('itemid'=>$data_vip['id'],'id'=>$thisCard['id']));?>">编辑</a> <a href="<?php echo U('Member_card/coupon_del',array('itemid'=>$data_vip['id'],'id'=>$thisCard['id']));?>">删除</a>
					  </td>
