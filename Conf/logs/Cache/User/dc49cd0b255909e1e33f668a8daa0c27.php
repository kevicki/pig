...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		<script src="./tpl/User/default/common/js/jquery.min.js"></script>
		 <script src="<?php echo $staticPath;?>/tpl/static/jquery.qrcode.min.js" type="text/javascript"></script>
		 <script src="<?php echo $staticPath;?>/tpl/static/layer/layer.js" type="text/javascript"></script>
		<style>
			#qrcode{
				padding:3px;
			}
        ...
        <div class="content">
          <div class="cLineB">
              <h4 class="left">微游戏</h4>
                 
              <div class="clr"></div>
          </div>
          <div class="cLine">
            <div class="pageNavigator left">
  <a href='<?php echo U('Game/gameLibrary',array('token'=>$token));?>' class='btnGrayS vm bigbtn'>从游戏库中添加游戏</a>
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
                <TR></TR>
                  ...
                  <TD>
                  <a href="<?php echo U('Game/record',array('id'=>$list['id'],'token'=>$token));?>">查看记录</a></TD> 
 ...
 <style type="text/css">
   ...
   #showdiv<?php echo ($list["id"]); ?>{z-index:20; display:none;position:fixed; *position:absolute;top:30%; left:50%; margin:-50px 0 0 -50px;}
 ...
 <div id="showdiv<?php echo ($list["id"]); ?>">
   ...
   <div id="testdiv{pigcms:{pigcms:$list.id}"><img src="<?php echo (session('source_domain')); ?>/wap.php?c=Wxapp&a=qrcode&id=<?php echo ($list["id"]); ?>&modle=Game" width="300" height="300" class="cateimg_small"></div>
 </div>
   <a id="lay<?php echo ($list["id"]); ?>" style="width:70px;">查看二维码</a><?php endif; endif; ?>
							<a href="index.php?g=User&m=Game&a=gameSet&id=<?php echo ($list["id"]); ?>">修改</a>
					   	<a href="index.php?g=User&m=Game&a=delGame&id=<?php echo ($list["id"]); ?>">删除</a>
					   	<a onclick="qrcode('{changjingUrl}/index.php?m=Game&c=index&a=index&id=<?php echo ($list["gameid"]); ?>&uid=<?php echo ($thisUser["uid"]); ?>&ugameid=<?php echo ($list["id"]); ?>')" href="javascript:void(0)">扫二维码预览</a>
				   </TD>
