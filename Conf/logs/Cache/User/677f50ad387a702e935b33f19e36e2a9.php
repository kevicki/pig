...
<script type="text/javascript">
  ...
  <a href='<?php echo U('Coupon/add',array('token'=>$token));?>' title='新增优惠券' class='btnGrayS vm bigbtn'><?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm"><?php endif; ?> 新增优惠券</a>
...
<?php else: ?>
		<div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-top:5px;"><?php endif; ?>
			此优惠券活动是用会员卡中的优惠券做活动，在添加此优惠券活动前，请确认会员卡中有优惠券。
			<br>
			如果网友没有会员卡，在进入活动时会提醒并跳转到会员卡中心。
			<br>
			注：不支持微信卡券
		</div>
          <div class="msgWrap">
...
<TH class="norightborder">操作</TH>
 ...
 <div id="showdiv<?php echo ($list["id"]); ?>">
   ...
   <div id="testdiv<?php echo ($list["id"]); ?>"><img src="<?php echo (session('source_domain')); ?>/wap.php?c=Wxapp&a=qrcode&id=<?php echo ($list["id"]); ?>&modle=Coupon" width="300" height="300" class="cateimg_small"></div>
 </div>
