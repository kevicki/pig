...
<div class="cLineB">
 ...
 <a href="<?php if($fid != 0): echo U('Classify/add',array('fid'=>$fid)); else: echo U('Classify/add'); endif; ?>" class="btnGrayS vm bigbtn">添加<?php if($fid != 0): ?>【<?php echo ($thisClassify["name"]); ?>】子<?php endif; ?>分类</a>　
</div>
...
<td class="norightborder" width="120">
  ...
  <a href="<?php if ($vo['fid']==0){ echo U('Classify/flash',array('tip'=>3,'id'=>$vo['id'])); }else{ echo U('Classify/flash',array('tip'=>3,'id'=>$vo['id'],'fid'=>$vo['fid'])); }?>">幻灯片</a>
