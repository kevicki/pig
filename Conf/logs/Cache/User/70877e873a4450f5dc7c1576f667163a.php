...
<div class="msgWrap form">
    ...
    <div class="content">
		<div class="cLineB">
		  <h4><a href="<?php echo U('Seckill/shop_add',array('token'=>$token,'type'=>$type, 'aid' => $_GET['aid']));?>" class="btnGrayS vm bigbtn">添加活动商品</a></h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
		</div>
...
<?php if(is_array($action)): $i = 0; $__LIST__ = $action;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
              ...
              <a href="<?php echo U('Seckill/shop_add',array('aid'=>$_GET['aid'],'sid'=>$vo['shop_id'], 'type'=>'seckill'));?>" class="btnGreen">编辑</a>
              <a href="<?php echo U('Seckill/shop_del',array('aid'=>$_GET['aid'],'sid'=>$vo['shop_id'],'type'=>'del', 'type'=>'seckill'));?>" onclick="return(confirm('确定要删除吗？'))" class="btnGreen">删除</a> </td>
            </tr>
