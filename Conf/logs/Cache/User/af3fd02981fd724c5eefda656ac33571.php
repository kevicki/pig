...
<form class="form" method="post" action="<?php echo U('Numqueue/add_action');?>" target="_top" enctype="multipart/form-data">
...
<td><input type="text" name="reply_keyword" value="<?php if($vo['reply_keyword'] == ''): ?>微排号<?php else: echo ($vo["reply_keyword"]); endif; ?>" class="px" style="width:550px;"></td>
</tr>
<tr>
<th width="120"><span class="red">*</span>回复标题：</th>
<td><input type="text" name="reply_title" value="<?php echo ($vo["reply_title"]); ?>" class="px" style="width:550px;"></td>
</tr>
<tr>
...
<tr>
  ...
  <?php if($vo["reply_pic"] != ''): ?><img class="thumb_img" id="pic1_src" src="<?php echo ($vo["reply_pic"]); ?>" style="max-height:100px;max-width: 200px;">
	<?php else: ?>
	<img class="thumb_img" id="pic1_src" src="<?php echo ($staticPath); ?>/tpl/static/numqueue/images/paidui.png" style="max-height:100px;max-width: 200px;"><?php endif; ?>
  <input type="text" name="reply_pic" value='<?php if($vo['reply_pic'] != ''): echo ($vo["reply_pic"]); else: echo ($staticPath); ?>/tpl/static/numqueue/images/paidui.png<?php endif; ?>' id="pic1" class="px" style="width:200px;" >
...
<tr>
  ...
  <td>
  <input type="text" name="icon" value='<?php echo ($vo["icon"]); ?>' id="pic2" class="px" style="width:200px;" >
  <a href="###" onclick="upyunPicUpload('pic2',100,100,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a>   &nbsp; 手机端等待人数处展示的图标,建议图片尺寸100*100，图片大小不超过300K</td>
</tr>
<tr>
<th>是否开启热门品牌：</th>
<td>
  <input type="radio" name="is_hot" value="1" <?php if($vo["is_hot"] == '1' or $vo["is_hot"] == ''): ?>checked<?php endif; ?>>
  开启
  <input type="radio" name="is_hot" value="2" <?php if($vo["is_hot"] == '2'): ?>checked<?php endif; ?>>关闭
</td>
</tr>
<tr>
<th>是否开启活动：</th>
<td>
  <input type="radio" name="is_open" value="1" <?php if($vo["is_open"] == '1' or $vo["is_open"] == ''): ?>checked<?php endif; ?>>
  开启
  <input type="radio" name="is_open" value="2" <?php if($vo["is_open"] == '2'): ?>checked<?php endif; ?>>关闭
</td>
</tr>
<tr>
<th>&nbsp;</th>
<td><button type="button" name="button" class="btnGreen sub" onclick="save_numqueue()">保存</button>
<a href="<?php echo U('Numqueue/add_action');?>" class="btnGray vm">取消</a>
</td>
</tr>
</tbody>
</table>
