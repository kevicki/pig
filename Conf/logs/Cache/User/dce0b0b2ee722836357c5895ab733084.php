...
<a href="<?php echo U('Numqueue/add_action',array('token'=>$token,'id'=>$id));?>" class="btnGrayS vm bigbtn"><?php if($usertplid == 2): ?><img class="vm" src="./tpl/User/default/common/images/product/new.gif"><?php endif; ?>添加微排号</a> 
</div>
  <div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-bottom:5px;font-size:12px;">温馨提示：本功能使用了模板消息中的"排队提醒"模板消息,模板消息编号OPENTM200869995。<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;开通微信支付功能的公众号在使用此功能的时候可以在"基本设置——微信模板消息"中配置对应的模板消息。
</div>
    <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
	<thead>
	<tr>
	  <th style="width:15%;">回复关键词</th>
	  <th style="width:15%;">回复标题</th>
	  <th style="width:10%;">活动状态</th>
	</th>
	<th>操作</th>
	</tr>
	</thead>
	<?php if($list != ''): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
		  <td><?php echo ($vo["reply_keyword"]); ?></td>
		  <td><?php echo ($vo["reply_title"]); ?></td>
		  <td><?php if($vo["is_open"] == 1): ?>开启<?php else: ?>关闭<?php endif; ?></td>
		  <td class="norightborder">
		  <a href="<?php echo U('Numqueue/store_list',array('action_id'=>$vo['id']));?>" class="btnGreen">门店列表</a>
		  <a href="<?php echo U('Numqueue/add_action',array('id'=>$vo['id']));?>" class="btnGreen">编辑</a>
		  <a href="<?php echo U('Numqueue/del_action',array('id'=>$vo['id']));?>" onclick="return(confirm('确定要删除吗？'))" class="btnGreen">删除</a> </td>
		</tr>
	  </tbody><?php endforeach; endif; else: echo "" ;endif; ?> 
	<?php else: ?>
	<tbody><tr><td colspan="5" align="center">暂无记录！</td></tr></tbody><?php endif; ?>
	</table>
