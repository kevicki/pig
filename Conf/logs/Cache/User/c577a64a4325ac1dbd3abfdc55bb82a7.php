...
<a href="###" onclick="upyunPicUpload('picurl',468,180,'<?php echo ($token); ?>')" class="a_upload">上传</a>
...
<TR>
  <TH valign="top"><label for="keyword"><font color="red">首页模板：</font></label></TH>
  <TD>
    ...
    <a class="a_upload" onclick="viewTpl()">预览</a> <font color="red">[注意]仅仅支持(模板管理)栏目首页模板风格下的<a href="<?php echo U('Tmpls/index',array('token'=>$token));?>">[支持自定义背景]</a>模板,如果没有就默认.</font>
    <script>
        function viewTpl(){
            var tid = $('#tpid').val();
            chooseTpl(tid,'',2);
...
<a href="###" onclick="upyunPicUpload('toppicurl',278,420,'<?php echo ($token); ?>')" class="a_upload">上传</a>
<a href="###" onclick="viewImg('toppicurl')">预览</a> [278,420]</td>
          ...
          <tr>
            ...
            <input type="input" class="px" id="roompicurl" value="<?php echo ($busines['roompicurl']); ?>" name="roompicurl" data-validation-engine="validate[required,custom[url]]"
                    data-errormessage-value-missing="必须上传图片!"  data-errormessage-custom-error="如果是手动填写,正确的网址,如: http://www.baidu.com/images/demo.png">
<a href="###" onclick="upyunPicUpload('roompicurl',630,255,'<?php echo ($token); ?>')" class="a_upload">上传</a>
...
公司电话：<?php endif; ?>
            ...
            <td><input type="input" class="px" id="compyphone" value="<?php echo ($busines['compyphone']); ?>" name="compyphone" style="width:200px" >
              正确格式:0351-65373998 </td>
            <td></td>
          </tr>
<script>
