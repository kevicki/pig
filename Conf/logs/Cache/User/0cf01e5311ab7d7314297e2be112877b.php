...
<input type="submit" value="搜索" id="msgSearchBtn" href="" class="btnGrayS" title="搜索">
 ...
 <div class="cLineD">
	...
	<?php if($showStatistics == 1): ?><div id="chartdiv1" align="center"></div>
					<script type="text/javascript">
          ...
          <div class="cLine">
            <div class="pageNavigator left">
				<a href="<?php echo U('User/Wechat_group/send');?>" class="btnGrayS vm bigbtn">
					<img src="tpl/User/default/common/images/text.png" class="vm">更新列表
				</a>
				<a href="<?php echo U('User/Wechat_group/send_info',array('all'=>1));?>" class="btnGrayS vm bigbtn">
...
<form method="post" action="<?php echo U('User/Wechat_group/setGroup');?>" id="info">
          <div style="width:70%;float:left">将选中粉丝转移到分组中 <select name="wechatgroupid"><?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?><option value="<?php echo ($g["wechatgroupid"]); ?>"><?php echo ($g["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?></select> <input type="submit" value="转移" id="msgSearchBtn" href="" class="btnGrayS" title="转移">&nbsp;&nbsp;按分组查看粉丝：<select id="wechatgroupid" onchange="location.href='?g=User&m=Wechat_group&a=index&token=<?php echo ($token); ?>&wechatgroupid='+this.value"><?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?><option value="<?php echo ($g["wechatgroupid"]); ?>"<?php if ($_GET['wechatgroupid']==$g['wechatgroupid']){echo ' selected';}?>><?php echo ($g["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?></select>
          </div>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
			  ...
			  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td class="norightborder">
						<a href="<?php echo U('Wechat_behavior/statisticsOfSingleFans',array('openid'=>$list['openid']));?>">粉丝行为管理</a>　
