...
<!--活动开始-->
<div class="cLineB">
    <h4>编辑<?php echo ($activityTypeName); ?>活动开始内容</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
</div>
...
<TR>
  ...
  <TD>
	...
	<input type="input" class="px" id="keyword" value="<?php if($vo['keyword'] == ''): echo ($activityTypeName); else: echo ($vo["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
  	<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
  </TD>
  <TD rowspan="4" valign="top">
	  <div style="margin-left:20px">
		<img id="pic1_src" src="<?php if($vo['starpicurl'] == ''): echo ($staticPath); ?>/tpl/static/autumns/img/ads.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>" width="373px" height="220" >
		<br />
		<input class="px"  name="starpicurl" value="<?php if($vo['starpicurl'] == ''): echo ($staticPath); ?>/tpl/static/autumns/img/ads.jpg<?php else: echo ($vo["starpicurl"]); endif; ?>" id="pic1" style="width:363px;"  />
		<br />
		  <script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic1',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;活动开始图片
	  </div>
  </TD>
</TR>
<TR>
  ...
  <TD>
	<input type="input" class="px" id="title" value="<?php if($vo['title'] == ''): echo ($activityTypeName); ?>活动开始了<?php else: echo ($vo["title"]); endif; ?>" name="title" style="width:400px" />
  	<br />
  	请不要多于50字!
  </TD>
</TR>
    ...
    <td>
    <textarea  class="px" id="txt" name="txt"  style="width:400px; height:50px" ><?php if($vo['txt'] == ''): ?>兑奖请联系我们，电话138********<?php else: echo ($vo["txt"]); endif; ?></textarea>
...
<TR>
	...
	<td><input type="input" class="px" id="statdate" value="<?php if($vo['statdate'] != ''): echo (date("Y-m-d H:i",$vo["statdate"])); endif; ?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" name="statdate" />
		到
		<input type="input" class="px" id="enddate" value="<?php if($vo['enddate'] != ''): echo (date("Y-m-d H:i",$vo["enddate"])); endif; ?>" name="enddate"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"  />
	</td>
...
<td><textarea  class="px" id="aginfo" name="aginfo"  style="width:400px; height:125px" ><?php if($vo['aginfo'] == ''): ?>此活动杜绝恶意刷礼盒，每个手机只能有一个微信号帮忙。<?php else: echo ($vo["aginfo"]); endif; ?></textarea><br />
 </td>
</TR>

<TR>
<th valign="top">活动说明：</th>
<td><textarea  class="px" id="info" name="info"  style="width:400px; height:125px" ><?php if($vo['info'] == ''): ?>亲，请点击进入<?php echo ($activityTypeName); ?>活动页面，祝您好运哦！<?php else: echo ($vo["info"]); endif; ?></textarea><br />

</TR>
	
 <TR>
    <th valign="top">主题文字：</th>
    <td><textarea class="px" id="sttxt"  name="sttxt" style="width:400px"  ><?php if($vo['sttxt'] == ''): ?>欢迎参加<?php echo ($activityTypeName); ?>活动，祝您好运哦！<?php else: echo ($vo["sttxt"]); endif; ?></textarea> 活动首页显示文字</td>
</TR>
<TR>
	<th>背景音乐：</th>
    <td>	 
	<input class="px" name="backmp3" value="<?php if($vo['backmp3'] == ''): echo ($staticPath); ?>/tpl/static/autumns/mp3/bg.mp3<?php else: echo ($vo["backmp3"]); endif; ?>" id="backp3" style="width:300px" onchange="document.getElementById('plmp3').src=this.value"> 
	<a href="###" onclick="upyunPicUpload('backp3',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a><a href="###" onclick="chooseFile('backp3','music')" class="a_upload">选择</a>
	<audio id="plmp3" src="" preload="none"></audio><font color="#FF0000"></font>
	<br>活动首页的背景音乐 </td>
	
</TR>
<TR>
	<th valign="top">首页背景图片：</th>
	<td>
		<input class="px"  name="hpic" value="<?php if($vo['hpic'] == ''): echo ($staticPath); ?>/tpl/static/autumns/img/backimg.jpg<?php else: echo ($vo["hpic"]); endif; ?>" id="pic3" style="width:300px;"  />
		<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic3',640,1136,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic3')">预览</a>
	</td>
</TR>
<TR>
  <th valign="top">我的盒子背景图片：</th>
  <td>
    <input class="px"  name="mpic" value="<?php if($vo['mpic'] == ''): echo ($staticPath); ?>/tpl/static/autumns/img/myboximg.jpg<?php else: echo ($vo["mpic"]); endif; ?>" id="pic5" style="width:300px;"  />
    <script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic5',640,1136,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic5')">预览</a>
  </td>
</TR>
<TR>
  <th valign="top">兑奖页面宣传图片：</th>
  <td>
    <input class="px"  name="xpic" value="<?php if($vo['xpic'] == ''): echo ($staticPath); ?>/tpl/static/autumns/img/openimg.jpg<?php else: echo ($vo["xpic"]); endif; ?>" id="pic4" style="width:300px;"  />
    <script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic4',516,310,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic4')">预览</a>
    <br>注意图片尺寸，以宽度为标准等比例缩放
  </td>
</TR>
</TBODY>
</TABLE>
  	...
  	<table class="userinfoArea" style=" margin: 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
  		<tbody>
  			<tr>
  				...
  				<td><input type="input" class="px" id="endtite" value="<?php if($vo['endtite'] == ''): echo ($activityTypeName); ?>活动已经结束了<?php else: echo ($vo["endtite"]); endif; ?>" name="endtite" style="width:363px" />
  					<br />
  					请不要多于50字! </td>
  				<td rowspan="4" valign="top"><div style="margin-left:20px"><img  id="pic2_src" src="<?php if($vo['endpicurl'] == ''): echo ($staticPath); ?>/tpl/static/autumns/img/ads.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  width="373px" height="200px"/> <br />
  					<input class="px" id="pic2"  name="endpicurl" value="<?php if($vo['endpicurl'] == ''): echo ($staticPath); ?>/tpl/static/autumns/img/ads.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  style="width:363px;"  />
  					<br />
  					  <script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic2',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a>&nbsp; 活动结束图片 </div></td>
  				</tr>
  			<tr>
  				<th valign="top">活动结束说明：</th>
  				<td valign="top"><textarea  class="px" id="endinfo" name="endinfo"  style="width:400px; height:125px" ><?php if($vo['endinfo'] == ''): ?>亲，活动已经结束，请继续关注我们的后续活动哦。<?php else: echo ($vo["endinfo"]); endif; ?></textarea><br />
  				  </td>
  				</tr>
  			</tbody>
  		</table>
...
<tr>
<th valign="top"><span class="red"></span>需要分享的次数：</th>
<td><input class="px" id="optime" name="optime" style="width:150px" value="<?php echo ($vo["optime"]); ?>" type="input">
找小伙伴帮忙的次数</td>
</tr>
...
<td><input class="px" id="parssword" name="parssword" style="width:150px" value="<?php echo ($vo["parssword"]); ?>" type="input">消费确认密码长度小于15位</td>
</tr>
<tr>
...
<TR>
  ...
  <td>
  <input type="radio" name="focus" value="0" <?php if($vo['focus'] == '' or $vo['focus'] == 0): ?>checked<?php endif; ?>>是
  &nbsp;&nbsp;&nbsp;
  &nbsp;
  <input type="radio" name="focus" value="1" <?php if($vo['focus'] == 1): ?>checked<?php endif; ?>>否
  &nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <TR>
  <th valign="top"><span class="red"></span>是否需要粉丝详情信息：</th>
  <td>
  <input class="radio" type="radio" name="needreg" value="0"  <?php if($vo['needreg'] == 0): ?>checked<?php endif; ?>> 是
  &nbsp;&nbsp;&nbsp;
  &nbsp;
  <input class="radio" type="radio" name="needreg" value="1"  <?php if($vo['needreg'] == 1): ?>checked<?php endif; ?>>否
  &nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
 </TR>
...
<tr>
<th>&nbsp;</th>
<td><button type="submit" name="button" class="btnGreen">保存</button>　<a href="" class="btnGray vm">取消</a>　<span class="red">请确认功能管理已开启活动奖品功能</span></td>
                                    </tr>
</TBODY>
</TABLE>
