...
<div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>>
          ...
          <div class="cLineB">
              <h4 class="left">文章管理</h4>
              <div class="clr"></div>
          </div>
          <div class="cLine">
            <?php if($usertplid == 0): ?><div class="pageNavigator left">
                <a href='<?php echo U("Essay/add");?>' title='新增图文自定义回复' class='btnGrayS vm bigbtn'>新增一篇文章</a>　
            ...
            <?php else: ?>
              <div class="pageNavigator left">
                ...
                <div class="vm02">
                    <a href='<?php echo U("Essay/add");?>' title='新增文章自定义回复'>新增文章自定义回复</a>　
                </div>
                <div class="vm03">
                    <form action="#" method="post">
                     <input type="text" placeholder="请输入标题搜索词" value="<?php echo ($_POST['search']); ?>" class="px" name="search" />
          ...
          <div class="msgWrap">
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
                <TR></TR>
				<form action="<?php echo U("Essay/editUsort");?>" method="post" id="sortform">
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "没有找到数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><?php echo ($vo["click"]); ?></td>
				   ...
				   <a href="<?php echo U('Essay/edit',array('id'=>$vo['id']));?>" title="编辑图文自定义回复">编辑</a>
				   <a href="<?php echo U('Essay/del',array('id'=>$vo['id']));?>">删除</a></td>
