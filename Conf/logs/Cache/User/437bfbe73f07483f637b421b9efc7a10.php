...
<div class="content">
        ...
        <div class="cLine">
       		<strong>本月可创建 <span style="color:red"><?php echo ($count); ?></span> 张，剩余<span style="color:red"><?php echo ($cancrnum); ?></span>张</strong>
        </div>
          ...
          <div class="msgWrap form">
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <tbody>
  				<tr>
              		<th>卡号英文编号：</th>
              		<td><input type="input" class="px" id="title" value="" name="title" style="width:195px;"> 例：<font style="color:red">BSD</font>-65535 <font style="color:red">BSD</font>就是英文编号</td>
              		</tr>
