...
<div class="pageNavigator left"> 
	<a href="###" onclick="if(confirm('您确定要删除吗?')){$('#info').submit();}else{ return false;}" title="批量删除" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">批量删除</a>
	 <a href="###" onclick="$('#info').attr('action','/index.php?g=User&m=Forum&a=checkComment');$('#info').submit();" title="批量审核" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">批量审核</a>
</div>
<div class="clr"></div>
</div>
