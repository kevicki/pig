              ...
              <tbody>
                <?php if(is_array($data_vip)): $i = 0; $__LIST__ = $data_vip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data_vip): $mod = ($i % 2 );++$i;?><tr>
					  ...
					  <td class="norightborder">
						<!-- <a href="<?php echo U('Member_card/useRecords',array('id'=>$thisCard['id'],'type'=>'vip','itemid'=>$data_vip['id']));?>">使用统计</a>  -->
						<a href="<?php echo U('Member_card/privilege_add',array('id'=>$thisCard['id'],'itemid'=>$data_vip['id']));?>">编辑</a> 
						<a href="<?php echo U('Member_card/privilege_del',array('itemid'=>$data_vip['id'],'id'=>$thisCard['id']));?>">删除</a>
					  </td>
