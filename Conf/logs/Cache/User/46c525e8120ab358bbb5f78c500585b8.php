...
<link href="<?php echo ($staticPath); ?>/tpl/static/crowdfunding/css/index.css" rel="stylesheet" type="text/css">
<form class="form" method="post"   action=""  enctype="multipart/form-data" >
        <div class="content">
<!--活动开始-->
<div class="cLineB">
    <h4>众筹设置</h4><a href="<?php echo U('Crowdfunding/index',array('token'=>$token));?>"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
</div>
...
<?php if($_SESSION['is_syn'] == 0): ?><th valign="top"><span class="red">*</span>关键词：</th>
  <TD>
  <input type="input" class="px" id="keyword" value="<?php if($set['keyword'] == ''): ?>微众筹<?php else: echo ($set["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
  ...
  <TD rowspan="4" valign="top">
    ...
    <img id="pic1_src" src="<?php if($set['pic'] == ''): echo ($staticPath); ?>/tpl/static/crowdfunding/images/default.jpg<?php else: echo ($set["pic"]); endif; ?>" width="373px">
    <br />
    <input class="px"  name="pic" value="<?php if($set['pic'] == ''): echo ($staticPath); ?>/tpl/static/crowdfunding/images/default.jpg<?php else: echo ($set["pic"]); endif; ?>" id="pic1" style="width:363px;"  />
    <br />
      <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic1',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;&nbsp;产品图片
    </div>
  </TD>
</TR>

<!-- <TR>
  <th valign="top"><span class="red">*</span>项目分类：</th>
  <TD>
    <select name="type">
      <option value="">请选择。。</option>
      <option value="1" <?php if($set["type"] == '1'): ?>selected<?php endif; ?>>手机平板</option>
      <option value="2" <?php if($set["type"] == '2'): ?>selected<?php endif; ?>>电脑办公</option>
      <option value="3" <?php if($set["type"] == '3'): ?>selected<?php endif; ?>>生活娱乐</option>
      <option value="4" <?php if($set["type"] == '4'): ?>selected<?php endif; ?>>运动健身</option>
    </select>
  </TD>
</TR> -->

<TR>
  <th valign="top"><span class="red">*</span>项目名称：</th>
  <TD>
  <input type="input" class="px" id="name" value="<?php echo ($set["name"]); ?>" name="name" style="width:400px" />
    <br />
    （请不要多于50字!）
  </TD>
</TR>
...
<TR>
  <th valign="top"><span class="red">*</span>项目简介：</th>
  <td><textarea  class="px" id="info" name="intro"  style="width:400px; height:60px" ><?php echo ($set["intro"]); ?></textarea>
  </td>
</TR>

<TR>
  <th valign="top"><span class="red">*</span>筹资金额：</th>
  <TD>
    <input type="input" class="px" id="warn" value="<?php echo ($set["fund"]); ?>" name="fund" style="width:100px" /> 元 
  </TD>
</TR>

<TR>
  <th valign="top"><span class="red" >*</span>筹资上限：</th>
  <TD colspan="2">
    <input type="input" class="px" id="warn" value="<?php if($set["day"] == ''): ?>0<?php else: echo ($set["max"]); endif; ?>" name="max" style="width:100px" /> % 
    <br/>
    (0为不限制,直到筹资天数过期。计算公式：筹资总上限=筹资金额*筹资上限，筹资达到总上限或者超过筹资天数后项目将会自动结束)
  </TD>
</TR>

<TR>
  <th valign="top"><span class="red">*</span>筹资天数：</th>
  <TD>
    <input type="input" class="px" id="warn" value="<?php if($set["day"] == ''): ?>30<?php else: echo ($set["day"]); endif; ?>" name="day" style="width:100px" /> 天
  </TD>
</TR>

<TR>
  <th valign="top"><span class="red">*</span>项目详情：</th>
  <td colspan="2"><textarea  class="px" id="detail" name="detail"  style="width:590px;height:250px" ><?php echo ($set["detail"]); ?></textarea>
  </td>
</TR>
...
<TR>
  ...
  <td>
    ...
    <input type="submit" class="btnGreen" value="保存信息">
  </td>
</TR>
</TBODY>
</TABLE>
  ...
  <div class="common_button">
    <button type="button" class="button"  onclick="javascript:window.location='<?php echo U('Crowdfunding/reward_set',array('token'=>$token,'pid'=>$set['id']));?>';">下一步</button>
  </div>
</div>
