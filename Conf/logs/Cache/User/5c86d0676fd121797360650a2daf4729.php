...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        <div class="content">
<div class="cLineB">
<h4 class="left">高级微场景</h4>
<div class="clr"></div>
</div>

<div class="cLine">
<div class="pageNavigator left"><a href="<?php echo U('SeniorScene/add',array('token'=>$token));?>" title="添加新的场景关键词" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加新的场景关键词</a></div>
...
<td class="norightborder">
	<a href="<?php echo U('SeniorScene/add',array('id'=>$item['id'],'token'=>$token));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('SeniorScene/del',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
