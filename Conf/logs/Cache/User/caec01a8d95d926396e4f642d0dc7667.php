...
<div class="cLineB">
  <h4>邀请函报名嘉宾 </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
    
	<div class="tab_th">
		<table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%" style="text-align:center;">
		<thead>
		<tr><th>姓名</th><th>电话</th><th>公司</th><th>Email</th><th>身份</th><th>操作</th></tr>
		</thead>
		<tbody>
		<tr></tr>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Invite): $mod = ($i % 2 );++$i;?><tr><td><?php echo ($Invite["name"]); ?></td><td><?php echo ($Invite["mobile"]); ?></td><td><?php echo ($Invite["comp"]); ?></td><td><?php echo ($Invite["email"]); ?></td><td><?php echo ($Invite["post"]); ?></td><td><a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Invite/enrdel',array('token'=>$Invite['token'],'id'=>$Invite['id']));?>');"><font color="red" size="2"><b>删除</b></font></a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
		</tbody>
		</table>
   </div>
