              ...
              <tbody>
              	 <tr>
                    <td align="right"><label for="title">名称：</label></td>
              		...
              		<td><input type="input" class="px" id="name" name="name" value="<?php echo ($set["name"]); ?>" style="width:420px;"></td>
              		</tr>
              		 <tr>
                    ...
                    <td align="right"><label for="title">背景音乐：</label></td>
                     ...
                     <tr>
                       ...
                       <table border="0" cellspacing="0" cellpadding="0" class="quanjing">
                         ...
                         <tr>
                           <td><input type="input" class="px" id="frontpic" value="<?php echo ($set["frontpic"]); ?>" name="frontpic" style="width:135px;"></td>
                           <td><input type="input" class="px" id="rightpic" value="<?php echo ($set["rightpic"]); ?>" name="rightpic" style="width:135px;"></td>
                           <td><input type="input" class="px" id="backpic" value="<?php echo ($set["backpic"]); ?>" name="backpic" style="width:135px;"></td>
                           <td><input type="input" class="px" id="leftpic" value="<?php echo ($set["leftpic"]); ?>" name="leftpic" style="width:135px;"></td>
                           <td><input type="input" class="px" id="toppic" value="<?php echo ($set["toppic"]); ?>" name="toppic" style="width:135px;"></td>
                           <td><input type="input" class="px" id="bottompic" value="<?php echo ($set["bottompic"]); ?>" name="bottompic" style="width:135px;"></td>
                         </tr>
                         <tr>
                           <td align="center"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('frontpic',1000,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('frontpic')">预览</a></td>
                           <td align="center"><a href="###" onclick="upyunPicUpload('rightpic',1000,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('rightpic')">预览</a></td>
                           <td align="center"><a href="###" onclick="upyunPicUpload('backpic',1000,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('backpic')">预览</a></td>
                           <td align="center"><a href="###" onclick="upyunPicUpload('leftpic',1000,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('leftpic')">预览</a></td>
                           <td align="center"><a href="###" onclick="upyunPicUpload('toppic',1000,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('toppic')">预览</a></td>
                           <td align="center"><a href="###" onclick="upyunPicUpload('bottompic',1000,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('bottompic')">预览</a></td>
                         </tr>
                       </tbody></table></td>
                     </tr>
              	...
              	<tr>
              		<td></td>
              		<td colspan="3"><button type="submit" name="button" class="btnGreen">保存</button>　<a href="<?php echo U('Panorama/index',array('token'=>$token));?>" class="btnGray vm">取消</a></td>
              		</tr>
              	</tbody>
            </table>
     </div>
