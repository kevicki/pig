...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        ...
        <div class="content">
<div class="cLineB">
<h4 class="left">微助力</h4>
<div class="clr"></div>
</div>

<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Helping/set',array('token'=>$token));?>" title="添加活动" class="btnGrayS vm bigbtn"><?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm"><?php endif; ?> 添加活动</a></div>
...
<th width="130">添加时间</th>
 ...
 <th width="50">转发数</th>
 <th width="50">浏览量</th>
<th <?php if($usertplid == 2): ?>width="290"<?php endif; ?>width="250" class="norightborder">操作</th>
</tr>
</thead>
<tbody>
<tr></tr>
...
<td>
	<?php if($item["is_newtp"] == '1'): ?><span style="color:green">新模板</span>
	<?php else: ?>	
		<span style="color:blue">旧模板</span><?php endif; ?>
</td>
...
<?php if($_SESSION['is_syn']== 2): if($usertplid != 2): ?><script type="text/javascript">
 ...
 <style type="text/css">
   ...
   #showdiv<?php echo ($item["id"]); ?>{z-index:20; display:none;position:fixed; *position:absolute; width:100px; height:100px; top:30%; left:50%; margin:-50px 0 0 -50px;}
 ...
 <div id="showdiv<?php echo ($item["id"]); ?>">
   ...
   <div id="testdiv<?php echo ($item["id"]); ?>"><img src="<?php echo (session('source_domain')); ?>/wap.php?c=Wxapp&a=qrcode&id=<?php echo ($item["id"]); ?>&modle=Helping" width="300" height="300" class="cateimg_small"></div>
 </div>
	<a id="lay<?php echo ($item["id"]); ?>"  style="width:191px;">查看二维码</a><br><?php endif; endif; ?>
	<a href="<?php echo U('Helping/rank',array('id'=>$item['id'],'token'=>$token));?>">助力排行榜</a>
	<a href="<?php echo U('Helping/set',array('id'=>$item['id'],'token'=>$token));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Helping/del',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
