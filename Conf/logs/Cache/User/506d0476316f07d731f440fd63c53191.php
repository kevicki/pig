...
<div class="content" >  
<div class="cLineB"><h4>摇一摇设置</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a></div> 
<div class="msgWrap">
...
<TR>
 ...
 <tr> 
        <th>图文回复图片：</th>
        <td><input type="text" name="thumb" value="<?php echo ($info["thumb"]); ?>" class="px" id="thumb" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('thumb',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('thumb')">预览</a></td> 
       </tr>
<tr> 
  <TR>
  ...
  <TD>
    ...
    <a href="###" onclick="upyunPicUpload('logo',400,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
...
<TR>
  ...
  <TD>
    ...
    <a href="###" onclick="upyunPicUpload('background',1500,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;
    <a href="###" onclick="viewImg('background')" class="a_upload">预览</a> 
...
<TR>
  ...
  <TD><input type="input" class="px" id="backgroundmusic" value="<?php if($info["backgroundmusic"] == ''): ?>/tpl/static/wall/music/v2.mp3<?php else: echo ($info["backgroundmusic"]); endif; ?>" name="backgroundmusic" style="width:250px" value="" >  <a href="###" onclick="chooseFile('backgroundmusic','music')" class="a_upload">选择</a> 定义大屏幕背景音乐，为URL地址
</TD>
  <TD rowspan="2" valign="top"></TD>
</TR>
<!--
...
<TR>
  ...
  <TD><input type="input" class="px" id="qrcode" value="<?php echo ($info["qrcode"]); ?>" name="qrcode" style="width:250px" value="" >  <a href="###" onclick="chooseFile('qrcode','my')" class="a_upload">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('qrcode',1500,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('qrcode')" class="a_upload">预览</a> 大屏幕显示的二维码
...
<TR>
  ...
  <TD>
  	<label for="radio3"><input id="radio3" class="radio" type="radio" name="isopen" value="1"  <?php if(($info["isopen"]) == "1"): ?>checked="checked"<?php endif; ?> /> 开启</label><br />
  	<label for="radio4"><input class="radio" id="radio4" type="radio" name="isopen" value="0" <?php if(($info["isopen"]) == "0"): ?>checked="checked"<?php endif; ?> /> 关闭</label>
  	<span style='color:red;'>关闭再重新开始可以重置连接人数。</span>
  </TD>
</TR>
<!--
<TR>
