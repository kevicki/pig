...
<li class="<?php if(ACTION_NAME == 'comments' OR (ACTION_NAME == 'comments_add')): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Business/comments',array('token'=>$token,'type'=>'ktv'));?>">客户点评</a></li>
...
<div class="content">
  <div class="cLineB">
      <h4><?php echo ($op); ?>秒杀活动</h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
  </div>
  <div class="msgWrap">
    <form class="form" method="post" action="<?php echo U('Seckill/action_add', array("type" => $_GET['type']));?>" method="post" id="formID" enctype="multipart/form-data">
      <table class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            
            <tr>
              <input type="hidden" class="px" id="id" value="<?php echo ($action_id); ?>" name="id" >
            </tr>
            <tr>
            <?php if($_SESSION['is_syn'] == 0): ?><th valign="top"><span class="red">*</span>关键词：</th>
              <td><input type="text" name="reply_keyword" data-validation-engine="validate[required,minSize[1],maxSize[30]]" data-errormessage-value-missing="必填项" value="<?php echo ($reply_keyword); ?>" class="px" style="width:450px;">&nbsp;&nbsp;回复活动关键词</td>
          		<?php else: ?>
					<th valign="top"></th>
            ...
            <tr>
              ...
              <td><input type="text" name="reply_title" data-validation-engine="validate[required,minSize[1],maxSize[50]]" data-errormessage-value-missing="必填项" value="<?php echo ($reply_title); ?>" class="px" style="width:450px;">&nbsp;&nbsp;回复标题</td>
            </tr>
            <tr>
              <th width="120">&nbsp;回复内容：</th>
              <td><textarea style="width:560px;height:75px" name="reply_content" id="info" class="px"><?php echo ($reply_content); ?></textarea><br/>最多填写120个字</td>
            </tr>
            <tr>
              <th>&nbsp;回复图片：</th>
              <td>
              <?php if($reply_pic != ''): ?><img class="thumb_img" id="picurl_src1" src="<?php echo ($reply_pic); ?>" style="max-height:100px;max-width: 200px;">
				<?php else: ?>
				 <img class="thumb_img" id="picurl_src1" src="<?php echo ($staticPath); ?>/tpl/static/seckill/images/banner.png" style="max-height:100px;max-width: 200px;"><?php endif; ?>
              <input type="text" name="reply_pic" value='<?php if($reply_pic != ''): echo ($reply_pic); else: echo ($staticPath); ?>/tpl/static/seckill/images/banner.png<?php endif; ?>' id="pic1" class="px" style="width:200px;" >
            ...
            <tr>
              ...
              <td><input type="input" class="px" id="title" value="<?php echo ($action_name); ?>" name="action_name" style="width:300px" data-validation-engine="validate[required,minSize[1],maxSize[30]]" data-errormessage-value-missing="必填项">
                请输入活动名称,30个字以内 </td>
              <td></td>
            </tr>
            ...
            <td>
            <?php if($action_header_img != ''): ?><img class="thumb_img" id="picurl_src" src="<?php echo ($action_header_img); ?>" style="max-height:100px;max-width: 200px;"><?php endif; ?>
            <input type="input" class="px" id="picurl" style="width:200px;" value="<?php echo ($action_header_img); ?>" name="action_header_img" data-validation-engine="validate[required,custom[url]]"
                    data-errormessage-value-missing="必须上传图片!"  data-errormessage-custom-error="如果是手动填写,正确的网址,如: http://www.baidu.com/images/demo.png">
			<a href="###" onclick="upyunPicUpload('picurl',1080,450,'<?php echo ($token); ?>')" class="a_upload">上传</a>
            ...
            <tr>
              ...
              <td><input type="input" class="px" id="action_sdate" value="<?php echo (date('Y-m-d',($action_sdate)?($action_sdate):time())); ?>" name="action_sdate" style="width:100px" data-validation-engine="validate[required,minSize[2],maxSize[20]]" onClick="WdatePicker()" data-errormessage-value-missing="必填项">
                <input type="input" class="px" id="action_sdate" value="<?php echo (date('H',$action_sdate)); ?>" name="action_sdate_h" style="width:50px" data-validation-engine="validate[required,minSize[1],maxSize[2]]" data-errormessage-value-missing="必填项"> 时
                <input type="input" class="px" id="action_sdate" value="<?php echo (date('i',$action_sdate)); ?>" name="action_sdate_i" style="width:50px" data-validation-engine="validate[required,minSize[1],maxSize[2]]" data-errormessage-value-missing="必填项"> 分
                &nbsp;&nbsp;&nbsp;     活动开始时间
              </td>
              <td></td>
            </tr>
            ...
            <tr>
              ...
              <td><input type="input" class="px" id="action_edate" value="<?php echo (date('Y-m-d',($action_edate)?($action_edate): strtotime('+1 month'))); ?>" name="action_edate" style="width:100px" data-validation-engine="validate[required,minSize[2],maxSize[20]]" onClick="WdatePicker()" data-errormessage-value-missing="必填项">
              <input type="input" class="px" id="action_edate" value="<?php echo (date('H',$action_edate)); ?>" name="action_edate_h" style="width:50px" data-validation-engine="validate[required,minSize[1],maxSize[2]]" data-errormessage-value-missing="必填项"> 时
                <input type="input" class="px" id="action_edate" value="<?php echo (date('i',$action_edate)); ?>" name="action_edate_i" style="width:50px" data-validation-engine="validate[required,minSize[1],maxSize[2]]" data-errormessage-value-missing="必填项"> 分
                &nbsp;&nbsp;&nbsp;      活动结束时间
              </td>
              <td></td>
            </tr>
            ...
            <tr>
              ...
              <td>
              <input type="input" class="px" id="share_time" value="<?php echo ($rand_min_time); ?>" name="share_time_min" style="width:100px" data-validation-engine="validate[required,minSize[1],maxSize[3]]" data-errormessage-value-missing="必填项">
              到
              <input type="input" class="px" id="share_time" value="<?php echo ($rand_max_time); ?>" name="share_time_max" style="width:100px" data-validation-engine="validate[required,minSize[1],maxSize[3]]" data-errormessage-value-missing="必填项">
                好友分享获得时间的范围，单位秒
              </td>
              <td></td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <textarea class="px" id="action_rule" name="action_rule" style="width: 605px; height: 350px;" ><?php echo ($action_rule); ?></textarea>
              </td>
              <td></td>
            </tr>
			<tr>
              ...
              <td>
                <input name="action_is_attention" type="radio" value = '1' id="action_rule" <?php if($action_is_attention == 1): ?>checked<?php endif; if($action_is_attention == ''): ?>checked<?php endif; ?>/> 是&nbsp;&nbsp;&nbsp;&nbsp;
                <input name="action_is_attention" type="radio" value = '2' id="action_rule" <?php if($action_is_attention == 2): ?>checked<?php endif; ?> /> 否 &nbsp;&nbsp;&nbsp;<span><?php echo ($__access_remind__); ?></span>
              </td>
              <td></td>
            </tr>
            <tr>
              ...
              <td>
                <input name="action_is_reg" type="radio" value = '1' id="action_rule" <?php if($action_is_reg == 1): ?>checked<?php endif; if($action_is_attention == ''): ?>checked<?php endif; ?>/> 是&nbsp;&nbsp;&nbsp;&nbsp;
                <input name="action_is_reg" type="radio" value = '2' id="action_rule" <?php if($action_is_reg == 2): ?>checked<?php endif; ?> /> 否
                &nbsp;&nbsp;&nbsp;&nbsp;(没有粉丝详细信息参加活动的处理方式)
              </td>
              <td></td>
            </tr>
			<tr>
              ...
              <td>
                <input name="action_open" type="radio" value = '0' id="action_rule" <?php if($action_open == 0): ?>checked<?php endif; ?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
                <input name="action_open" type="radio" value = '1' id="action_rule" <?php if($action_open == 1): ?>checked<?php endif; ?> />  关闭
