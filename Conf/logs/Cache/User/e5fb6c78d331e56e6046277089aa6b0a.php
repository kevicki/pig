...
<link rel="stylesheet" href="<?php echo ($staticPath); ?>/tpl/static/card/css/card_coupons.css"/>
...
<div class="main_bd" id="js_main_content">
				...
				<div class="msg_card_inner">
					...
					<div class="js_preview msg_card_section shop disabled">
						<div class="shop_panel" id="img_preview">
							<img src="<?php if($vip["pic"] == '' and $type == '1'): echo ($staticPath); ?>/tpl/static/card/images/youhui.png<?php elseif($vip["pic"] == '' and $type == '0'): echo ($staticPath); ?>/tpl/static/card/images/daijin.png<?php echo ($vip["pic"]); elseif($vip["pic"] == '' and $type == '2'): echo ($staticPath); ?>/tpl/static/card/images/lipin.png<?php else: echo ($vip["pic"]); endif; ?>" id="pic_src" style="max-width:100%;max-height:100%;">
						</div>
						<div class="shop_panel" id="color_preview" style="display:none;">	
							<div class="logo_area group">
								<span class="logo left">
									<img src="<?php echo ($company[0]['logourl']); ?>" id="logourl_src">
								</span>
							...
							<div class="msg_area">
								<div class="tick_msg">
									<p>
										<b id="title_preview"><?php echo ($vip["title"]); ?></b>
									</p>
								...
								<p class="time">
									<span id="validtime_preview">
										有效期：
										<span class="start"><?php if($vip['statdate'] != ''): echo (date("Y-m-d",$vip["statdate"])); else: echo (date("Y-m-d",$statdate)); endif; ?></span>
										至
										<span class="end"><?php if($vip['enddate'] != ''): echo (date("Y-m-d",$vip["enddate"])); else: echo (date("Y-m-d",$enddate)); endif; ?></span>
									</span>
								</p>
							</div>
					...
					<div class="shop_detail">
						<ul class="list">
							...
							<?php if($coupon_type == 'weixin'): ?><li class="msg_card_section js_preview last_li">
							<div class="li_panel" href="">
								<div class="li_content">
									<p>
										微信卡券
					...
					<div class="inner">
						<div class="editor_section">
							...
							<div class="appmsg_edit_item frm_normal">
								...
								<input type="input" id="title" value="<?php echo ($vip["title"]); ?>" name="title" target="#js_title_tip"  class="frm_input js_can_preview js_maxlength" placeholder="">
								</span>
								<p class="frm_tips">
									建议标题长度不超过9个汉字 ，否则开启“微信卡券”标题不能完全同步
								</p>
							</div>
							<div class="appmsg_edit_item">
								...
								<span class="frm_input_box">
									<select name="cardid" class="frm_input" style="border:0;background:none;width:100%;">
										...
										<?php if(is_array($allcard)): $i = 0; $__LIST__ = $allcard;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$allcard): $mod = ($i % 2 );++$i;?><option value="<?php echo ($allcard["id"]); ?>" <?php if($allcard['id'] == $vip['cardid']): ?>selected<?php endif; ?>><?php echo ($allcard["cardname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</span>
							</div>
							<div class="appmsg_edit_item frm_normal upload_item">
								...
								<span class="frm_input_box">
									<select name="company_id" class="frm_input"  style="border:0;background:none;width:100%;">
										...
										<?php if(is_array($company)): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item["id"]); ?>" <?php if($item['id'] == $vip['company_id']): ?>selected<?php endif; ?>><?php echo ($item["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</span>
								<p class="frm_tips">选择卡券使用门店，“微信卡券”，请先同步微信门店信息</p>
							</div>
							<!--
							<div class="appmsg_edit_item frm_normal">
								<label for="" class="frm_label">
								...
								<div class="frm_controls frm_vertical_lh">
									<div class="radio_control_group group" style="line-height: 32px;">
										<label class="frm_radio_label frm_radio_input selected" for="checkbox1">
											...
											<input type="radio" <?php if($vip['type'] == '1' or $vip['type'] == ''): ?>checked="checked"<?php endif; ?> name="type" class="type" value="1">
											<span class="lbl_content">优惠券</span>&nbsp;&nbsp;
											<input type="radio" <?php if($vip['type'] == '2' and $vip['type'] != ''): ?>checked="checked"<?php endif; ?>  name="type" class="type" value="2">
											<span class="lbl_content">礼品券</span>&nbsp;&nbsp;
											<input type="radio" <?php if($vip['type'] == '0' and $vip['type'] != ''): ?>checked="checked"<?php endif; ?>  name="type"  class="type" value="0">
							...
							<div class="appmsg_edit_item">
								...
								<span class="frm_input_box" style="width:175px;">
									<input type="input" name="pic" id="pic" value="<?php if($vip["pic"] == '' or $vip["type"] == '1'): echo ($staticPath); ?>/tpl/static/card/images/youhui.png<?php elseif($vip["pic"] == '' and $vip["type"] == '0'): echo ($staticPath); ?>/tpl/static/card/images/daijin.png<?php elseif($vip["pic"] == '' and $vip["type"] == '2'): echo ($staticPath); ?>/tpl/static/card/images/lipin.png<?php else: echo ($vip["pic"]); endif; ?>" class="frm_input js_can_preview js_maxlength valid">
								</span>
								<script src="/tpl/static/upyun.js"></script>
								<a href="###" onclick="upyunPicUpload('pic',720,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
								<span class="tips">[720*400]</span>
							</div>

							<div class="appmsg_edit_item frm_normal gift" <?php if($vip['type'] == '2' or $type == '2'): else: ?>style="display:none"<?php endif; ?>>
								<label for="" class="frm_label">
									<strong class="title">礼品名称</strong>
								</label>
								<span class="frm_input_box">
									<input type="input" value="<?php echo ($vip["gift_name"]); ?>" name="gift_name" class="frm_input js_can_preview js_maxlength valid">
								</span>
							</div>
							...
							<div class="appmsg_edit_item frm_normal gift" <?php if($vip['type'] == '2' or $type == '2'): else: ?>style="display:none"<?php endif; ?>>
								...
								<span class="frm_input_box">
									<input type="input" value="<?php echo ($vip["integral"]); ?>" name="integral" class="frm_input js_can_preview js_maxlength valid">
								</span>
								<p class="frm_tips">设置领取此券的积分</p>
	
							</div>

							<div class="appmsg_edit_item frm_normal cktime" <?php if($vip['type'] == '0' or $type == '0'): else: ?>style="display:none"<?php endif; ?>>
								<label for="" class="frm_label">
									<strong class="title">启用金额</strong>
								</label>
								<span class="frm_input_box">
									<input type="input"value="<?php echo ($vip["least_cost"]); ?>" name="least_cost" class="frm_input js_can_preview js_maxlength valid">
								</span>
								<p class="frm_tips">使用此券的消费金额</p>
							</div>	
							<div class="appmsg_edit_item frm_normal cktime" <?php if($vip['type'] == '0' or $type == '0'): else: ?>style="display:none"<?php endif; ?>>
								<label for="" class="frm_label">
								...
								<span class="frm_input_box">
									<input type="input" value="<?php echo ($vip["reduce_cost"]); ?>" name="reduce_cost" class="frm_input js_can_preview js_maxlength valid">
								</span>
						...
						<div class="editor_section">
							...
							<div class="appmsg_edit_item">
								...
								<div class="input_submsg">
									<span class="frm_input_box">
										<input type="input" id="total" value="<?php if($vip['total'] == ''): ?>100<?php else: echo ($vip["total"]); endif; ?>" name="total" class="frm_input js_can_preview js_maxlength valid" >
									</span>
							...
							<div class="appmsg_edit_item appmsg_edit_item_label_mult appmsg_input_submsg_item group">
								...
								<div class="input_submsg l">
									<span class="frm_input_box">
										<input type="input"  id="people" value="<?php if($vip['people'] == ''): ?>1<?php else: echo ($vip["people"]); endif; ?>" name="people"  class="frm_input js_can_preview js_maxlength valid" >
									</span>
								...
								<div class="frm_control_group radio_row">
									...
									<div id="js_colorpicker" class="color_picker dropdown_menu">
										<span class="frm_input_box" style="width:125px;">
											<input type="input" id="statdate" value="<?php if($vip['statdate'] != ''): echo (date("Y-m-d",$vip["statdate"])); else: echo (date("Y-m-d",$statdate)); endif; ?>" onclick="WdatePicker()" name="statdate" class="frm_input js_can_preview js_maxlength valid"> 
										</span>
										-
										<span class="frm_input_box" style="width:125px;">
											<input type="input" id="enddate" value="<?php if($vip['enddate'] != ''): echo (date("Y-m-d",$vip["enddate"])); else: echo (date("Y-m-d",$enddate)); endif; ?>" name="enddate" onclick="WdatePicker()" class="frm_input js_can_preview js_maxlength valid">
										</span>
									</div>
							...
							<div class="appmsg_edit_item textarea_item">
								...
								<div class="frm_controls">
									<div class="frm_textarea_box">
										<textarea name="info" class="frm_textarea" class="frm_textarea"><?php echo ($vip["info"]); ?></textarea>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="inner">
						<div class="editor_section">
							...
							<div class="appmsg_edit_item">
								...
								<span class="frm_input_box">
									<input type="input" value="" name="brand_name" id="brand_name" class="frm_input js_can_preview js_maxlength valid">
								</span>
								<p class="frm_tips">
									建议长度不超过12个汉字，否则开启“微信卡券”名称不能完全同步
								</p>
							</div>
							<div class="appmsg_edit_item frm_normal upload_item">
								<label for="" class="frm_label">
								...
								<p class="frm_tips">
									<span class="frm_input_box">
										<input type="text" name="logourl" id="logourl" value="<?php echo ($company[0]['logourl']); ?>"  class="frm_input js_can_preview js_maxlength valid" >
									</span>
									<script src="/tpl/static/upyun.js"></script>
									<span class="input_sub_msg">
										<a href="###" onclick="upyunPicUpload('logourl',400,400,'<?php echo ($token); ?>')" class="a_upload">上传</a>
							...
							<div class="appmsg_edit_item">
								...
								<div id="js_colorpicker" class="color_picker dropdown_menu">
									<select name="color" style="width:180px;" class="color">
										<?php if(is_array($color)): $i = 0; $__LIST__ = $color;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$color): $mod = ($i % 2 );++$i;?><option value="<?php echo ($color["name"]); ?>" <?php if($color['name'] == $vip['color']): ?>selected<?php endif; ?>>		<?php echo ($color["value"]); ?>
	...
	<div class="tool_bar border tc">
		<input type="hidden" name="id" value="<?php echo ($vip["id"]); ?>">
		<?php if($coupon_type == 'local'): ?><input type="hidden" name="is_check" value="1"><?php endif; ?>
		<?php if($vip['attr'] == '1' or $attr == 1): ?><input type="hidden" name="is_check" value="1">
			<input type="hidden" name="attr" 	 value="1"><?php endif; ?>
		<input type="hidden" name="type" value="<?php if($vip["id"] != ''): echo ($vip["type"]); else: echo ($type); endif; ?>">
...
<script>
	...
	$('.type').change(function(){
		 if($(this).val() == 1){ 
			 $('#pic_src').attr('src','<?php echo ($staticPath); ?>/tpl/static/card/images/youhui.png');
			 $('#pic').val('<?php echo ($staticPath); ?>/tpl/static/card/images/youhui.png');
			 $('.cktime').css('display','none');
			 $('.gift').css('display','none');
		 }else if ($(this).val() == 2){
			 $('#pic_src').attr('src','<?php echo ($staticPath); ?>/tpl/static/card/images/lipin.png');
			 $('#pic').val('<?php echo ($staticPath); ?>/tpl/static/card/images/lipin.png');
			 $('.gift').css('display','');
			 $('.cktime').css('display','none');
		 }else{
			 $('#pic_src').attr('src','<?php echo ($staticPath); ?>/tpl/static/card/images/daijin.png');
			 $('#pic').val('<?php echo ($staticPath); ?>/tpl/static/card/images/daijin.png');
			 $('.cktime').css('display','');
			 $('.gift').css('display','none');
		 }
	 });
