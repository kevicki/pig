...
<li class="current tabli" id="tab1"><a href="<?php echo U('DishOut/Statistics', array('token' => $token,'cid' => $cid));?>">外卖统计</a></li>
</ul>
</div>
<!--tab end-->
    <div class="msgWrap bgfc"> 
		...
		<div class="cLine">
		开始时间：<input type="input" class="px" name="stime" id="stime" value="<?php echo ($stime); ?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"> &nbsp;&nbsp;&nbsp;
		结束时间：<input type="input" class="px" name="etime" id="etime" value="<?php echo ($etime); ?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">&nbsp;&nbsp;&nbsp;
		<a class="btnGreen" onclick="toInquiry();">提 交</a>
		<div class="clr" style="height:15px;"></div>
		</div>
		<?php if(isset($nodata)): ?><div style="margin-left: 20px;color: red;font-size: 20px;">没有数据！</div><?php endif; ?>
...
<script type="text/javascript">
    ...
    var option = {
        title : {
            text: '外卖菜品统计',
			subtext: "菜品的销售总份数：<?php echo ($tnums); ?> / 份\n菜品的销售总金额：<?php echo ($tmoney); ?> / 元",
            x:'left'
        },
        tooltip : {
            trigger: 'axis',
