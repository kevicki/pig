...
<th width="303" rowspan="6" valign="top">
	...
	<span class="red">Logo宽370px高170px，背景图宽534px高318px，图片类型png。<a href="<?php echo RES;?>/images/cart_info/template.rar" class="green">请下载模板</a></span>
</th>
</tr>
<tr>
<td colspan="2">最低积分要求：
...
<tr>
<td colspan="2">会员卡的图标：
<input type="text" name="logo" id="member-card-logo" value="<?php echo ($card["logo"]); ?>" class="px" style="width:200px;" /> 
<input type="button" onclick="document.getElementById('cardlogo').src=document.getElementById('member-card-logo').value;" value="显示效果" class="btnGrayS"> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('member-card-logo',50,50,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('member-card-logo')">预览</a></td>
</tr>
<tr>
<td colspan="2">会员卡的背景：
	<select name="bg" onchange="document.getElementById('cardbg').src=this.options[this.selectedIndex].value;document.getElementById('member-card-bg').value=this.options[this.selectedIndex].value;" class="pt" style="width:210px;"> 
...
<tr>
<td colspan="2">自己设计背景：
	<input type="text" name="diybg" id="member-card-bg" class="px" value="<?php echo ($card["diybg"]); ?>" style="width:200px;"> 
	<input type="button" onclick="document.getElementById('cardbg').src=document.getElementById('member-card-bg').value;" value="显示效果" class="btnGrayS"> 
	  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('member-card-bg',1000,600,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('member-card-bg')">预览</a> 背景图
</td>
</tr>
<tr>
<td colspan="2">
...
<!-- <th width="303" rowspan="5" valign="top">
	<div class="vipcard">
		<h3>签到头部图片</h3>
		<img id="qiandao2_src" src="<?php if($card["qiandao"] != ''): echo ($card["qiandao"]); else: ?>/tpl/User/default/common/images/cart_info/qiandao.jpg<?php endif; ?>" style="width:265px;height:150px;">
		<br />
		<textarea name="qiandao" class="px" id="qiandao2" style="width:255px; height:35px" onblur="document.getElementById('qiandao2_scr').src=document.getElementById('qiandao2').value;"><?php if($card["qiandao"] != ''): echo ($card["qiandao"]); else: ?>/tpl/User/default/common/images/cart_info/qiandao.jpg<?php endif; ?></textarea>
		<br />
		<script src="/tpl/static/upyun.js"></script>
		<a href="###" onclick="upyunPicUpload('qiandao2',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
...
<td colspan="3">
开启充值赠送：
<input type="radio" class="px" name="is_donate" value="0" <?php if($card["is_donate"] == 0): ?>checked<?php endif; ?>>关闭&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" class="px" name="is_donate" value="1" <?php if($card["is_donate"] == 1): ?>checked<?php endif; ?>>开启&nbsp;&nbsp;&nbsp;(开启充值赠送后，可设置充值赠送选项)
</td>
</tr>
...
<td colspan="2">
会员卡使用说明：<br />
<textarea class="px" id="info" name="info" style="width: 300px; height: 150px; display: none;"><?php echo ($card["info"]); ?></textarea>
</td>
</tr>
<tr>
<td colspan="2"><button type="submit" name="button" class="btnGreen">保存</button></td>
</tr>
</tbody>
</table>
</div> 
