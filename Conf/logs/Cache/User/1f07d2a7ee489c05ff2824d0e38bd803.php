...
<div class="cLineB">
  ...
  <a href='<?php echo U('Zhaopianwall/add',array('token'=>$token));?>' title='新增照片墙活动' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" />新增照片墙活动</a>
