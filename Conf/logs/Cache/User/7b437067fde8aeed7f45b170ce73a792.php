...
<link rel="stylesheet" type="text/css" href="<?php echo ($staticPath); echo ltrim(RES,'.');?>/css/catemenu-style/style_2_common.css" media="all">
 <div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>>
        ...
        <div class="msgWrap">
        <div class="ftip" style="margin:10px 0">更换菜单样式后需要过大概五分钟才会生效</div> 
                ...
                <td><form id="form1" name="form1" method="post" action="">
                    <ul class="cateradio">
                     <li <?php if($radiogroup == 0): ?>class="active"<?php endif; ?> >
                      ...
                      <li <?php if($radiogroup == 17): ?>class="active"<?php endif; ?>>
                        <label><img src="<?php echo RES;?>/css/catemenu-style/017.png">
                          <input class="radio" type="radio" name="radiogroup" value="17" id="radiogroup_17" <?php if($radiogroup == 17): ?>checked<?php endif; ?>>
                          17</label>
                      </li>
                    </ul>
                    <script>
