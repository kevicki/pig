...
<div class="content">
          <div class="cLineB"><h4><?php echo ($thisCard["cardname"]); ?>：发布优惠券 <span class="FAQ">发布现金抵用券和打折优惠券信息</span></h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a></div>
...
<td height="35">
	<label>
	  <input type="radio" <?php if($vip['attr'] == '0' or $vip['attr'] == ''): ?>checked="checked"<?php endif; ?> name="attr" class="attr" value="0">
普通券</label>
　<label>
		<input type="radio" <?php if($vip['attr'] == '1'): ?>checked="checked"<?php endif; ?> name="attr" class="attr" value="1">
赠送劵
  </label>
  &nbsp;
  (赠送劵只有在添加开卡赠送的时候可以使用)
...
<td height="35">
	<label>
		<input type="radio" <?php if($vip['type'] == 1): ?>checked="checked"<?php endif; ?> name="type" class="type" value="1">
	优惠券
	</label>
　<label>
	<input name="type" <?php if($vip['type'] == 0): ?>checked="checked"<?php endif; ?>  type="radio" class="type" value="0">
	现金券
  </label>
...
<tr>
<th>发放总数：</th>
<td><input type="input" class="px" id="total" value="<?php if($vip['total'] == ''): ?>0<?php else: echo ($vip["total"]); endif; ?>" name="total" style="width:120px;"> 张 (“0”不限制)</td>
</tr>
<tr>
<th>每人可领取数：</th>
<td><input type="input" class="px" id="people" value="<?php if($vip['people'] == ''): ?>0<?php else: echo ($vip["people"]); endif; ?>" name="people" style="width:120px;"> 张 (“0”不限制)</td>
</tr>
<tr>
<th>优惠劵图标：</th>
<td>
<img src="<?php if($vip["pic"] == '' and $vip["type"] == 1): echo ($staticPath); ?>/tpl/static/card/images/youhui.png<?php elseif($vip["pic"] == '' and $vip["type"] == 0): echo ($staticPath); ?>/tpl/static/card/images/daijin.png<?php else: echo ($vip["pic"]); endif; ?>" id="pic_src"style="max-width:200px;"><br/>

<input type="text" name="pic" id="pic" value="<?php if($vip["pic"] == '' and $vip["type"] == 1): echo ($staticPath); ?>/tpl/static/card/images/youhui.png<?php elseif($vip["pic"] == '' and $vip["type"] == 0): echo ($staticPath); ?>/tpl/static/card/images/daijin.png<?php else: echo ($vip["pic"]); endif; ?>" class="px" style="width:200px;"> 
