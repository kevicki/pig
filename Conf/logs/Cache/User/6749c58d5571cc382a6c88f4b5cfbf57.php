...
<script type="text/javascript" src="<?php echo RES;?>/js/formCheck/formcheck.js">
</script>
<script src="<?php echo STATICS;?>/kindeditor/plugins/code/prettify.js" type="text/javascript"></script>
<script type="text/javascript">
var editor;
...
<div class="content">
	<div class="cLineB">
		 <h4>添加简历信息</h4>  <a href="<?php echo U('Zhaopin/jianli',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a> 
	</div>
	<div class="tab">
		<ul>
			<li class="tabli" id="tab2"><a href="<?php echo U('Zhaopin/index');?>">招聘信息管理</a>
			</li>
			<li class="current tabli" id="tab2"><a href="<?php echo U('Zhaopin/jianli');?>">简历信息管理</a>
			</li>
			<li class=" tabli" id="tab20"><a href="<?php echo U('Zhaopin/reply');?>">回复信息配置</a>
			</li>
		</ul>
	</div>
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
				<tbody>
					<tr>
						...
						<td>
							<input type="text" id="name" name="name" placeholder=" 请填写姓名" value="<?php echo ($set["name"]); ?>" class="px" style="width:400px;" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<select name="sex" id="sex" class="input-medium">
								<option value="男" <?php if(($set["sex"]) == "男"): ?>selected<?php endif; ?>>男</option>
								<option value="女" <?php if(($set["sex"]) == "女"): ?>selected<?php endif; ?>>女</option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" id="age" name="age" placeholder=" 请填写年龄" value="<?php echo ($set["age"]); ?>" class="px" style="width:400px;" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<select name="year" id="year" class="select">
                            	<?php
 $i=0;$str=''; for($i=1960;$i<=date('Y');$i++){ $str=$str.'<option value="'.$i.'" '; if($i==intval($set['year'])) $str=$str.'selected '; $str=$str.'>'.$i.'</option>'; } echo $str; ?>
							</select>&nbsp;年&nbsp;
							<select name="month" id="month" class="select">
                            	<?php
 $i=0;$str=''; for($i=1;$i<=12;$i++){ $str=$str.'<option value="'.sprintf('%02s',$i).'" '; if($i==intval($set['month'])) $str=$str.'selected '; $str=$str.'>'.sprintf('%02s',$i).'</option>'; } echo $str; ?>
							</select>&nbsp;月&nbsp;
							<select name="day" id="day" class="select">
								<?php
 $i=0;$str=''; for($i=1;$i<=31;$i++){ $str=$str.'<option value="'.sprintf('%02s',$i).'" '; if($i==intval($set['day'])) $str=$str.'selected '; $str=$str.'>'.sprintf('%02s',$i).'</option>'; } echo $str; ?>
							</select>&nbsp;日&nbsp;</td>
					</tr>
					<tr>
						<th><span class="red">*</span>联系电话：</th>
						<td>
							<input type="text" id="phone" name="phone" placeholder=" 请填写常用联系电话" value="<?php echo ($set["phone"]); ?>" class="px" style="width:400px;" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<select name="education" id="education" class="select">
								<option value="初中及以下" <?php if(($set["education"]) == "初中及以下"): ?>selected<?php endif; ?>>初中及以下</option>
								<option value="高中" <?php if(($set["education"]) == "高中"): ?>selected<?php endif; ?>>高中</option>
								<option value="大专" <?php if(($set["education"]) == "大专"): ?>selected<?php endif; ?>>大专</option>
								<option value="本科" <?php if(($set["education"]) == "本科"): ?>selected<?php endif; ?>>本科</option>
								<option value="硕士及以上" <?php if(($set["education"]) == "硕士及以上"): ?>selected<?php endif; ?>>硕士及以上</option>
							</select>
						</td>
					</tr>
                    <tr>
                        ...
                        <td>
                            <select name="leibie" id="auth2nd" class="input-medium">
                                <option value="服务/销售" <?php if(($set["leibie"]) == "服务/销售"): ?>selected<?php endif; ?>>服务/销售</option>
                                <option value="电子/商务" <?php if(($set["leibie"]) == "电子/商务"): ?>selected<?php endif; ?>>电子/商务</option>
                                <option value="普工/技工" <?php if(($set["leibie"]) == "普工/技工"): ?>selected<?php endif; ?>>普工/技工</option>
                                <option value="市场/运营" <?php if(($set["leibie"]) == "市场/运营"): ?>selected<?php endif; ?>>市场/运营</option>
                            </select>
                        </td>
                    </tr>
					<tr>
						...
						<td>
							<input type="text" id="job" name="job" placeholder=" 请填写期望工作" value="<?php echo ($set["job"]); ?>" class="px" style="width:400px;" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<select name="salary" id="salary" class="select">
								<option value="1000-3000" <?php if(($set["salary"]) == "1000-3000"): ?>selected<?php endif; ?>>1000-3000</option>
								<option value="3000-5000" <?php if(($set["salary"]) == "3000-5000"): ?>selected<?php endif; ?>>3000-5000</option>
								<option value="5000-7000" <?php if(($set["salary"]) == "5000-7000"): ?>selected<?php endif; ?>>5000-7000</option>
								<option value="7000-10000" <?php if(($set["salary"]) == "7000-10000"): ?>selected<?php endif; ?>>7000-10000</option>
								<option value="10000以上" <?php if(($set["salary"]) == "10000以上"): ?>selected<?php endif; ?>>10000以上</option>
							</select>
						</td>
					</tr>
					<tr>
						<TR>
							...
							<TD>
								<input type="text" id="workarea" name="workarea" placeholder=" 请填写期望工作地点" value="<?php echo ($set["workarea"]); ?>" class="px" style="width:400px;" />
							</TD>
						</TR>
						<TR>
							<TH valign="top"><span class="red">*</span>自我简介：</TH>
							<TD>
								<textarea name="introduce" id="introduce" rows="5" style="width:590px;height:360px;border:1px solid black;"><?php echo ($set["introduce"]); ?></textarea>
							</TD>
						</TR>
                        <TR>
							...
							<TD>
								<select name="validTime" id="validTime" class="select">
                                    <option value="3" <?php if(($set["validTime"]) == "3"): ?>selected<?php endif; ?>>3天</option>
                                    <option value="5" <?php if(($set["validTime"]) == "5"): ?>selected<?php endif; ?>>5天</option>
                                    <option value="10" <?php if(($set["validTime"]) == "10"): ?>selected<?php endif; ?>>10天</option>
                                    <option value="15" <?php if(($set["validTime"]) == "15"): ?>selected<?php endif; ?>>15天</option>
                                    <option value="20" <?php if(($set["validTime"]) == "20"): ?>selected<?php endif; ?>>20天</option>
                                    <option value="30" <?php if(($set["validTime"]) == "30"): ?>selected<?php endif; ?>>30天</option>
                                </select>
							</TD>
						</TR>
						...
						<tr>
							...
							<td>
								...
								<button type="submit" class="btnGreen">保存</button>&nbsp; <a href="<?php echo U('Zhaopin/index',array('token'=>$token));?>" class="btnGray vm">取消</a>
							</td>
						</tr>
				</tbody>
			</table>
