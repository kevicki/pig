...
<div class="content"> 
	<div class="cLineB"> 
		<h4>外卖管理</h4> 
		<a href="<?php echo U('DishOut/index',array('token' => $token,'cid'=>$cid));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
	</div> 
...
<div class="tab">
<ul>
<li class="tabli" id="tab3"><a href="<?php echo U('DishOut/index', array('token' => $token,'cid' => $cid));?>">外卖菜单</a></li>
<li class="current tabli" id="tab2"><a href="<?php echo U('DishOut/manageTime', array('token' => $token,'cid' => $cid));?>">外卖管理</a></li>
...
<input type="hidden" name="tid" value="<?php echo ($mtime['id']); ?>" />
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody>
       <tr> 
        <th>营业时间：</th> 
		<td style="width:480px"><div>时间段一从 <input type="input" class="px" name="zc_sdate" id="zc_sdate" value="<?php if($mtime['zc_sdate'] > 0): echo (date("H:i",$mtime['zc_sdate'])); endif; ?>" onClick="WdatePicker({dateFmt:'H:mm'})"> 开始
		&nbsp;到&nbsp; 
		<input type="input" class="px" name="zc_edate" id="zc_edate" value="<?php if($mtime['zc_edate'] > 0): echo (date("H:i",$mtime['zc_edate'])); endif; ?>"  onClick="WdatePicker({dateFmt:'H:mm'})"> 结束</div>
		<br/>
		<div>
		时间段二从 <input type="input" class="px" name="wc_sdate" id="wc_sdate" value="<?php if($mtime['wc_sdate'] > 0): echo (date("H:i",$mtime['wc_sdate'])); endif; ?>" onClick="WdatePicker({dateFmt:'H:mm',minDate:'5:00'})"> 开始
		&nbsp;到&nbsp; 
		<input type="input" class="px" name="wc_edate" id="wc_edate" value="<?php if($mtime['wc_edate'] > 0): echo (date("H:i",$mtime['wc_edate'])); endif; ?>"  onClick="WdatePicker({dateFmt:'H:mm',minDate:'5:00'})"> 结束</div>
		</td>
		<td rowspan="2"><span class="red">如果您的经营时间是19:00-凌晨02:00，你可以第一段开始时间留空不填 结束时间02:00,第二段开始时间19:00 结束时间留空不填。全不填默认为全天24小时营业</span></td>
       </tr>
	   <!---
       <tr> 
        <th>晚餐送餐时间段：</th> 
		<td style="width:480px"><input type="input" class="px" name="wc_sdate" id="wc_sdate" value="<?php if($mtime['wc_sdate'] > 0): echo (date("H:i",$mtime['wc_sdate'])); endif; ?>" onClick="WdatePicker({dateFmt:'H:mm',minDate:'5:00'})">
		到
		<input type="input" class="px" name="wc_edate" id="wc_edate" value="<?php if($mtime['wc_edate'] > 0): echo (date("H:i",$mtime['wc_edate'])); endif; ?>" onClick="WdatePicker({dateFmt:'H:mm',minDate:'5:00'})"> 结束</td>
		<td></td>
       </tr>
	   --->
       <tr> 
        ...
        <input type="text" name="permin" id="permin" class="px" style="width:25px;" value="<?php if($mtime['permin'] > 0): echo ($mtime['permin']); else: ?>15<?php endif; ?>"/>&nbsp;分钟显示一个时间供客户选择外卖送达时间
       ...
       <tr> 
        ...
        <input type="text" name="removing" id="removing" class="px" style="width:285px;" value="<?php if($mtime['removing'] > 0): echo ($mtime['removing']); else: ?>5<?php endif; ?>"/>&nbsp;公里
	   ...
	   <tr>
	    <th>配送区域：</th> 
        <td style="width:370px">
        <input type="text" name="area" id="area" class="px" style="width:285px;" value="<?php if($mtime['area']): echo (htmlspecialchars_decode($mtime['area'],ENT_QUOTES)); endif; ?>"/>
	    ...
	    <th>送达时间：</th> 
        <td style="width:370px">
        <input type="text" name="sendtime" id="sendtime" class="px" style="width:285px;" value="<?php if($mtime['sendtime'] > 0): echo ($mtime['sendtime']); endif; ?>"/>&nbsp;分钟
	    ...
	    <tr> 
        <th>门店幻灯图片1：</th>
        <td><input type="text" name="simage[]" value="<?php echo ($simage['img']['0']); ?>" class="px" id="img0shop" style="width:380px;" /> <a href="###" onclick="upyunPicUpload('img0shop',640,270,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img0shop')"> &nbsp;预览</a>图片建议尺寸[640*270]</td>
		<td>&nbsp;&nbsp;<input type="text" name="tourl[]"  value="<?php echo ($simage['tourl']['0']); ?>" placeholder="跳转地址" class="px" style="width:130px;" id="tourl_0"><a href="###" onclick="addLink('tourl_0',0)" class="a_choose" >从功能库添加</a></td>
       </tr>
	    <tr> 
        <th>门店幻灯图片2：</th>
        <td><input type="text" name="simage[]" value="<?php echo ($simage['img']['1']); ?>" class="px" id="img1shop" style="width:380px;" />  <a href="###" onclick="upyunPicUpload('img1shop',640,270,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img1shop')"> &nbsp;预览</a>图片建议尺寸[640*270]</td> 
		<td>&nbsp;&nbsp;<input type="text" name="tourl[]"  value="<?php echo ($simage['tourl']['1']); ?>" placeholder="跳转地址" class="px" style="width:130px;" id="tourl_1"><a href="###" onclick="addLink('tourl_1',0)" class="a_choose" >从功能库添加</a></td>
       </tr>
	    <tr> 
        <th>门店幻灯图片3：</th>
        <td><input type="text" name="simage[]" value="<?php echo ($simage['img']['2']); ?>" class="px" id="img2shop" style="width:380px;" /><a href="###" onclick="upyunPicUpload('img2shop',640,270,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img2shop')"> &nbsp;预览</a>图片建议尺寸[640*270]</td>
		<td>&nbsp;&nbsp;<input type="text" name="tourl[]"  value="<?php echo ($simage['tourl']['2']); ?>" placeholder="跳转地址" class="px" style="width:130px;" id="tourl_2"><a href="###" onclick="addLink('tourl_2',0)" class="a_choose" >从功能库添加</a></td>
       </tr>
	    <tr> 
        <th>门店幻灯图片4：</th>
        <td><input type="text" name="simage[]" value="<?php echo ($simage['img']['3']); ?>" class="px" id="img3shop" style="width:380px;" /><a href="###" onclick="upyunPicUpload('img3shop',640,270,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img3shop')"> &nbsp;预览</a>图片建议尺寸[640*270]</td> 
		<td>&nbsp;&nbsp;<input type="text" name="tourl[]"  value="<?php echo ($simage['tourl']['3']); ?>"  placeholder="跳转地址" class="px" style="width:130px;" id="tourl_3"><a href="###" onclick="addLink('tourl_3',0)" class="a_choose" >从功能库添加</a></td>
       </tr>

       <tr>
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="submit" class="btnGreen" id="save">保存</button> &nbsp; <a href="<?php echo U('DishOut/index',array('token' => $token, 'cid' => $cid));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
