...
<div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>>
              ...
              <THEAD>
                <TR>
                 ...
                 <TR>
                  ...
                  <TD>
                    <label for="radio2"><input class="radio" id="radio2" type="radio" name="precisions" value="0" <?php if($info['precisions'] == 0): ?>checked="checked"<?php endif; ?> /> 包含匹配 （当此关键词包含粉丝输入关键词时有效）</label>
                    <br />
                    <label for="radio1"><input id="radio1" class="radio" type="radio" name="precisions" value="1" <?php if($info['precisions'] == 1): ?>checked="checked"<?php endif; ?> /> 完全匹配  （当此关键词和粉丝输入关键词完全相同时有效）</label>
                  </TD>
                </TR>
              </THEAD>
              <TBODY>
            ...
            <TD><input type="text" class="px" id="pic"  name="pic" value="<?php echo ($info["pic"]); ?>" style="width:580px;"  />  <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a>
               ...
               <TR>
                ...
                <TR>
                  ...
                  <TD>
                      隐藏<input class="radio" type="radio" name="is_focus" value="0" <?php if(($info["is_focus"]) == "0"): ?>checked="checked"<?php endif; ?> />
                      &nbsp;&nbsp;
                      &nbsp;&nbsp;
                      显示<input class="radio" type="radio" name="is_focus" value="1" <?php if(($info["is_focus"]) == "1"): ?>checked="checked"<?php endif; ?> />
                       &nbsp;&nbsp;
                ...
                <TR>
                  ...
                  <TD><textarea name="info" id="info"  rows="5" style="width:590px;height:360px"><?php echo ($info["info"]); ?></textarea>
 ...
 if( 2 < $wxuser['winxintype']): ?>
	...
	art.dialog.open('<?php echo U('Map/setLatLng',array('token'=>$token,'id'=>$id));?>',{lock:false,title:'设置经纬度',width:600,height:400,yesText:'关闭',background: '#000',opacity: 0.87});
        ...
        <td>经度 <input type="text" id="longitude"  name="longitude" size="14" class="px" value="<?php echo ($info["longitude"]); ?>" /> 纬度 <input type="text"  name="latitude" size="14" id="latitude" class="px" value="<?php echo ($info["latitude"]); ?>" /> <a href="###" onclick="setlatlng($('#longitude').val(),$('#latitude').val())">在地图中查看/设置</a>&nbsp;&nbsp;可以根据粉丝发送的地理位置后推送最近的图文（可以不填）</td> 
       </tr>
                <TR>
