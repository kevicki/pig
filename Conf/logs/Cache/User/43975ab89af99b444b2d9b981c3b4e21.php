...
<div class="tab">
	<ul>
		<li style="display:none" class="<?php if(ACTION_NAME == 'index'): ?>current<?php endif; ?> tabli" id="tab0"><a href="<?php echo U('ServiceUser/index',array('token'=>$token));?>">客服工号管理</a></li>
		...
		<li style="display:none" class="<?php if(ACTION_NAME == 'son'): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('ServiceUser/chat_log',array('token'=>$token));?>">聊天记录管理</a></li>
