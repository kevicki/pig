...
<div class="msgWrap form">
  ...
  <tr>
    <th>兑换消耗积分：</th>
    <td><input type="input" class="px" id="title" value="<?php echo ($vip["integral"]); ?>" name="integral" style="width:50px;">点</td>
  </tr>
<tr>
<th>使用门店：</th>
<td>
...
<tr>
  <th>优惠劵图标：</th>
  <td>
  <img src="<?php if($vip["pic"] == ''): echo ($staticPath); ?>/tpl/static/card/images/lipin.png<?php else: echo ($vip["pic"]); endif; ?>" id="pic_src"style="max-width:200px;"><br/>
  <input type="text" name="pic" id="pic" value="<?php if($vip["pic"] == ''): echo ($staticPath); ?>/tpl/static/card/images/lipin.png<?php else: echo ($vip["pic"]); endif; ?>" class="px" style="width:200px;"> 
