...
<tr><td align="right">消息加解密方式：</td><td><?php echo ($info["encodetype"]); ?></td></tr><?php endif; ?>

<?php if($fuwu == TRUE): ?><tr><td align="right">网关（服务窗）</td><td><input class="px" value="<?php echo ($f_siteUrl); echo U('Fuwu/Fuwu/api',array('token'=>$info['token']));?>" style="width:550px;height:30px;" /> <input id="copy-button4" data-clipboard-text="<?php echo C('site_url'); echo U('Fuwu/Fuwu/api',array('token'=>$info['token']));?>" class="btn btn-sm btn-default" value="复制" type="button"></td></tr>

  <tr><td align="right">公钥（服务窗）</td><td><input class="px" value="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDVwtjFJVYyf4/sZY+GE3FSeLx7RyOmt+KoWnLi9XsRpQdaXRd+X7mO8kr8Yw6KN9TwgZV8o7iVi3OsuuCD/hgua4Go2oyIWG/NjcaqM3nXOYripfV+BlOdslKBVyAhY6SNuavLt97CVpAe2bIcZH/heNQnHoMQtb/X+KoC6kwouQIDAQAB" style="width:550px;height:30px;" /> <input id="copy-button5" data-clipboard-text="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDVwtjFJVYyf4/sZY+GE3FSeLx7RyOmt+KoWnLi9XsRpQdaXRd+X7mO8kr8Yw6KN9TwgZV8o7iVi3OsuuCD/hgua4Go2oyIWG/NjcaqM3nXOYripfV+BlOdslKBVyAhY6SNuavLt97CVpAe2bIcZH/heNQnHoMQtb/X+KoC6kwouQIDAQAB" class="btn btn-sm btn-default" value="复制" type="button"></td></tr><?php endif; ?>
