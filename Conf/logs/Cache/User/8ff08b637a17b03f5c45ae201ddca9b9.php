...
<!--活动开始-->
<div class="cLineB">
    <h4>高级微场景设置</h4><a href="<?php echo U('SeniorScene/index',array('token'=>$token));?>"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
</div>
...
<tr>
  <th>封面图片地址：</th>
  <td>
    <input class="px"  name="pic" value="<?php echo ($info["pic"]); ?>" id="pic1" style="width:250px;"  />
...
<tr>
  <th valign="top"><label for="url">选择已有场景 ：</label></th>
  <td><input type="text" class="px" id="url" value="<?php echo ($info["url"]); ?>" name="url" style="width:300px"> <a href="###" onclick="addLink('url',0)" class="a_choose">从功能库添加</a><a href="<?php echo U('SeniorScene/highLive',array('token'=>$token));?>" target="_blank" class="a_choose">创建新场景</a><br>
  </td>
  <td>&nbsp;</td>
</tr>
<TR>
