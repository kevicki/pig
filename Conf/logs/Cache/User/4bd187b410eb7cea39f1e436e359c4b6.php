...
<tr>
	...
	<td><div class="cateimg"></div><input class="px"  style="width:250px;"   type="text"   name="picurl" id="picurl<?php echo ($i); ?>" value="<?php echo ($photo["picurl"]); ?>"  /> <a href="###" onclick="upyunPicUpload('picurl<?php echo ($i); ?>',1500,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl<?php echo ($i); ?>')">预览</a></td>
	<td><input class="px" type="text"  style="width:200px;"  name="info" value="<?php echo ($photo["info"]); ?>"  /></td>
	<td>
