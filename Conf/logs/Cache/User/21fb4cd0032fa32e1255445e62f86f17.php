...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />  
 <div class="content">
<div class="cLineB">
<h4 class="left">商城分佣管理</h4>
<div class="searchbar right">
<form method="post" action="">
<input type="text" class="txt left" placeholder="输入推广号" name="searchkey" value="<?php echo ($key); ?>"/>
...
<div class="tab">
<ul>
<?php if($isgroup != 1 OR $ischild != 1): ?><li class="tabli" id="tab2"><a href="<?php echo U('Store/index',array('token'=>$token));?>">商品分类管理</a></li>
	...
	<?php if($ischild == 0): ?><li class="tabli" id="tab5"><a href="<?php echo U('Reply_info/set',array('token'=>$token,'infotype'=>'Shop'));?>">商城回复配置</a></li><?php endif; ?>
	<?php if($isgroup == 1): ?><li class="tabli" id="tab5"><a href="<?php echo U('Store/group',array('token'=>$token));?>">商品分组</a></li>
	<li class="tabli" id="tab7"><a href="<?php echo U('Store/productgroup',array('token'=>$token));?>">分组商品展现</a></li><?php endif; ?>
<?php else: ?>
	...
	<li class="current tabli" id="tab2"><a href="<?php echo U('Store/twitter',array('token'=>$token));?>">商城分佣管理</a></li>
</ul>
</div>
<!--tab end-->
<div class="cLine">
	<div class="pageNavigator left"> 
		<a href="<?php echo U('Store/twitterset', array('token' => $token, 'cid' => $cid));?>" title="分佣设置" class="btnGrayS vm bigbtn">
			<?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" class="vm" /><?php endif; ?>分佣设置
		</a>
	</div>
	<div class="pageNavigator right"> 
		<a href="<?php echo U('Store/removesearch', array('token' => $token, 'cid' => $cid));?>" title="查看申请提现" class="btnGrayS vm bigbtn">
			<?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" class="vm" /><?php endif; ?>查看申请提现
		</a>
	</div>
	<div class="clr"></div>
</div>
...
<tr>
<th width="200">推广号</th>
<th width="200">分佣总金额</th>
<th width="200">已提现的金额</th>
<th width="200" class="norightborder">详情</th>
</tr>
</thead>
<tbody>
<tr></tr>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($hostlist['twid']); ?>(<?php echo ($hostlist['nickname']); ?>)</td>
<td><?php echo ($hostlist['total']); ?></td> 
<td><?php echo ($hostlist['remove']); ?></td> 
<td class="norightborder">
	<a href="<?php echo U('Store/detail',array('token' => $token, 'twid' => $hostlist['twid'], 'cid' => $cid));?>">佣金获取详情</a>
	<span>&nbsp;&nbsp;　|　&nbsp;&nbsp;<a href="<?php echo U('Store/remove',array('token' => $token, 'twid' => $hostlist['twid'], 'cid' => $cid));?>">提现详情</a></span>
</td>
