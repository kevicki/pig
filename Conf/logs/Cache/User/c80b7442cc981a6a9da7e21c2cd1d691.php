...
function showWxhelp(){
	art.dialog.open('http://www.meihua.com/waphelp/wxpay.php?siteUrl=<?php echo ($f_siteUrl); ?>',{lock:true,title:'微信支付设置',width:800,height:600,yesText:'Y',background: '#000',opacity: 0.45});
}
function showWxhelpQa(){
	art.dialog.open('http://www.meihua.com/waphelp/wxpay.php?siteUrl=<?php echo ($f_siteUrl); ?>#qa',{lock:true,title:'微信支付常见问题',width:800,height:600,yesText:'Y',background: '#000',opacity: 0.45});
}
$(function(){
	if($('#pay_open').val() == 0){
	  ...
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
					...
					<td>
						<select name="is_open" id="pay_open">
							<option value="0" <?php if($config["is_open"] == 0): ?>selected<?php endif; ?>>关闭支付</option>
							<option value="1" <?php if($config["is_open"] == 1): ?>selected<?php endif; ?>>开启支付</option>
						</select> 开启支付后，商城等b2c功能将有在线支付功能
					</td>
				</tr>
				<tr>
					<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/weixin.png"/>微信支付：</th>
					<td>
						<div class="pay_setting">
							<div>
								<input type="radio" name="weixin[open]" id="open_weixin_yes" value="1" <?php if($config['weixin']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_weixin_yes">本账号微信支付</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="weixin[open]" id="open_weixin_other" value="2" <?php if($config['weixin']['open'] == 2): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_weixin_other">其他账号微信支付</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="weixin[open]" id="open_weixin_no" value="0" <?php if($config['weixin']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_weixin_no">关闭微信支付</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<div class="hidden" id="weixin_setting">
								<div class="setting_rows">
									...
									<p style="text-align:center;margin-bottom:40px;margin-top:20px;">
										<input type="button" pay_type="new" class="change_wx_pay <?php if(empty($config['weixin']['is_old'])): ?>btnGreen<?php else: ?>btnGray<?php endif; ?>" value="新版微信支付"/>
										<input type="button" pay_type="old" class="change_wx_pay <?php if($config['weixin']['is_old']): ?>btnGreen<?php else: ?>btnGray<?php endif; ?>" value="老版微信支付"/>
										<input type="hidden" name="weixin[is_old]" id="wx_is_old" value="<?php echo (intval($config["weixin"]["is_old"])); ?>"/>
									</p>
									<div id="new_wxpay_box" class="wxpay_box" <?php if($config['weixin']['is_old']): ?>style="display:none;"<?php endif; ?>>
										<p><span>Appid：</span><input type="text" name="weixin[new_appid]" value="<?php echo ($config["weixin"]["new_appid"]); ?>" class="px"/>&nbsp;&nbsp;公众账号ID</p>
										<p><span>Appsecret：</span><input type="text" name="weixin[appsecret]" value="<?php echo ($config["weixin"]["appsecret"]); ?>" class="px" />公众账号Appsecret</p>
										<p><span>微支付商户号：</span><input type="text" name="weixin[mchid]" value="<?php echo ($config["weixin"]["mchid"]); ?>" class="px" />&nbsp;&nbsp;微信支付商户号</p>
										<p><span>API密钥：</span><input type="text" name="weixin[key]" value="<?php echo ($config["weixin"]["key"]); ?>" class="px" />&nbsp;&nbsp;商户支付API密钥</p>
										<p><span></span><a href="###" onclick="showWxhelp()" class="a_red">点击查看如何设置</a></p>
									</div>
									<div id="old_wxpay_box" class="wxpay_box" <?php if(empty($config['weixin']['is_old'])): ?>style="display:none;"<?php endif; ?>>
										<p><span>Appid：</span><input type="text" name="weixin[appid]" value="<?php echo ($config["weixin"]["appid"]); ?>" class="px"/>&nbsp;&nbsp;公众账号ID</p>
										<p><span>paysignKey：</span><input type="text" name="weixin[paysignkey]" value="<?php echo ($config["weixin"]["paysignkey"]); ?>" class="px" />&nbsp;&nbsp;</p>
										<p><span>partnerId：</span><input type="text" name="weixin[partnerid]" value="<?php echo ($config["weixin"]["partnerid"]); ?>" class="px" />&nbsp;&nbsp;</p>
										<p><span>partnerKey：</span><input type="text" name="weixin[partnerkey]" value="<?php echo ($config["weixin"]["partnerkey"]); ?>" class="px" />&nbsp;&nbsp;</p>
									</div>
								</div>
							</div>
						</div>
				...
				<tr>
					<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/alipay.png"/>支付宝：</th>
					<td>
						<div class="pay_setting">
							<div>
								<input type="radio" name="alipay[open]" id="open_alipay_yes" value="1" <?php if($config['alipay']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_alipay_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="alipay[open]" id="open_alipay_no" value="0" <?php if($config['alipay']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_alipay_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="###" onclick="showSetting('alipay','支付宝');" class="a_choose">配置信息</a>
							</div>
							<div class="hidden" id="alipay_setting">
								<div class="setting_rows">
									<p><span>帐号：</span><input type="text" name="alipay[name]" value="<?php echo ($config["alipay"]["name"]); ?>" class="px" /></p>
									<p><span>PID：</span><input type="text" name="alipay[pid]" value="<?php echo ($config["alipay"]["pid"]); ?>" class="px" /></p>
									<p><span>KEY：</span><input type="text" name="alipay[key]" value="<?php echo ($config["alipay"]["key"]); ?>" class="px" /></p>
								</div>
							</div>
						</div>
					</td>
				...
				<tr>
					<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/tenpay.png"/>财付通(WAP手机)：</th>
					<td>
						<div class="pay_setting">
							<div>
								<input type="radio" name="tenpay[open]" id="open_tenpay_yes" value="1" <?php if($config['tenpay']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_tenpay_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="tenpay[open]" id="open_tenpay_no" value="0" <?php if($config['tenpay']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_tenpay_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="###" onclick="showSetting('tenpay','财付通(WAP接口)');" class="a_choose">配置信息</a>
							</div>
							<div class="hidden" id="tenpay_setting">
								<div class="setting_rows">
									<p><span>partnerId：</span><input type="text" name="tenpay[partnerid]" value="<?php echo ($config["tenpay"]["partnerid"]); ?>" class="px" /></p>
									<p><span>partnerKey：</span><input type="text" name="tenpay[partnerkey]" value="<?php echo ($config["tenpay"]["partnerkey"]); ?>" class="px" /></p>
								</div>
							</div>
						</div>
					</td>
				...
				<tr>
					<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/allinpay.png"/>通联支付：</th>
					<td>
						<div class="pay_setting">
							<div>
								<input type="radio" name="allinpay[open]" id="open_allinpay_yes" value="1" <?php if($config['allinpay']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_allinpay_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="allinpay[open]" id="open_allinpay_no" value="0" <?php if($config['allinpay']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_allinpay_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="###" onclick="showSetting('allinpay','通联支付');" class="a_choose">配置信息</a>
							</div>
							<div class="hidden" id="allinpay_setting">
								<div class="setting_rows">
									<p><span>商户号：</span><input type="text" name="allinpay[merchantId]" value="<?php echo ($config["allinpay"]["merchantId"]); ?>" class="px" /></p>
									<p><span>MD5 KEY：</span><input type="text" name="allinpay[merchantKey]" value="<?php echo ($config["allinpay"]["merchantKey"]); ?>" class="px" /></p>
								</div>
							</div>
						</div>
					</td>
				...
				<tr>
					<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/yeepay.png"/>易宝支付：</th>
					<td>
						<div class="pay_setting">
							<div>
								<input type="radio" name="yeepay[open]" id="open_yeepay_yes" value="1" <?php if($config['yeepay']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_yeepay_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="yeepay[open]" id="open_yeepay_no" value="0" <?php if($config['yeepay']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_yeepay_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="###" onclick="showSetting('yeepay','易宝支付');" class="a_choose">配置信息</a>
							</div>
							<div class="hidden" id="yeepay_setting">
								<div class="setting_rows">
									<p><span>商户编号：</span><input type="text" name="yeepay[merchantaccount]" value="<?php echo ($config["yeepay"]["merchantaccount"]); ?>" class="px" /></p>
									<p><span>商户私钥：</span><input type="text" name="yeepay[merchantPrivateKey]" value="<?php echo ($config["yeepay"]["merchantPrivateKey"]); ?>" class="px" /></p>
									<p><span>商户公钥：</span><input type="text" name="yeepay[merchantPublicKey]" value="<?php echo ($config["yeepay"]["merchantPublicKey"]); ?>" class="px" /></p>
									<p><span>易宝公钥：</span><input type="text" name="yeepay[yeepayPublicKey]" value="<?php echo ($config["yeepay"]["yeepayPublicKey"]); ?>" class="px" /></p>
									<p><span>商品类别码：</span><input type="text" name="yeepay[product_catalog]" value="<?php echo ($config["yeepay"]["product_catalog"]); ?>" class="px" /></p>
								</div>
							</div>
						</div>
					</td>
				...
				<!-- 
				<tr>
					<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/chinabank.png"/>网银在线：</th>
					<td>
						<div class="pay_setting">
							<div>
								<input type="radio" name="chinabank[open]" id="open_chinabank_yes" value="1" <?php if($config['chinabank']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_chinabank_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="chinabank[open]" id="open_chinabank_no" value="0" <?php if($config['chinabank']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_chinabank_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="###" onclick="showSetting('chinabank','网银在线');" class="a_choose">配置信息</a>
							</div>
							<div class="hidden" id="chinabank_setting">
								<div class="setting_rows">
									<p><span>商户号：</span><input type="text" name="chinabank[chinabank_account]" value="<?php echo ($config["chinabank"]["chinabank_account"]); ?>" class="px" /></p>
									<p><span>MD5私钥：</span><input type="text" name="chinabank[chinabank_key]" value="<?php echo ($config["chinabank"]["chinabank_key"]); ?>" class="px" /></p>
								</div>
							</div>
						</div>
					</td>
				 ...
				 -->
				<tr>
					<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/cardpay.jpg"/>会员卡付款：</th>
					<td>
						<div class="pay_setting">
							<div style="/*margin-bottom:10px;*/">
								<input type="radio" name="CardPay[open]" id="open_cardpay_yes" value="1" <?php if($config['CardPay']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_cardpay_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="CardPay[open]" id="open_cardpay_no" value="0" <?php if($config['CardPay']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_cardpay_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							</div>
						</div>
					</td>
				</tr>
				<tr>
					<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/daofu.png"/>货到付款：</th>
					<td>
						<div class="pay_setting">
							<div>
								<input type="radio" name="daofu[open]" id="open_daofu_yes" value="1" <?php if($config['daofu']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_daofu_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="daofu[open]" id="open_daofu_no" value="0" <?php if($config['daofu']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_daofu_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							</div>
						</div>
					</td>
				</tr>
				<tr>
					<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/dianfu.png"/>到店付款：</th>
					<td>
						<div class="pay_setting">
							<div style="/*margin-bottom:10px;*/">
								<input type="radio" name="dianfu[open]" id="open_dianfu_yes" value="1" <?php if($config['dianfu']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_dianfu_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="dianfu[open]" id="open_dianfu_no" value="0" <?php if($config['dianfu']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_dianfu_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							</div>
						</div>
					</td>
				</tr>
				...
				<?php if(C('platform_open') == 1): ?><tr>
						<th><img src="<?php echo ($staticPath); ?>/tpl/static/pay_icon/platform.png"/>平台支付：</th>
						<td>
							<div class="pay_setting">
								<div>
									<input type="radio" name="platform[open]" id="open_platform_yes" value="1" <?php if($config['platform']['open'] == 1): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_platform_yes">开启</label>&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="platform[open]" id="open_platform_no" value="0" <?php if($config['platform']['open'] == 0): ?>checked="checked"<?php endif; ?>/>&nbsp;<label for="open_platform_no">关闭</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="###" onclick="showSetting('platform','平台支付');" class="a_choose">配置信息</a>&nbsp;&nbsp;&nbsp;&nbsp;平台现在是开启的是
									<span style='color:red;'>
									<?php
 if (C('platform_weixin_open')) echo '微信、'; if (C('platform_alipay_open')) echo '支付宝、'; if (C('platform_tenpay_open')) echo '财付通(WAP手机)、'; if (C('platform_tenpayComputer_open')) echo '财付通(即时到帐)、'; if (C('platform_allinpay_open')) echo '通联支付、'; if (C('platform_yeepay_open')) echo '易宝支付'; ?></span>，开启平台支付后将在您相应的支付方式关闭时进行使用支付。
								</div>
								</div>
								<div class="hidden" id="platform_setting">
									<div class="setting_rows">
										<p><span>名称标注：</span><input type="text" name="platform[platformName]" value="<?php echo ($config["platform"]["platformName"]); ?>" class="px" />&nbsp;&nbsp;支付时的支付名称额外的标注【如：<font color="red">支付宝(**)</font>】，不填写则不展示</p>
									</div>
								</div>
							</div>
						</td>
