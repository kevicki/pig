...
<div class="content"> 
	<div class="cLineB"> 
		<h4>菜品分类设置</h4> 
		<a href="<?php echo U('Repast/index',array('token' => $token,'cid'=>$cid));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
	</div> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       <tr> 
        ...
        <td>
        <input type="text" name="name" id="name" value="<?php echo ($tableData["name"]); ?>" class="px" style="width:400px;" />
        </td> 
       </tr>
       <tr> 
        <th>展示图片：</th>
        <td><input type="text" name="image" value="<?php echo ($tableData["image"]); ?>" class="px" id="pic" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,700,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a></td> 
       </tr>
       <tr> 
        <th>分类描述：</th> 
        <td><textarea name="des" class="px" style="width:400px;height:80px;"><?php echo ($tableData["des"]); ?></textarea></td> 
       </tr> 
       <tr> 
        <th>排序：</th> 
        <td><input type="text" id="sort" name="sort" value="<?php echo ($tableData["sort"]); ?>" class="px" style="width:50px;" />  数字越小排再越前（大于等于0的整数）</td> 
       </tr>
       <tr>
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="submit" class="btnGreen" id="save">保存</button> &nbsp; <a href="<?php echo U('Repast/sort',array('token' => $token, 'cid' => $cid));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
