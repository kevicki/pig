...
<div class="content">
  <div class="cLineB">
    <h4 class="left">招聘信息管理 (<?php echo ($page); ?> ) </h4>
  </div>
  <div class="tab">
    <ul>
  ...
  <div class="cLine">
    <div class="pageNavigator left" style=" margin-right:30px"> <a href="<?php echo U('Zhaopin/exportForms',array('token'=>$token));?>" title="导出招聘信息" class="btnGrayS vm bigbtn">导出招聘信息</a> </div>
    <div class="pageNavigator left"> <a href="<?php echo U('Zhaopin/add',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"> <img src="<?php echo RES;?>/images/product/add.png" width="16">添加</a> </div>
    <div class="clr"></div>
  </div>
  <div class="msgWrap">
        ...
        <tbody>
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td class="norightborder">
                ...
                <?php if($item['allow'] == 0): ?>&nbsp;&nbsp;<a href="<?php echo U('Zhaopin/allowQY',array('id'=>$item['id'],'token'=>$token,'allow'=>'1'));?>">未审核</a>
                <?php else: ?>
                  &nbsp;&nbsp;<a href="<?php echo U('Zhaopin/allowQY',array('id'=>$item['id'],'token'=>$token,'allow'=>'0'));?>">已审核</a><?php endif; ?>
                &nbsp;&nbsp;<a href="<?php echo U('Zhaopin/set',array('id'=>$item['id'],'token'=>$token));?>">修改</a>
                &nbsp;&nbsp;<a href="<?php echo U('Zhaopin/del',array('aid'=>$item['pid'],'id'=>$item['id'],'token'=>$token));?>">删除</a>
              </td>
