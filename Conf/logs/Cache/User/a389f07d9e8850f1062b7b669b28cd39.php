...
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Groupon/add',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加团购</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<th width="240" class="norightborder">操作</th>
</tr>
</thead>
<tbody>
<tr></tr>
...
<td class="norightborder">
	<?php if($hostlist["sn"] == 1): ?><a href="<?php echo U('Groupon/sn',array('id'=>$hostlist['id'],'token'=>$token));?>">管理虚拟物品</a><?php endif; ?>
	<a href="<?php echo U('Groupon/set',array('id'=>$hostlist['id'],'token'=>$token));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Groupon/del',array('id'=>$hostlist['id'],'token'=>$token));?>');">删除</a></td>
