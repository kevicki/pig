...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
 <div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>>
          <div class="cLineB"><h4>添加幻灯片</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a></div> 
<div class="msgWrap">
...
<TR>
  ...
  <TD><input type="text" class="px" id="img" value="" name="img" style="width:500px" >  <script src="/tpl/static/upyun.js?2013"></script><a href="###" onclick="chooseFile('img','focus')" class="a_upload">选择</a> <a href="###" onclick="upyunPicUpload('img',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img')">预览</a> 建议图片(宽640高320)  </TD>
  <TD>&nbsp;</TD>
</TR>

<TR>
  <TH valign="top"><label for="keyword">幻灯片链接地址 ：</label></TH>
  <TD><input type="text" class="px" id="url" value="" name="url" style="width:500px" > <?php if(session('isQcloud') != true): ?><a href="###" onclick="addLink('url',0)" class="a_choose">从功能库添加</a><?php endif; ?><br />
                   </TD>
  <TD>&nbsp;</TD>
</TR>
