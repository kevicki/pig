...
<ul id="tags" style="width:100%">
 <?php if(is_array($cats)): $k = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($k % 2 );++$k;?><li <?php if($catid == $k): ?>class="selectTag"<?php endif; ?>>
				<a href="?g=User&m=Game&a=gameLibrary&catid=<?php echo ($k); ?>"><?php echo ($list["name"]); ?></a> 
          ...
          <div class="ftip" style="margin:25px auto 5px auto;">微游戏是我们与第三方游戏平台合作功能，将会不断推出热门微信游戏</div>
...
<?php if(is_array($games)): $i = 0; $__LIST__ = $games;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
<td><img src="<?php echo ($item["logo"]); ?>" width="60" /></td>
<td><?php echo ($item["title"]); ?></td>
<td><?php echo ($item["intro"]); ?></td>
<td class="norightborder">
<a href="<?php echo U('Game/gameSet',array('gameid'=>$item['id']));?>" >使用此游戏</a>
