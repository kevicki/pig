...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Company/index',array('token'=>$token,'isBranch'=>1));?>" title="" class="btnGrayS vm bigbtn"><?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" class="vm"><?php endif; ?> 添加</a></div>
<div class="clr"></div>
</div>
...
<td><?php echo ($c["business_type_name"]); ?></td>
<td><?php echo ($c["province"]); echo ($c["city"]); echo ($c["district"]); echo ($c["address"]); ?></td>
