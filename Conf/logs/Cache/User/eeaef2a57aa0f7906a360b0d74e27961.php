...
<TR>
  <TH valign="top" align="right" style="text-align:right">未关注默认提示语：</TH>
  <TD>
  	<textarea style="width:400px;height:75px" name="sub_notice" id="sub_notice" class="px"><?php echo (($wxuser['sub_notice'])?($wxuser['sub_notice']):'您好，您还没有权限参加活动。'); ?></textarea>
  </TD>
</TR>

<TR>
  <TH valign="top" align="right" style="text-align:right">引导关注按钮提示语：</TH>
  <TD>
  	<input style="width:400px;" name="sub_notice_btn" id="sub_notice_btn" value="<?php echo (($wxuser['sub_notice_btn'])?($wxuser['sub_notice_btn']):'立即获得权限'); ?>" class="px" />
  </TD>
</TR>

<TR>
  <TH valign="top" align="right" style="text-align:right">需要粉丝手机号提示语：</TH>
  <TD>
  	<textarea style="width:400px;height:75px" name="need_phone_notice" id="need_phone_notice" class="px"><?php echo (($wxuser['need_phone_notice'])?($wxuser['need_phone_notice']):'您好，需要您先填写个人信息才能参加活动。'); ?></textarea>
  </TD>
</TR>
