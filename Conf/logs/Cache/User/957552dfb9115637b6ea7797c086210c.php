...
<?php if($type == 'seckill'): ?><a href="<?php echo U('Seckill/action_add',array('token'=>$token,'type'=>$type));?>" class="btnGrayS vm bigbtn">添加微秒杀</a>
<?php else: ?>
<a href="<?php echo U('Business/index_add',array('token'=>$token,'type'=>$type));?>" class="btnGrayS vm bigbtn">
    ...
    <div class="bdrcontent">
      <div id="div_ptype">
        <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
          <thead>
            <tr>
<?php if($type == 'seckill'): ?><th style=" width:100px;">活动标题</th>
...
<?php if(is_array($busines)): $i = 0; $__LIST__ = $busines;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
              ...
              <a href="<?php echo U('Business/index_add',array('bid'=>$vo['bid'],'type'=>$vo['type']));?>" class="btnGreen">编辑</a>
              <a href="<?php echo U('Business/index_del',array('bid'=>$vo['bid'],'type'=>$vo['type']));?>" onclick="return(confirm('确定要删除吗？'))" class="btnGreen">删除</a> </td>
