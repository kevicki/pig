...
<script type="text/javascript">
  ...
  <a href='<?php echo U('Guajiang/add',array('token'=>$token));?>' title='新增刮刮卡活动' class='btnGrayS vm bigbtn'><?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" /><?php endif; ?> 新增刮刮卡活动</a>
...
<TH>活动名称</TH>
<?php if($_SESSION['is_syn'] == 0): ?><TH>关键字</TH><?php endif; ?>
<TH>参与人数</TH>
<TH>开始时间/结束时间</TH>
<TH>状态</TH>
<TH>外链代码</TH>
...
<?php if($_SESSION['is_syn']== 2): if($usertplid != 2): ?><script type="text/javascript">
 ...
 <div id="showdiv<?php echo ($list["id"]); ?>">
   ...
   <div id="testdiv<?php echo ($list["id"]); ?>"><img src="<?php echo (session('source_domain')); ?>/wap.php?c=Wxapp&a=qrcode&id=<?php echo ($list["id"]); ?>&modle=Guajiang" width="300" height="300" class="cateimg_small"></div>
 </div>
