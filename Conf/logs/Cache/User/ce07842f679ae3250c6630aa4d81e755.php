	  ...
	  <form class="form" method="post" action="" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
					<th>回复图片：</th>
					<td><input type="text" name="picurl" id="picurl" value="<?php echo ($home["picurl"]); ?>" class="px" style="width:550px;">   <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('picurl',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl')">预览</a></td>
				</tr>
				<TR>
                  <TH valign="top"><label for="gzhurl">公众号链接地址：</label></TH>
                  <TD><input type="text" class="px" id="gzhurl"  name="gzhurl" value="<?php echo ($home["gzhurl"]); ?>" style="width:580px;"  /><br>
                    <span class="red">填写此链接地址可以有效帮助粉丝关注您的公众号！请填写一个微信官方公众平台群发出的文章链接。链接前加http://</span>
                  </TD>
                </TR>
				<tr>
					<th>3G网站背景：</th>
				...
				<tr>
					...
					<td><select id="start" onchange="Cmd(this)" name="start" value="<?php echo ($home["start"]); ?>"style="width:220px">
						...
						<option name="start" value="1" <?php if($home["start"] == 1): ?>selected<?php endif; ?>>宝马动画</option>
						<option name="start" value="2" <?php if($home["start"] == 2): ?>selected<?php endif; ?>>左右展开</option>
						<option name="start" value="3" <?php if($home["start"] == 3): ?>selected<?php endif; ?>>上下展开</option>
						<option name="start" value="4" <?php if($home["start"] == 4): ?>selected<?php endif; ?>>滑动式开场动画(可自定义图片)</option>
					</select></td>
				</tr>
				<tr id="div23">
					<th>开场动画颜色：</th>
					<td>
						<input type="text" name="stpics" id="stpics" value="<?php echo ($strcolor); ?>" class="px color" style="width: 55px; background:<?php echo ($strcolor); ?>; color: rgb(255, 255, 255);"onblur="document.getElementById('pic1').value=document.getElementById('stpics').value;">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">实际显示颜色为当前所选颜色的70%透明效果。</span>
					</td>
				</tr>
				<tr id="div4">
					<th></th>
					<td>
						<p class="red">此动画结束后,点击一下图片才能进入主页。</p>
						<img id="pic1_src" src="<?php if($img == 1): echo ($staticPath); ?>/tpl/static/home/kcdhbj.jpg<?php elseif($img == 2): echo ($strpic); else: echo ($staticPath); ?>/tpl/static/home/kcdhbj.jpg<?php endif; ?>" width="220" >
						<input class="px"  name="stpic" value="<?php if($img == 1): echo ($strpic); elseif($img == 2): echo ($strpic); else: echo ($staticPath); ?>/tpl/static/home/kcdhbj.jpg<?php endif; ?>" id="pic1" style="width:363px;" type="hidden" >
						<br>
						<script src="<?php echo ($staticPath); ?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic1',330,550,'<?php echo ($token); ?>')" class="a_upload">自定义图片</a> &nbsp;&nbsp;&nbsp;<span class="red">建议图片尺寸(330*550),由于手机屏幕大小不同,尺寸随实际需求设置。</span>
					</td>
				</tr>
				<tr>
					<th>幻灯片切换效果：</th>
					<td><select id="switch" onchange="Cmd(this)" name="switch" value="<?php echo ($home["switch"]); ?>"style="width:220px">
						<option name="switch" value="0">普通切换效果</option>
						<option name="switch" value="1" <?php if($home["switch"] == 1): ?>selected<?php endif; ?>>3D切换效果</option>
					</select></td>
				</tr>
				<tr>
					<th>背景音乐：</th>
					<td>
					<table><tr><?php if($home["musicurl"] != ''): ?><td><a style="width:120px;float:left" id="musicurl_src" class="audio {skin:'green'}" href="<?php echo ($home["musicurl"]); ?>">音乐播放</a></td><?php endif; ?><td> <input type="text" class="px" name="musicurl" value="<?php echo ($home["musicurl"]); ?>" id="musicurl" style="width:200px;float:left" onchange="$('#musicurl_src').attr('href',this.value"> <a href="###" onclick="upyunPicUpload('musicurl',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;<a href="###" onclick="chooseFile('musicurl','music')" class="a_upload">选择</a></td></tr></table>
					 </td>
				</tr>
				<tr>
					<th>公司Logo：</th>
					<td><input type="text" name="logo" id="logo" value="<?php echo ($home["logo"]); ?>" class="px" style="width:550px;">  <a href="###" onclick="upyunPicUpload('logo',1500,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('logo')">预览</a><br/> </td>
				</tr>
				<tr>
					<th>第三方接口：</th>
				...
				<tr>
					<th>是否开启网页客服：</th>
					<td>
						<input type="radio" id="servicestate1" class='servicestate' value="1" name="servicestate" <?php if($servicestate == 1){?>checked<?php }?> />&nbsp;&nbsp;<label for="servicestate1">打开</label>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" id="servicestate0" class='servicestate' value="0" name="servicestate" <?php if($servicestate == 0){?>checked<?php }?> />&nbsp;&nbsp;<label for="servicestate0">关闭</label>
					</td>
				</tr>
				<tr>
					<th>&nbsp;</th>
