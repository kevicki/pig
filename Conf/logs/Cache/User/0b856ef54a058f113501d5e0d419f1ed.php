...
<a class="right btnGrayS vm" style="margin-top:-27px" href="javascript:history.go(-1);">返回</a>
</div>

<div class="cLine">
<div class="pageNavigator left"> <a href='/index.php?g=User&m=Member_card&a=noticeSet&id=<?php echo ($thisCard["id"]); ?>&token=<?php echo ($token); ?>' title='添加通知' class='btnGrayS vm bigbtn'><img class="vm" src="./tpl/User/default/common/images/product/add.png">添加通知</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<a href="/index.php?g=User&m=Member_card&a=noticeSet&token=<?php echo ($token); ?>&id=<?php echo ($thisCard["id"]); ?>&noticeid=<?php echo ($item["id"]); ?>">编辑</a> <a href="javascript:drop_confirm('您确定要删除吗?', '/index.php?g=User&m=Member_card&a=noticeDelete&token=<?php echo ($token); ?>&noticeid=<?php echo ($item["id"]); ?>&id=<?php echo ($thisCard["id"]); ?>');">删除</a></TD>
