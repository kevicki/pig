...
<div class="content">
          <div class="cLineB"><h4><?php echo ($thisCard["cardname"]); ?>：发布会员特权 <span class="FAQ"></span></h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a></div>
          ...
          <div class="msgWrap form">
			...
			<th>有效期：</th>
			<td><label>
			<input name="type" type="radio" id="RadioGroup1_1" onclick="document.getElementById('cktime').style.display='none';" value="1" <?php if($vip['statdate'] == false): ?>checked="checked"<?php endif; ?>>
			无时间期限</label>　
			<label>
			<input name="type" type="radio" id="RadioGroup1_0" <?php if($vip['statdate'] != false): ?>checked="checked"<?php endif; ?> onclick="document.getElementById('cktime').style.display='';;" value="0">
			选择时间期限</label>
			</td>
		</tr>
		<tr id="cktime" <?php if($vip['statdate'] == false): ?>style="display:none"<?php endif; ?>>
		<th></th>
		<td>
			...
			<input type="input" class="px" id="enddate" name="enddate" value="<?php if($vip['enddate'] != false): echo (date("Y-m-d H:i:s",$vip["enddate"])); endif; ?>" onClick="WdatePicker()">（含）
		</td>
		</tr>
              	<tr>
              		<th valign="top">使用说明：</th>
              		<td><textarea name="info" id="info" rows="5" style="width: 410px; height: 250px; border:1px solid #ccc ;"> <?php echo ($vip["info"]); ?>  </textarea></td>
              	</tr>
              	<tr>
					<th></th>
					<td>
