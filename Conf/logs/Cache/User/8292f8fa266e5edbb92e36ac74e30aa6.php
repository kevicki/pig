...
<div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>>
          ...
          <div class="cLine">
            <?php if($usertplid == 0): ?><div class="pageNavigator left" style="width: 100%;">
      ...
      <div class="alert alert-success alert-dismissable">
			...
			<?php  if (2 < $wxuser['winxintype'] || D('Img')->isOpenSync($wxuser)): ?>  
			<a class="btnGrayS vm bigbtn" href="<?php echo U('Upyun/sync');?>">
 ...
 if($group): ?>
                  <td>
					<?php
 $wechatGroup = explode(',', $vo['wechat_group']); $groups = array_intersect_key($group, array_flip($wechatGroup)); $groups = implode(',', $groups); echo empty($groups) ? '全部分组' : $groups; ?>
				  </td>
				  <?php
 endif; ?>
