...
<div class="cLineB">
<ul id="tags">
  <li><a href="<?php echo U('Member_card/center',array('token'=>$token));?>">已领卡会员</a> </li>
  <li class="selectTag"><a href="<?php echo U('Member_card/center_all',array('token'=>$token));?>">所有注册会员</a></li>
  <div class="clr"></div>
</ul>
<div class="clr"></div>
</div>
...
<form method="post"  action="" id="info" >
	关键词：
	<input type="text" class="px" name="search" value="" style="height:25px;width:150px;" placeholder="昵称、真姓名或者手机号">
...
<TD><?php echo ($item["expensetotal"]); ?></TD>
