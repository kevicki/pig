...
class MarketAction extends UserAction
{
	...
	public function index()
	{
		...
		if (IS_POST) {
			...
			$this->assign('default', './tpl/static/market/default.jpg');
	...
	{
		$name = array('商家', '停车场', '简介', '团购');
		$url = array('{siteUrl}/index.php?g=Wap&m=Market&a=tenant&token=' . $this->token . '&wecha_id={wechat_id}', '{siteUrl}/index.php?g=Wap&m=Market&a=park&token=' . $this->token . '&wecha_id={wechat_id}', '{siteUrl}/index.php?g=Wap&m=Market&a=intro&token=' . $this->token . '&wecha_id={wechat_id}', '{siteUrl}/index.php?g=Wap&m=Groupon&a=grouponIndex&token=' . $this->token . '&wecha_id={wechat_id}');
		$pic = array('./tpl/static/attachment/icon/white/1.png', './tpl/static/attachment/icon/white/4.png', './tpl/static/attachment/icon/white/9.png', './tpl/static/attachment/icon/white/7.png', './tpl/static/attachment/icon/white/14.png', './tpl/static/attachment/icon/white/15.png');
		$system = array('1', '1', '1', '1', '0', '0');
	...
	public function _get_slide($market_id)
	{
		...
		if (empty($arr)) {
			$arr['slide_0'] = rtrim(C('site_url'), '/') . '/tpl/static/attachment/focus/default/2.jpg';
			$arr['slide_1'] = rtrim(C('site_url'), '/') . '/tpl/static/attachment/focus/default/3.jpg';
			$arr['slide_2'] = rtrim(C('site_url'), '/') . '/tpl/static/attachment/focus/default/4.jpg';
		}
