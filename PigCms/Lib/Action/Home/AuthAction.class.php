...
class AuthAction extends BaseAction
{
	...
	private $_status = array(
		...
		40201 => array('status' => 40201, 'message' => '登录失败'),
	...
	private $_callback = array(
		1 => array('pay' => '/wap/otherPay.php?', 'auth' => '/wap/otherAuth.php?', 'share' => '/wap/otherShare.php?'),
		2 => array('pay' => '/wap.php?c=Wxapp&a=pay&', 'auth' => '/wap.php?c=Wxapp&a=redirect&', 'share' => '/wap.php?c=Wxapp&a=share&')
		);
	...
	private function _debug(&$result, $method = 'M')
	{
		if ($_POST['debug']) {
			if ('D' == $method) {
