...
class AgentAction extends BaseAction
{
	...
	public function submenu_basic()
	{
		...
		$home_menus['display']['submenu'][] = array('text' => '购买套餐', 'link' => '?g=Agent&m=Basic&a=discountPrice');
	...
	{
		$home_menus['display'] = array('text' => '客户管理', 'icon' => 'image/content.png', 'folder' => 0, 'link' => '?g=Agent&m=Users&a=index');
		$home_menus['display']['submenu'][] = array('text' => '套餐管理', 'link' => '?g=Agent&m=Users&a=groups');
		$home_menus['display']['submenu'][] = array('text' => '客户管理', 'link' => '?g=Agent&m=Users&a=index');
	...
	public function submenu_site()
	{
		...
		$home_menus['display']['submenu'][] = array('text' => '新闻管理', 'link' => '?g=Agent&m=Site&a=news');
		...
		$home_menus['display']['submenu'][] = array('text' => '横幅管理', 'link' => '?g=Agent&m=Site&a=images');
		$home_menus['display']['submenu'][] = array('text' => '首页幻灯片', 'link' => '?g=Agent&m=Site&a=banner');
		$home_menus['display']['submenu'][] = array('text' => '自定义导航', 'link' => '?g=Agent&m=Site&a=customs');
		$home_menus['display']['submenu'][] = array('text' => '微信托管', 'link' => '?g=Agent&m=Site&a=weixin');
		return $home_menus;
	}

	public function submenu_level()
	{
		$home_menus['display'] = array('text' => '代理商管理', 'icon' => 'image/config.png', 'folder' => 0, 'link' => '?g=Agent&m=Level&a=index');
		$home_menus['display']['submenu'][] = array('text' => '代理商管理', 'link' => '?g=Agent&m=Level&a=index');
		$home_menus['display']['submenu'][] = array('text' => '添加代理商', 'link' => '?g=Agent&m=Level&a=add');
		return $home_menus;
	}
}
