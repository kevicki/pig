...
! function(a, b) {
    ...
    h.pt = h.prototype, h.pt.config = {
        ...
        d.border[0] && (j = '<div id="xubox_border' + c + '" class="xubox_border" style="' + o + '"></div>'), !d.maxmin || 1 !== d.type && 2 !== d.type || /^\d+%$/.test(d.area[0]) && /^\d+%$/.test(d.area[1]) || (n = '<a class="xubox_min" href="javascript:;"><cite></cite></a><a class="xubox_max xulayer_png32" href="javascript:;"></a>'), d.closeBtn[1] && (n += '<a class="xubox_close xubox_close' + d.closeBtn[0] + '" href="javascript:;" style="' + (4 === d.type ? "position:absolute; right:-3px; _right:7px; top:-4px;" : "") + '"> </a>');
        ...
        c = jQuery, d = c(a), g.html = c("html"), layer.use("layer.css"), c.layer = function(a) {
            var b = new h(a);
            return b.index
        }, (new Image).src = layer.path + "xubox_ico0.png"
